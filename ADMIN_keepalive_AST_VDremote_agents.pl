#!/usr/bin/perl
#
# ADMIN_keepalive_AST_VDremote_agents.pl
#
...
if ($psline[1] =~ /\/home\/cron\/AST_VDremote_agents\.pl/) {$running_12++;}
...
if (!$running_12)
	{
	`/usr/bin/screen -d -L -m -S ASTVDremote /home/cron/AST_VDremote_agents.pl`;
