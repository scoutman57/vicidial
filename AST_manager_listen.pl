#!/usr/bin/perl
#
# AST_manager_listen.pl version 0.5
#
...
#	$/ at /home/cron/AST_manager_listen.pl line 114.
			...
			foreach(@input_lines)
				{
				if ( ($input_lines[$ILcount] =~ /State: Ringing|State: Up|State: Dialing|Event: Hangup|Event: Newcallerid|Event: Shutdown/) && ($input_lines[$ILcount] !~ /ZOMBIE/) )
					{
