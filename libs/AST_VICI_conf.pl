...
$LOCAL_GMT = '-5';			# local GMT offset, DO NOT ADJUST FOR DST!

### VICIDIAL Variables
$login_user = '6666';			# VICIDIAL user (optional)
$login_pass = '1234';			# VICIDIAL password (optional)
$login_pass = 'sales';			# VICIDIAL password (optional)
$login_campaign = 'TESTCAMP';	# VICIDIAL campaign (optional)
$login_campaign = 'CLOSER';	# VICIDIAL campaign (optional)
...
#$VICIDIAL_web_URL ='http://www.vicimarketing.com/cof_memberworks_sales_entry.php';
...
$admin_hijack_enabled = 1;		# allow force hijack of Zap and SIP
...
$enable_fast_refresh = 1;		# enables half-second refresh of channel info 
	$fast_refresh_rate = 1000;		# in milliseconds, refresh rate if fast rate 
$enable_persistant_mysql = 0;	# enables one persistant mysql connection 
$auto_dial_next_number = 1;		# enables placing next call right after dispo 
$VDstop_rec_after_each_call = 1;# looks for and stops any recording in the
									# session after every call is HUNGUP
