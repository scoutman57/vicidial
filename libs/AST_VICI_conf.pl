...
$VDstop_rec_after_each_call = 0;# looks for and stops any recording in the
...
$VICIDIAL_web_QUERY_STRING.="&fronter=$user";
$VICIDIAL_web_QUERY_STRING.="&closer=$user";
$VICIDIAL_web_QUERY_STRING.="&campaign=$campaign";
$VICIDIAL_web_QUERY_STRING.="&group=$campaign";
$VICIDIAL_web_QUERY_STRING.="&channel_group=$campaign";
