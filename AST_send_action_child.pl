...
$FULL_LOG = 0; # set to 1 for a full response log to be created in /home/cron/action_full.date
...
#			print "DB0: |$ARGS|$#ARGV|$i|\n";
	...
	if ($ARGS =~ /--help/i)
	{
	print "allowed run time options:\n  [-q] = quiet\n  [--tenmore] = print ten more [--data1=XXXXXXX] [--data2=xxxxxx] = data to print\n\n\n";
	}
	else
	{
		if ($ARGS =~ /-q/i)
