+------------------------------------------------------------------------------+
|    Asterisk GUI client - astguiclient - eighteenth public release 1.1.5     |
...
- astGUIclient_1.1.0.pl - the GUI application itself
 ...
 - astVICIDIAL_1.1.pl - the VICIDIAL GUI client auto-dialing application
...
Zaptel trunks or IAX or SIP VOIP trunks and SIP/IAX/Zap hard or softphones or 
...
There is also a web version of the astGUIclient as of release 1.1.1
