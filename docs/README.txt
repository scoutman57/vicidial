+------------------------------------------------------------------------------+
|    Asterisk GUI client - astguiclient - twentieth public release 1.1.7       |
...
Sangoma Zaptel trunks or IAX or SIP VOIP trunks and SIP/IAX/Zap hard or 
softphones or devices as extensions, it could be adapted to other functions, but 
it was designed for Zap/IAX/SIP users. The client programs will run on X and 
Win32. There are also fully functional web versions of the astGUIclient and 
vicidial client apps.
...
- on VICIDIAL autodial, very rarely the Perl/Tk app will freeze, just close it 
  and log back in again and everything should be fine.
...
- Depending on what version of perl you are running(for the Perl/Tk apps only),
  ...
  To fix this, jut go to http://search.cpan.org/~jhi/Time-HiRes-1.65/ and 
...
1.1.7 - Twentieth public release - 2005-09-30
