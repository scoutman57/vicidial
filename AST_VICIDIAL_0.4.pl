...
# 
# AST_VICIDIAL_0.4.pl version 0.4      for Perl/Tk
...
#		$dial_info_frame->Label(-text => " ")->pack(-side => 'top');
	...
	### disposition frame for the dialer app
		...
		my $dispo_OK_button = $dispo_OK_button_frame->Button(-text => 'OK', -width => -1, -background => '#FFFFCC', -activebackground => '#FFFF99',
					-command => sub 
					{
