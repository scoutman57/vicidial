...
# 
# astVICIDIAL_0.8.pl version 0.9      for Perl/Tk
...
# perl -d:ptkdb C:\AST_VICI\astVICIDIAL_0.9.pl  
#  
#
...
if (length($PARK)<5)
	...
	### use manager middleware-app to connect the next call to the meetme room
		...
		if ($CLOSER_XFER_TYPE =~ /INTERNAL/)
			{
			$TXextension = "90009*CL_$campaign$park_exten_suffix**$lead_id*$VICIDIAL_park_on_filename***";
			}
