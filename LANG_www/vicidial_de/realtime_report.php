...
function realtime_refresh_display()
	...
	if (ar_seconds > 0)
		{
		document.getElementById("erfrischen_countdown").innerHTML = "" + ar_seconds + "";
		ar_seconds = (ar_seconds - 1);
		setTimeout("realtime_erfrischen_display()",1000);
		}
	else
		{
		document.getElementById("erfrischen_countdown").innerHTML = "0";
		ar_seconds = ar_erfrischen;
...
echo " &nbsp; &nbsp; &nbsp; erfrischen: <span id=erfrischen_countdown name=erfrischen_countdown></span>\n\n";
