...
$report_name="Kampagne Status List Report";
$NOW_DATE = date("Y-m-d");
...
while($i < $group_ct)
	...
	while ($row=mysqli_fetch_row($rslt)) 
		...
		if (mysqli_num_rows($stat_rslt)>0) 
			...
			$graph_header="<table cellspacing='0' cellpadding='0' class='horizontalgraph'><caption align='top'>Liste Identifikation #$list_id: $list_name</caption><tr><th class='thgraph' scope='col'>DISPOSITION</th>";
