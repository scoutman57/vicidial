...
$report_name='Dial Protokollbericht';
...
if ($SUBMIT && $query_date) {
		...
		$CSV_text="\"CALLER CODE\",\"LEAD ID\",\"BEDIENERIP\",\"CALL DATE\",\"EXTENSION\",\"CHANNEL\",\"CONTEXT\",\"TIMEOUT\",\"OUTBOUND CID\",\"SIP HANGUP CAUSE\",\"UNIQUE ID\",\"SIP HANGUP REASON\"\n";

		$dial_log_rpt="+----------------------+-----------+-----------------+---------------------+----------------------+----------------------------------------------------+----------------------+---------+------------------------------------------+--------+----------------------+----------------------------------------------------+\n";
		$dial_log_rpt.="|                      |           |                 |                     |                      |                                                    |                      |         |                                          | SIP    |                      |                                                    |\n";
		$dial_log_rpt.="|                      |           |                 |                     |                      |                                                    |                      |         |                                          | HANGUP |                      |                                                    |\n";
		$dial_log_rpt.="| CALLER CODE          | LEAD ID   | BEDIENERIP       | CALL DATE           | EXTENSION            | CHANNEL                                            | CONTEXT              | TIMEOUT | OUTBOUND CID                             | CAUSE  | UNIQUE ID            | SIP HANGUP REASON                                  |\n";
		$dial_log_rpt.="+----------------------+-----------+-----------------+---------------------+----------------------+----------------------------------------------------+----------------------+---------+------------------------------------------+--------+----------------------+----------------------------------------------------+\n";
