...
$report_name = 'Benutzer-Gruppe Login Report';
$db_source = 'M';
...
if ($SUBMIT=="SUBMIT") 
	{
	$ASCII_text="+--------------------------------+----------+----------------------+---------------------+---------------------+----------+-----------------+-----------------+----------------------+--------------+-----------------+-----------------+-----------------+\n";
	$ASCII_text.="| USER NAME                      | ID       | User Group           | FIRST LOGIN DATE    | LAST LOGIN DATE     | CAMPAIGN | BEDIENERIP       | COMPUTER IP     | EXTENSION            | BROWSER      | PHONE LOGIN     |  BEDIENERPHONE   | PHONE IP        |\n";
	$ASCII_text.="+--------------------------------+----------+----------------------+---------------------+---------------------+----------+-----------------+-----------------+----------------------+--------------+-----------------+-----------------+-----------------+\n";

	$CSV_text="\"User group login report\",\"User groups:\",\"$user_group_string\"\n\n";
	$CSV_text.="\"User name\",\"User ID\",\"User group\",\"First login date\",\"Last login date\",\"Kampagne Identifikation\",\"Bediener IP\",\"Computer IP\",\"Extension\",\"Browser\",\"Phone login\",\"Server phone\",\"Phone IP\"\n";
