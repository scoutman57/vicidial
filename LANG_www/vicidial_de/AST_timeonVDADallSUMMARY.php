...
if (!isset($types))			{$types='Zeige ALL KAMPAGNEN';}

$report_name = 'Real-Time Kampagne Summary';
$db_source = 'M';
...
$MAIN.="<b>Real-Time All Kampagnen Summary</b> &nbsp; &nbsp; &nbsp; \n";
...
$MAIN.="<option value=\"Zeige ALL KAMPAGNEN\"";
	if ($types == 'Zeige ALL KAMPAGNEN') {$MAIN.=" selected";} 
$MAIN.=">Zeige ALL KAMPAGNEN</option>";
...
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>DROPPED / ANTWORTED:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $dropsTODAY / $answersTODAY &nbsp; </TD>";
...
$MAIN.="</TR>";
$CSV_text.="\"HOPPER LEVEL:\",\"$HOPlev\",\"DROPPED / ANTWORTED:\",\"$dropsTODAY / $answersTODAY\",\"DL DIFF:\",\"$diffONEMIN\",\"STATUSES:\",\"$DIALstatuses\"\n";
...
if ($VSCagentcalls > 0)
	...
	$MAIN.="</TR>";
	$CSV_text.="\"MITTELAVG WAIT:\",\"$avgwaitTODAY\",\"AVG CUSTTIME:\",\"$avgcustTODAY\",\"AVG ACW:\",\"$avgacwTODAY\",\"AVG PAUSE:\",\"$avgpauseTODAY\"\n";
	}
