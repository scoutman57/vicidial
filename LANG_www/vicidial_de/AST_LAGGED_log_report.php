...
if ($SUBMIT && $query_date) {
	...
	if (mysqli_num_rows($rslt)>0) {
		$ASCII_text.="--- BEDIENERIP BREAKDOWN FOR LAGGED RECORDS $query_date, $query_date_D TO $query_date_T \n";
		$ASCII_text.="+-----------------+---------+\n";
		$ASCII_text.="| BEDIENERIP       |  COUNT  |\n";
		$ASCII_text.="+-----------------+---------+\n";
		$HTML_text.="<table border='0' cellpadding='0' cellspacing='2' width='350'>";
		$HTML_text.="<TR><TH colspan='2' class='small_standard_bold grey_graph_cell'>BEDIENERIP BREAKDOWN FOR LAGGED RECORDS $query_date, $query_date_D TO $query_date_T</TH></TR>";
		$HTML_text.="<TR><TH class='small_standard_bold grey_graph_cell'>BEDIENERIP</th><TH class='small_standard_bold grey_graph_cell'>ZÄHLIMPULS</th></tr>";
		...
		$ASCII_text.="+-----------------+---------+\n\n\n";
		$HTML_text.="<TR><TH class='small_standard_bold grey_graph_cell'>GESAMTMENGE</th><TH class='small_standard_bold grey_graph_cell'>$total_count</th></tr></table>";
		...
		$lagged_rpt.="+--------------+------------+-----------------+---------------------+-----------+----------+--------+----------------------+----------------------+----------------------+\n";
		$lagged_rpt.="| MITTELLOG ID | USER       | BEDIENERIP       | EVENT TIME          | LEAD ID   | CAMPAIGN | STATUS | User Group           | COMMENTS             | UNIQUE ID            |\n";
		$lagged_rpt.="+--------------+------------+-----------------+---------------------+-----------+----------+--------+----------------------+----------------------+----------------------+\n";
		...
		$HTML_rpt.="<TR><TH class='small_standard_bold grey_graph_cell' width='90'>MITTELLOG ID</TH><TH class='small_standard_bold grey_graph_cell' width='80'>USER</TH><TH class='small_standard_bold grey_graph_cell' width='120'>BEDIENERIP</TH><TH class='small_standard_bold grey_graph_cell' width='100'>EVENT TIME</TH><TH class='small_standard_bold grey_graph_cell' width='80'>LEAD ID</TH><TH class='small_standard_bold grey_graph_cell' width='80'>CAMPAIGN</TH><TH class='small_standard_bold grey_graph_cell' width='60'>STATUS</TH><TH class='small_standard_bold grey_graph_cell' width='80'>User Group</TH><TH class='small_standard_bold grey_graph_cell' width='160'>COMMENTS</TH><TH class='small_standard_bold grey_graph_cell' width='120'>UNIQUE ID</TH></TR>";

		$CSV_text="\"MITTELLOG ID\",\"USER\",\"BEDIENERIP\",\"EVENT TIME\",\"LEAD ID\",\"CAMPAIGN\",\"STATUS\",\"User Group\",\"COMMENTS\",\"UNIQUE ID\"\n";
