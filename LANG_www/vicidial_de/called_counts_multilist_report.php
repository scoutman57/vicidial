...
$report_name = 'Called Counts Liste Identifikations Report';
$db_source = 'M';
...
$HEADER.="function LoadListen(FromBox) {\n";
$HEADER.="	if (!FromBox) {alert(\"NO\"); return false;}\n";
$HEADER.="	var selectedKampagnen=\"|\";\n";
...
$HEADER.="			selectedKampagnen += document.getElementById('group').options[i].value+\"|\";\n";
$HEADER.="		} \n";
$HEADER.="	}\n";
$HEADER.="\n";
$HEADER.="	// Liste löschen menu\n";
...
$HEADER.="		var campaign_matches = selectedKampagnen.match(campaignID);\n";
...
$MAIN.="<TABLE CELLSPACING=3><TR><TD VALIGN=TOP><input type='checkbox' name='override_date' value='1' checked>All dates<BR><BR>Termine:<BR>";
...
$MAIN.="Listen: <font size=1>(optional, möglicherweise langsam)</font><BR>\n";
$MAIN.=$list_options;
...
if (strlen($QUERY_STRING) > 5)
	...
	$MAIN.="<td align=center><font size=1>TEILSUMME</td></tr>\n";
	$CSV_text.="\"SUBTOTAL\"\n";
	...
	$MAIN.="<tr><td align=center colspan=2><b><font size=1>GESAMTMENGE</td>";
	$CSV_text.="\"\",\"TOTAL\",";
	$first = $all_called_first;
	while ($first <= $all_called_last)
		{
