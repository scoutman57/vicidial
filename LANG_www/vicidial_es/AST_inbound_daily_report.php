...
$MAIN.="<INPUT TYPE=submit NAME=ENVIAR VALUE=ENVIAR></TD></TR>\n";
$MAIN.="<TR><TD align='left'><FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2><INPUT TYPE=checkbox NAME=hourly_breakdown VALUE='checked' $hourly_breakdown>Show hourly results<BR><INPUT TYPE=checkbox NAME=show_disposition_statuses VALUE='checked' $show_disposition_statuses>Show disposition statuses<BR><INPUT TYPE=checkbox NAME=ignore_afterhours VALUE='checked' $ignore_afterhours>Ignore after-hours calls</FONT></TD><TD align='right'><a href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date$selected_group_URLstr&shift=$shift&hourly_breakdown=$hourly_breakdown&show_disposition_statuses=$show_disposition_statuses&ENVIAR=$ENVIAR&file_download=1\">DESCARGAR</a> | <a href=\"./admin.php?ADD=3111&group_id=$group\">MODIFICAR</a> | <a href=\"./admin.php?ADD=999999\">INFORMES</a></TD></TR>\n";
...
if ($groups_selected==0)
	{
	$MAIN.="\n\n";
	$MAIN.="POR FAVOR SELECCIONE UN GRUPO EN EL PÁRRAFO ANTERIOR Y FECHA DE RANGO y haga clic en Enviar\n";
	echo "$HEADER";
	require("admin_header.php");
	echo "$MAIN";
	}
...
#		}
	...
	*/
	...
	while ($d < $TOTintervals)
		...
		if ($totRESPUESTASdate[$d]>0)
			{
			$totRESPUESTASavgspeedTIME[$d] =	sprintf("%6s", date("i:s", mktime(0, 0, round($totRESPUESTASspeeddate[$d]/$totRESPUESTASdate[$d]))));
			$totRESPUESTASavgTIME[$d] =	sprintf("%6s", date("i:s", mktime(0, 0, round($totRESPUESTASsecdate[$d]/$totRESPUESTASdate[$d]))));
			if (round($totRESPUESTASspeeddate[$d]/$totRESPUESTASdate[$d])>$max_avganswerspeed) {$max_avganswerspeed=round($totRESPUESTASspeeddate[$d]/$totRESPUESTASdate[$d]);}
			$graph_stats[$d][12]=round($totRESPUESTASspeeddate[$d]/$totRESPUESTASdate[$d]);
			$graph_stats[$d][16]=round($totRESPUESTASsecdate[$d]/$totRESPUESTASdate[$d]);
			}
		else
			{
			$totRESPUESTASdate[$d]="0";
			$totRESPUESTASavgspeedTIME[$d] = " 00:00";
			$totRESPUESTASavgTIME[$d] = " 00:00";
			$graph_stats[$d][12]=0;
			$graph_stats[$d][16]=0;
			}
		$totRESPUESTAStalkTIME[$d] =	sprintf("%10s", floor($totRESPUESTASsecdate[$d]/3600).date(":i:s", mktime(0, 0, $totRESPUESTASsecdate[$d])));
		$totRESPUESTASwrapTIME[$d] =	sprintf("%10s", floor(($totRESPUESTASdate[$d]*15)/3600).date(":i:s", mktime(0, 0, ($totRESPUESTASdate[$d]*15))));
		...
		$totRESPUESTAStotTIME[$d] =	sprintf("%10s", floor(($totRESPUESTASsecdate[$d]+($totRESPUESTASdate[$d]*15))/3600).date(":i:s", mktime(0, 0, ($totRESPUESTASsecdate[$d]+($totRESPUESTASdate[$d]*15)))));
		...
		if (date("w", strtotime($daySTART[$d]))==0 && date("w", strtotime($daySTART[$d-1]))!=0 && $d>0) 
			...
			if ($totRESPUESTASwtd>0)
				{
				$totRESPUESTASavgspeedTIMEwtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totRESPUESTASspeedwtd/$totRESPUESTASwtd))));
				$totRESPUESTASavgTIMEwtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totRESPUESTASsecwtd/$totRESPUESTASwtd))));
				if (round($totRESPUESTASspeedwtd/$totRESPUESTASwtd)>$max_wtd_avganswerspeed) {$max_wtd_avganswerspeed=round($totRESPUESTASspeedwtd/$totRESPUESTASwtd);}
				$wtd_graph_stats[$wa][12]=round($totRESPUESTASspeedwtd/$totRESPUESTASwtd);
				$wtd_graph_stats[$wa][16]=round($totRESPUESTASsecwtd/$totRESPUESTASwtd);
				}
			else
				{
				$totRESPUESTASavgspeedTIMEwtd = " 00:00";
				$totRESPUESTASavgTIMEwtd = " 00:00";
				$wtd_graph_stats[$wa][12]=0;
				$wtd_graph_stats[$wa][16]=0;
				}
			$totRESPUESTAStalkTIMEwtd =	sprintf("%10s", floor($totRESPUESTASsecwtd/3600).date(":i:s", mktime(0, 0, $totRESPUESTASsecwtd)));
			$totRESPUESTASwrapTIMEwtd =	sprintf("%10s", floor(($totRESPUESTASwtd*15)/3600).date(":i:s", mktime(0, 0, ($totRESPUESTASwtd*15))));
			...
			$totRESPUESTAStotTIMEwtd =	sprintf("%10s", floor(($totRESPUESTASsecwtd+($totRESPUESTASwtd*15))/3600).date(":i:s", mktime(0, 0, ($totRESPUESTASsecwtd+($totRESPUESTASwtd*15)))));
			...
			if (round($totRESPUESTASsecwtd/$totRESPUESTASwtd)>$max_wtd_avgtalktime) {$max_wtd_avgtalktime=round($totRESPUESTASsecwtd/$totRESPUESTASwtd);}
		...
		if (date("d", strtotime($daySTART[$d]))==1 && $d>0 && date("d", strtotime($daySTART[$d-1]))!=1) 
			...
			if ($totRESPUESTASmtd>0)
				{
				$totRESPUESTASavgspeedTIMEmtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totRESPUESTASspeedmtd/$totRESPUESTASmtd))));
				$totRESPUESTASavgTIMEmtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totRESPUESTASsecmtd/$totRESPUESTASmtd))));
				if (round($totRESPUESTASspeedmtd/$totRESPUESTASmtd)>$max_mtd_avganswerspeed) {$max_mtd_avganswerspeed=round($totRESPUESTASspeedmtd/$totRESPUESTASmtd);}
				$mtd_graph_stats[$ma][12]=round($totRESPUESTASspeedmtd/$totRESPUESTASmtd);
				$mtd_graph_stats[$ma][16]=round($totRESPUESTASsecmtd/$totRESPUESTASmtd);
				}
			else
				{
				$totRESPUESTASavgspeedTIMEmtd = " 00:00";
				$totRESPUESTASavgTIMEmtd = " 00:00";
				$mtd_graph_stats[$ma][12]=0;
				$mtd_graph_stats[$ma][16]=0;
				}
			$totRESPUESTAStalkTIMEmtd =	sprintf("%10s", floor($totRESPUESTASsecmtd/3600).date(":i:s", mktime(0, 0, $totRESPUESTASsecmtd)));
			$totRESPUESTASwrapTIMEmtd =	sprintf("%10s", floor(($totRESPUESTASmtd*15)/3600).date(":i:s", mktime(0, 0, ($totRESPUESTASmtd*15))));
			...
			$totRESPUESTAStotTIMEmtd =	sprintf("%10s", floor(($totRESPUESTASsecmtd+($totRESPUESTASmtd*15))/3600).date(":i:s", mktime(0, 0, ($totRESPUESTASsecmtd+($totRESPUESTASmtd*15)))));
			$totAGENTSmtd=count(array_count_values($AGENTS_mtd_array));
			...
			if (round($totRESPUESTASsecmtd/$totRESPUESTASmtd)>$max_mtd_avgtalktime) {$max_mtd_avgtalktime=round($totRESPUESTASsecmtd/$totRESPUESTASmtd);}
			...
			if (date("m", strtotime($daySTART[$d]))==1 || date("m", strtotime($daySTART[$d]))==4 || date("m", strtotime($daySTART[$d]))==7 || date("m", strtotime($daySTART[$d]))==10) # Quarterly line
				...
				if ($totRESPUESTASqtd>0)
					{
					$totRESPUESTASavgspeedTIMEqtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totRESPUESTASspeedqtd/$totRESPUESTASqtd))));
					$totRESPUESTASavgTIMEqtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totRESPUESTASsecqtd/$totRESPUESTASqtd))));
					if (round($totRESPUESTASspeedqtd/$totRESPUESTASqtd)>$max_qtd_avganswerspeed) {$max_qtd_avganswerspeed=round($totRESPUESTASspeedqtd/$totRESPUESTASqtd);}
					$qtd_graph_stats[$qa][12]=round($totRESPUESTASspeedqtd/$totRESPUESTASqtd);
					$qtd_graph_stats[$qa][16]=round($totRESPUESTASsecqtd/$totRESPUESTASqtd);
					}
				else
					{
					$totRESPUESTASavgspeedTIMEqtd = " 00:00";
					$totRESPUESTASavgTIMEqtd = " 00:00";
					$qtd_graph_stats[$qa][12]=0;
					$qtd_graph_stats[$qa][16]=0;
					}
				$totRESPUESTAStalkTIMEqtd =	sprintf("%10s", floor($totRESPUESTASsecqtd/3600).date(":i:s", mktime(0, 0, $totRESPUESTASsecqtd)));
				$totRESPUESTASwrapTIMEqtd =	sprintf("%10s", floor(($totRESPUESTASqtd*15)/3600).date(":i:s", mktime(0, 0, ($totRESPUESTASqtd*15))));
				...
				$totRESPUESTAStotTIMEqtd =	sprintf("%10s", floor(($totRESPUESTASsecqtd+($totRESPUESTASqtd*15))/3600).date(":i:s", mktime(0, 0, ($totRESPUESTASsecqtd+($totRESPUESTASqtd*15)))));
				$totAGENTSqtd=count(array_count_values($AGENTS_qtd_array));
				...
				if (round($totRESPUESTASsecqtd/$totRESPUESTASqtd)>$max_qtd_avgtalktime) {$max_qtd_avgtalktime=round($totRESPUESTASsecqtd/$totRESPUESTASqtd);}
		...
		if (round($totRESPUESTASsecdate[$d]/$totRESPUESTASdate[$d])>$max_avgtalktime) {$max_avgtalktime=round($totRESPUESTASsecdate[$d]/$totRESPUESTASdate[$d]);}
	...
	if ($totCALLSsec > 0)
		...
		if ($FtotRESPUESTAS>0) 
			{
			$FtotRESPUESTASavgspeedTIME =	sprintf("%6s", date("i:s", mktime(0, 0, round($FtotRESPUESTASspeed/$FtotRESPUESTAS))));
			$FtotRESPUESTASavgTIME =	sprintf("%6s", date("i:s", mktime(0, 0, round($FtotRESPUESTASsec/$FtotRESPUESTAS))));
			}
		else 
			{
			$FtotRESPUESTASavgspeedTIME =	sprintf("%6s", "00:00");
			$FtotRESPUESTASavgTIME =	sprintf("%6s", "00:00");
			}
		$FtotRESPUESTAStalkTIME =	sprintf("%10s", floor($FtotRESPUESTASsec/3600).date(":i:s", mktime(0, 0, $FtotRESPUESTASsec)));
		$FtotRESPUESTASwrapTIME =	sprintf("%10s", floor(($FtotRESPUESTAS*15)/3600).date(":i:s", mktime(0, 0, ($FtotRESPUESTAS*15))));
		$FtotRESPUESTAStotTIME =	sprintf("%10s", floor(($FtotRESPUESTASsec+($FtotRESPUESTAS*15))/3600).date(":i:s", mktime(0, 0, ($FtotRESPUESTASsec+($FtotRESPUESTAS*15)))));
		...
		if (date("w", strtotime($daySTART[$d]))>0) 
			...
			for ($q=0; $q<count($wtd_graph_stats); $q++) {
				...
				$wtd_RESPUESTAED_graph.="  <tr><td class='chart_td$class'>".$wtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$wtd_graph_stats[$q][2]/$max_wtd_answered)."' height='16' />".$wtd_graph_stats[$q][2]."</td></tr>";
				...
				$wtd_AVGRESPUESTASPEED_graph.="  <tr><td class='chart_td$class'>".$wtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$wtd_graph_stats[$q][12]/$max_wtd_avganswerspeed)."' height='16' />".$wtd_graph_stats[$q][6]."</td></tr>";
		...
		if (date("d", strtotime($daySTART[$d]))!=1) 
			...
			for ($q=0; $q<count($mtd_graph_stats); $q++) {
				...
				$mtd_RESPUESTAED_graph.="  <tr><td class='chart_td$class'>".$mtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$mtd_graph_stats[$q][2]/$max_mtd_answered)."' height='16' />".$mtd_graph_stats[$q][2]."</td></tr>";
				...
				$mtd_AVGRESPUESTASPEED_graph.="  <tr><td class='chart_td$class'>".$mtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$mtd_graph_stats[$q][12]/$max_mtd_avganswerspeed)."' height='16' />".$mtd_graph_stats[$q][6]."</td></tr>";
	...
	#			{
			$totAGENTSqtd=count(array_count_values($AGENTS_qtd_array));
				...
				for ($q=0; $q<count($qtd_graph_stats); $q++) {
					...
					$qtd_RESPUESTAED_graph.="  <tr><td class='chart_td$class'>".$qtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$qtd_graph_stats[$q][2]/$max_qtd_answered)."' height='16' />".$qtd_graph_stats[$q][2]."</td></tr>";
					...
					$qtd_AVGRESPUESTASPEED_graph.="  <tr><td class='chart_td$class'>".$qtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$qtd_graph_stats[$q][12]/$max_qtd_avganswerspeed)."' height='16' />".$qtd_graph_stats[$q][6]."</td></tr>";
	...
	#			}
			...
			for ($q=0; $q<count($graph_stats); $q++) {
				...
				$RESPUESTAED_graph.="  <tr><td class='chart_td$class'>".$graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$graph_stats[$q][2]/$max_answered)."' height='16' />".$graph_stats[$q][2]."</td></tr>";
				...
				$AVGRESPUESTASPEED_graph.="  <tr><td class='chart_td$class'>".$graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$graph_stats[$q][12]/$max_avganswerspeed)."' height='16' />".$graph_stats[$q][6]."</td></tr>";
