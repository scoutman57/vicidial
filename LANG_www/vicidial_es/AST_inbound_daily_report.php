...
$MAIN.="<INPUT TYPE=submit NAME=REMITIR VALUE=REMITIR></TD></TR>\n";
$MAIN.="<TR><TD align='left'><FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2><INPUT TYPE=checkbox NAME=hourly_breakdown VALUE='checked' $hourly_breakdown>Show hourly results<BR><INPUT TYPE=checkbox NAME=show_disposition_statuses VALUE='checked' $show_disposition_statuses>Show disposition statuses<BR><INPUT TYPE=checkbox NAME=ignore_afterhours VALUE='checked' $ignore_afterhours>Ignore after-hours calls</FONT></TD><TD align='right'><a href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date$selected_group_URLstr&shift=$shift&hourly_breakdown=$hourly_breakdown&show_disposition_statuses=$show_disposition_statuses&REMITIR=$REMITIR&file_download=1\">DESCARGAR</a> | <a href=\"./admin.php?ADD=3111&group_id=$group\">MODIFICAR</a> | <a href=\"./admin.php?ADD=999999\">INFORMES</a></TD></TR>\n";
...
#		}
	...
	while ($i < $records_to_grab)
		...
		if ($row[6]!="VDCL" && $row[6]!="") {$ag[$i] = $row[6];} # Usuario
		# $fTOTAL_agents["$row[6]"]++;
	...
	#	$qrtQUEUE[$j]=0; $qrtQUEUEsec[$j]=0; $qrtQUEUEmax[$j]=0;
		...
		$totRESPUESTASdate[$j]=0;
		$totRESPUESTASsecdate[$j]=0;
		$totRESPUESTASspeeddate[$j]=0;
		$i=0;
		$agents_array=array();
		while ($i < $records_to_grab)
			{
	...
	#			$dtt = $dt[$i];
				...
				if (preg_match('/ABANDON|NOAGENT|QUEUETIMEOUT|AFTERHOURS|MAXCALLS/', $tr[$i])) 
					...
					if (($ls[$i]-$qs[$i]-15)>0) {  ## Patch by Joe J - can cause negative time values if removed.
						$totRESPUESTASsecdate[$j]+=($ls[$i]-$qs[$i]-15);
						$FtotRESPUESTASsec+=($ls[$i]-$qs[$i]-15);
					}
					$totRESPUESTASspeeddate[$j]+=$qs[$i];
					$FtotRESPUESTAS++;
					print "<!-- $FtotRESPUESTASspeed+=$qs[$i] //-->\n";
					$FtotRESPUESTASspeed+=$qs[$i];
					}
	...
	*/
	...
	$MAIN2="| SHIFT                                     | CALLS   | CALLS    | AGENTS   | CALLS     | ABANDON | ABANDON | RESPUESTA | TALK   | TALK       | WRAP       | CALL       |";
	$MAIN3="| DATE-TIME RANGE                           | OFFERED | RESPUESTAED | RESPUESTAED | ABANDONED | PERCENT | TIME    | SPEED  | TIME   | TIME       | TIME       | TIME       |";
	$CSV_text1="";
	$CSV_text2="";
	$CSV_text3="";
	...
	$CSV_text.="\"\",\"CALLS\",\"CALLS\",\"AGENTS\",\"CALLS\",\"ABANDON\",\"ABANDON\",\"RESPUESTA\",\"TALK\",\"TALK\",\"WRAP\",\"CALL\"$CSV_text2\n";
	$CSV_text.="\"SHIFT DATE-TIME RANGE\",\"OFFERED\",\"RESPUESTAED\",\"RESPUESTAED\",\"ABANDONED\",\"PERCENT\",\"TIME\",\"SPEED\",\"TIME\",\"TIME\",\"TIME\",\"TIME\"$CSV_text3\n";
	...
	$GRAPH="<a name='multigroup_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800'><tr><th width='10%' class='grey_graph_cell' id='multigroup_graph1'><a href='#' onClick=\"DrawGraph('OFFERED', '1'); return false;\">LLAMADAS TOTALES OFFERED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph2'><a href='#' onClick=\"DrawGraph('RESPUESTAED', '2'); return false;\">LLAMADAS TOTALES RESPUESTAED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph11'><a href='#' onClick=\"DrawGraph('AGENTS', '11'); return false;\">TOTAL AGENTS RESPUESTAED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph3'><a href='#' onClick=\"DrawGraph('ABANDONED', '3'); return false;\">LLAMADAS TOTALES ABANDONED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph4'><a href='#' onClick=\"DrawGraph('ABANDONPCT', '4'); return false;\">TOTAL ABANDON PERCENT</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph5'><a href='#' onClick=\"DrawGraph('AVGABANDONTIME', '5'); return false;\">AVG ABANDON TIME</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph6'><a href='#' onClick=\"DrawGraph('AVGRESPUESTASPEED', '6'); return false;\">AVG RESPUESTA SPEED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph7'><a href='#' onClick=\"DrawGraph('AVGTALKTIME', '7'); return false;\">AVG TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph8'><a href='#' onClick=\"DrawGraph('TOTALTALKTIME', '8'); return false;\">TOTAL TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph9'><a href='#' onClick=\"DrawGraph('TOTALWRAPTIME', '9'); return false;\">TOTAL WRAP TIME</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph10'><a href='#' onClick=\"DrawGraph('TOTALCALLTIME', '10'); return false;\">TOTAL CALL TIME</a></th></tr><tr><td colspan='11' class='graph_span_cell' align='center'><span id='stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
	$MTD_GRAPH="<BR><BR><a name='MTD_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800'><tr><th width='10%' class='grey_graph_cell' id='MTD_graph1'><a href='#' onClick=\"DrawMTDGraph('OFFERED', '1'); return false;\">LLAMADAS TOTALES OFFERED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph2'><a href='#' onClick=\"DrawMTDGraph('RESPUESTAED', '2'); return false;\">LLAMADAS TOTALES RESPUESTAED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph11'><a href='#' onClick=\"DrawMTDGraph('AGENTS', '11'); return false;\">TOTAL AGENTS RESPUESTAED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph3'><a href='#' onClick=\"DrawMTDGraph('ABANDONED', '3'); return false;\">LLAMADAS TOTALES ABANDONED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph4'><a href='#' onClick=\"DrawMTDGraph('ABANDONPCT', '4'); return false;\">TOTAL ABANDON PERCENT</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph5'><a href='#' onClick=\"DrawMTDGraph('AVGABANDONTIME', '5'); return false;\">AVG ABANDON TIME</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph6'><a href='#' onClick=\"DrawMTDGraph('AVGRESPUESTASPEED', '6'); return false;\">AVG RESPUESTA SPEED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph7'><a href='#' onClick=\"DrawMTDGraph('AVGTALKTIME', '7'); return false;\">AVG TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph8'><a href='#' onClick=\"DrawMTDGraph('TOTALTALKTIME', '8'); return false;\">TOTAL TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph9'><a href='#' onClick=\"DrawMTDGraph('TOTALWRAPTIME', '9'); return false;\">TOTAL WRAP TIME</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph10'><a href='#' onClick=\"DrawMTDGraph('TOTALCALLTIME', '10'); return false;\">TOTAL CALL TIME</a></th></tr><tr><td colspan='11' class='graph_span_cell' align='center'><span id='MTD_stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
	$WTD_GRAPH="<BR><BR><a name='WTD_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800'><tr><th width='10%' class='grey_graph_cell' id='WTD_graph1'><a href='#' onClick=\"DrawWTDGraph('OFFERED', '1'); return false;\">LLAMADAS TOTALES OFFERED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph2'><a href='#' onClick=\"DrawWTDGraph('RESPUESTAED', '2'); return false;\">LLAMADAS TOTALES RESPUESTAED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph11'><a href='#' onClick=\"DrawWTDGraph('AGENTS', '11'); return false;\">TOTAL AGENTS RESPUESTAED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph3'><a href='#' onClick=\"DrawWTDGraph('ABANDONED', '3'); return false;\">LLAMADAS TOTALES ABANDONED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph4'><a href='#' onClick=\"DrawWTDGraph('ABANDONPCT', '4'); return false;\">TOTAL ABANDON PERCENT</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph5'><a href='#' onClick=\"DrawWTDGraph('AVGABANDONTIME', '5'); return false;\">AVG ABANDON TIME</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph6'><a href='#' onClick=\"DrawWTDGraph('AVGRESPUESTASPEED', '6'); return false;\">AVG RESPUESTA SPEED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph7'><a href='#' onClick=\"DrawWTDGraph('AVGTALKTIME', '7'); return false;\">AVG TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph8'><a href='#' onClick=\"DrawWTDGraph('TOTALTALKTIME', '8'); return false;\">TOTAL TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph9'><a href='#' onClick=\"DrawWTDGraph('TOTALWRAPTIME', '9'); return false;\">TOTAL WRAP TIME</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph10'><a href='#' onClick=\"DrawWTDGraph('TOTALCALLTIME', '10'); return false;\">TOTAL CALL TIME</a></th></tr><tr><td colspan='11' class='graph_span_cell' align='center'><span id='WTD_stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
	$QTD_GRAPH="<BR><BR><a name='QTD_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800'><tr><th width='10%' class='grey_graph_cell' id='QTD_graph1'><a href='#' onClick=\"DrawQTDGraph('OFFERED', '1'); return false;\">LLAMADAS TOTALES OFFERED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph2'><a href='#' onClick=\"DrawQTDGraph('RESPUESTAED', '2'); return false;\">LLAMADAS TOTALES RESPUESTAED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph11'><a href='#' onClick=\"DrawQTDGraph('AGENTS', '11'); return false;\">TOTAL AGENTS RESPUESTAED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph3'><a href='#' onClick=\"DrawQTDGraph('ABANDONED', '3'); return false;\">LLAMADAS TOTALES ABANDONED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph4'><a href='#' onClick=\"DrawQTDGraph('ABANDONPCT', '4'); return false;\">TOTAL ABANDON PERCENT</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph5'><a href='#' onClick=\"DrawQTDGraph('AVGABANDONTIME', '5'); return false;\">AVG ABANDON TIME</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph6'><a href='#' onClick=\"DrawQTDGraph('AVGRESPUESTASPEED', '6'); return false;\">AVG RESPUESTA SPEED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph7'><a href='#' onClick=\"DrawQTDGraph('AVGTALKTIME', '7'); return false;\">AVG TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph8'><a href='#' onClick=\"DrawQTDGraph('TOTALTALKTIME', '8'); return false;\">TOTAL TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph9'><a href='#' onClick=\"DrawQTDGraph('TOTALWRAPTIME', '9'); return false;\">TOTAL WRAP TIME</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph10'><a href='#' onClick=\"DrawQTDGraph('TOTALCALLTIME', '10'); return false;\">TOTAL CALL TIME</a></th></tr><tr><td colspan='11' class='graph_span_cell' align='center'><span id='QTD_stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
	...
	$OFFERED_graph=$graph_header."<th class='thgraph' scope='col'>LLAMADAS TOTALES OFFERED</th></tr>";
	$RESPUESTAED_graph=$graph_header."<th class='thgraph' scope='col'>LLAMADAS TOTALES RESPUESTAED </th></tr>";
	$AGENTS_graph=$graph_header."<th class='thgraph' scope='col'>TOTAL AGENTS RESPUESTAED </th></tr>";
	$ABANDONED_graph=$graph_header."<th class='thgraph' scope='col'>LLAMADAS TOTALES ABANDONED</th></tr>";
	...
	$AVGRESPUESTASPEED_graph=$graph_header."<th class='thgraph' scope='col'>AVG RESPUESTA SPEED</th></tr>";
	...
	$totRESPUESTASsecwtd=0;
	$totRESPUESTASspeedwtd=0;
	$totABANDONSwtd=0;
	$totABANDONSsecwtd=0;
	...
	$totRESPUESTASsecmtd=0;
	$totRESPUESTASspeedmtd=0;
	$totABANDONSmtd=0;
	$totABANDONSsecmtd=0;
	...
	$totRESPUESTASsecqtd=0;
	$totRESPUESTASspeedqtd=0;
	$totABANDONSqtd=0;
	$totABANDONSsecqtd=0;
	...
	while ($d < $TOTintervals)
		...
		$totRESPUESTASavgspeedTIME[$d] =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($totRESPUESTASspeeddate[$d], $totRESPUESTASdate[$d])))));
		$totRESPUESTASavgTIME[$d] =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($totRESPUESTASsecdate[$d], $totRESPUESTASdate[$d])))));
		if (round(MathZDC($totRESPUESTASspeeddate[$d], $totRESPUESTASdate[$d]))>$max_avganswerspeed) {$max_avganswerspeed=round(MathZDC($totRESPUESTASspeeddate[$d], $totRESPUESTASdate[$d]));}
		$graph_stats[$d][12]=round(MathZDC($totRESPUESTASspeeddate[$d], $totRESPUESTASdate[$d]));
		$graph_stats[$d][16]=round(MathZDC($totRESPUESTASsecdate[$d], $totRESPUESTASdate[$d]));

		$totRESPUESTAStalkTIME[$d] =	sprintf("%10s", floor(MathZDC($totRESPUESTASsecdate[$d], 3600)).date(":i:s", mktime(0, 0, $totRESPUESTASsecdate[$d])));
		$totRESPUESTASwrapTIME[$d] =	sprintf("%10s", floor(MathZDC(($totRESPUESTASdate[$d]*15), 3600)).date(":i:s", mktime(0, 0, ($totRESPUESTASdate[$d]*15))));
		if (($totRESPUESTASdate[$d]*15)>$max_totalwraptime) {$max_totalwraptime=($totRESPUESTASdate[$d]*15);}
		$graph_stats[$d][13]=($totRESPUESTASdate[$d]*15);
		$graph_stats[$d][14]=($totRESPUESTASsecdate[$d]+($totRESPUESTASdate[$d]*15));
		$graph_stats[$d][15]=$totRESPUESTASsecdate[$d];

		$totRESPUESTAStotTIME[$d] =	sprintf("%10s", floor(MathZDC(($totRESPUESTASsecdate[$d]+($totRESPUESTASdate[$d]*15)), 3600)).date(":i:s", mktime(0, 0, ($totRESPUESTASsecdate[$d]+($totRESPUESTASdate[$d]*15)))));
		$totRESPUESTASdate[$d] =	sprintf("%8s", $totRESPUESTASdate[$d]);
		...
		if (date("w", strtotime($daySTART[$d]))==0 && date("w", strtotime($daySTART[$d-1]))!=0 && $d>0) 
			...
			$totRESPUESTASavgspeedTIMEwtd =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($totRESPUESTASspeedwtd, $totRESPUESTASwtd)))));
			$totRESPUESTASavgTIMEwtd =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($totRESPUESTASsecwtd, $totRESPUESTASwtd)))));
			if (round(MathZDC($totRESPUESTASspeedwtd, $totRESPUESTASwtd))>$max_wtd_avganswerspeed) {$max_wtd_avganswerspeed=round(MathZDC($totRESPUESTASspeedwtd, $totRESPUESTASwtd));}
			$wtd_graph_stats[$wa][12]=round(MathZDC($totRESPUESTASspeedwtd, $totRESPUESTASwtd));
			$wtd_graph_stats[$wa][16]=round(MathZDC($totRESPUESTASsecwtd, $totRESPUESTASwtd));
			$totRESPUESTAStalkTIMEwtd =	sprintf("%10s", floor(MathZDC($totRESPUESTASsecwtd, 3600)).date(":i:s", mktime(0, 0, $totRESPUESTASsecwtd)));
			$totRESPUESTASwrapTIMEwtd =	sprintf("%10s", floor(MathZDC(($totRESPUESTASwtd*15), 3600)).date(":i:s", mktime(0, 0, ($totRESPUESTASwtd*15))));
			if (($totRESPUESTASwtd*15)>$max_wtd_totalwraptime) {$max_wtd_totalwraptime=($totRESPUESTASwtd*15);}
			$wtd_graph_stats[$wa][13]=($totRESPUESTASwtd*15);
			$wtd_graph_stats[$wa][14]=($totRESPUESTASsecwtd+($totRESPUESTASwtd*15));
			$wtd_graph_stats[$wa][15]=$totRESPUESTASsecwtd;
			$totRESPUESTAStotTIMEwtd =	sprintf("%10s", floor(MathZDC(($totRESPUESTASsecwtd+($totRESPUESTASwtd*15)), 3600)).date(":i:s", mktime(0, 0, ($totRESPUESTASsecwtd+($totRESPUESTASwtd*15)))));
			# $totAGENTSwtd =	sprintf("%8s", $totAGENTSwtd);
			$totAGENTSwtd=count(array_count_values($AGENTS_wtd_array));
			$totAGENTSwtd =	sprintf("%8s", $totAGENTSwtd);
			$totRESPUESTASwtd =	sprintf("%8s", $totRESPUESTASwtd);
			...
			if (trim($totRESPUESTASwtd)>$max_wtd_answered) {$max_wtd_answered=trim($totRESPUESTASwtd);}
			...
			if (round(MathZDC($totRESPUESTASsecwtd, $totRESPUESTASwtd))>$max_wtd_avgtalktime) {$max_wtd_avgtalktime=round(MathZDC($totRESPUESTASsecwtd, $totRESPUESTASwtd));}
			if (trim($totRESPUESTASsecwtd)>$max_wtd_totaltalktime) {$max_wtd_totaltalktime=trim($totRESPUESTASsecwtd);}
			if (trim($totRESPUESTASsecwtd+($totRESPUESTASwtd*15))>$max_wtd_totalcalltime) {$max_wtd_totalcalltime=trim($totRESPUESTASsecwtd+($totRESPUESTASwtd*15));}
			...
			$wtd_graph_stats[$wa][2]=trim($totRESPUESTASwtd);
			...
			$wtd_graph_stats[$wa][6]=trim($totRESPUESTASavgspeedTIMEwtd);
			$wtd_graph_stats[$wa][7]=trim($totRESPUESTASavgTIMEwtd);
			$wtd_graph_stats[$wa][8]=trim($totRESPUESTAStalkTIMEwtd);
			$wtd_graph_stats[$wa][9]=trim($totRESPUESTASwrapTIMEwtd);
			$wtd_graph_stats[$wa][10]=trim($totRESPUESTAStotTIMEwtd);
			$wtd_graph_stats[$wa][17]=trim($totAGENTSwtd);
			$wa++;

			$ASCII_text.="$MAINH\n";
			$ASCII_text.="|                                       WTD | $totCALLSwtd | $totRESPUESTASwtd | $totAGENTSwtd | $totABANDONSwtd | $totABANDONSpctwtd%| $totABANDONSavgTIMEwtd | $totRESPUESTASavgspeedTIMEwtd | $totRESPUESTASavgTIMEwtd | $totRESPUESTAStalkTIMEwtd | $totRESPUESTASwrapTIMEwtd | $totRESPUESTAStotTIMEwtd |";
			$CSV_text.="\"WTD\",\"$totCALLSwtd\",\"$totRESPUESTASwtd\",\"$totAGENTSwtd\",\"$totABANDONSwtd\",\"$totABANDONSpctwtd%\",\"$totABANDONSavgTIMEwtd\",\"$totRESPUESTASavgspeedTIMEwtd\",\"$totRESPUESTASavgTIMEwtd\",\"$totRESPUESTAStalkTIMEwtd\",\"$totRESPUESTASwrapTIMEwtd\",\"$totRESPUESTAStotTIMEwtd\"";
			for ($s=0; $s<count($status_array); $s++) {
		...
		if (date("d", strtotime($daySTART[$d]))==1 && $d>0 && date("d", strtotime($daySTART[$d-1]))!=1) 
			...
			$totRESPUESTASavgspeedTIMEmtd =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($totRESPUESTASspeedmtd, $totRESPUESTASmtd)))));
			$totRESPUESTASavgTIMEmtd =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($totRESPUESTASsecmtd, $totRESPUESTASmtd)))));
			if (round(MathZDC($totRESPUESTASspeedmtd, $totRESPUESTASmtd))>$max_mtd_avganswerspeed) {$max_mtd_avganswerspeed=round(MathZDC($totRESPUESTASspeedmtd, $totRESPUESTASmtd));}
			$mtd_graph_stats[$ma][12]=round(MathZDC($totRESPUESTASspeedmtd, $totRESPUESTASmtd));
			$mtd_graph_stats[$ma][16]=round(MathZDC($totRESPUESTASsecmtd, $totRESPUESTASmtd));
			$totRESPUESTAStalkTIMEmtd =	sprintf("%10s", floor(MathZDC($totRESPUESTASsecmtd, 3600)).date(":i:s", mktime(0, 0, $totRESPUESTASsecmtd)));
			$totRESPUESTASwrapTIMEmtd =	sprintf("%10s", floor(MathZDC(($totRESPUESTASmtd*15), 3600)).date(":i:s", mktime(0, 0, ($totRESPUESTASmtd*15))));
			if (($totRESPUESTASmtd*15)>$max_mtd_totalwraptime) {$max_mtd_totalwraptime=($totRESPUESTASmtd*15);}
			$mtd_graph_stats[$ma][13]=($totRESPUESTASmtd*15);
			$mtd_graph_stats[$ma][14]=($totRESPUESTASsecmtd+($totRESPUESTASmtd*15));
			$mtd_graph_stats[$ma][15]=$totRESPUESTASsecmtd;
			$totRESPUESTAStotTIMEmtd =	sprintf("%10s", floor(MathZDC(($totRESPUESTASsecmtd+($totRESPUESTASmtd*15)), 3600)).date(":i:s", mktime(0, 0, ($totRESPUESTASsecmtd+($totRESPUESTASmtd*15)))));
			$totAGENTSmtd=count(array_count_values($AGENTS_mtd_array));
			$totAGENTSmtd =	sprintf("%8s", $totAGENTSmtd);
			$totRESPUESTASmtd =	sprintf("%8s", $totRESPUESTASmtd);
			...
			if (trim($totRESPUESTASmtd)>$max_mtd_answered) {$max_mtd_answered=trim($totRESPUESTASmtd);}
			...
			if (round(MathZDC($totRESPUESTASsecmtd, $totRESPUESTASmtd))>$max_mtd_avgtalktime) {$max_mtd_avgtalktime=round(MathZDC($totRESPUESTASsecmtd, $totRESPUESTASmtd));}
			if (trim($totRESPUESTASsecmtd)>$max_mtd_totaltalktime) {$max_mtd_totaltalktime=trim($totRESPUESTASsecmtd);}
			if (trim($totRESPUESTASsecmtd+($totRESPUESTASmtd*15))>$max_mtd_totalcalltime) {$max_mtd_totalcalltime=trim($totRESPUESTASsecmtd+($totRESPUESTASmtd*15));}
			$month=date("F", strtotime($dayEND[$d-1]));
			$year=substr($dayEND[$d-1], 0, 4);
			$mtd_graph_stats[$ma][0]="$month $year";
			$mtd_graph_stats[$ma][1]=trim($totCALLSmtd);
			$mtd_graph_stats[$ma][2]=trim($totRESPUESTASmtd);
			...
			$mtd_graph_stats[$ma][6]=trim($totRESPUESTASavgspeedTIMEmtd);
			$mtd_graph_stats[$ma][7]=trim($totRESPUESTASavgTIMEmtd);
			$mtd_graph_stats[$ma][8]=trim($totRESPUESTAStalkTIMEmtd);
			$mtd_graph_stats[$ma][9]=trim($totRESPUESTASwrapTIMEmtd);
			$mtd_graph_stats[$ma][10]=trim($totRESPUESTAStotTIMEmtd);
			$mtd_graph_stats[$ma][17]=trim($totAGENTSmtd);
			$ma++;

			$ASCII_text.="$MAINH\n";
			$ASCII_text.="|                                       MTD | $totCALLSmtd | $totRESPUESTASmtd | $totAGENTSmtd | $totABANDONSmtd | $totABANDONSpctmtd%| $totABANDONSavgTIMEmtd | $totRESPUESTASavgspeedTIMEmtd | $totRESPUESTASavgTIMEmtd | $totRESPUESTAStalkTIMEmtd | $totRESPUESTASwrapTIMEmtd | $totRESPUESTAStotTIMEmtd |";
			$CSV_text.="\"MTD\",\"$totCALLSmtd\",\"$totRESPUESTASmtd\",\"$totAGENTSmtd\",\"$totABANDONSmtd\",\"$totABANDONSpctmtd%\",\"$totABANDONSavgTIMEmtd\",\"$totRESPUESTASavgspeedTIMEmtd\",\"$totRESPUESTASavgTIMEmtd\",\"$totRESPUESTAStalkTIMEmtd\",\"$totRESPUESTASwrapTIMEmtd\",\"$totRESPUESTAStotTIMEmtd\"";
			for ($s=0; $s<count($status_array); $s++) {
			...
			if (date("m", strtotime($daySTART[$d]))==1 || date("m", strtotime($daySTART[$d]))==4 || date("m", strtotime($daySTART[$d]))==7 || date("m", strtotime($daySTART[$d]))==10) # Quarterly line
				...
				$totRESPUESTASavgspeedTIMEqtd =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($totRESPUESTASspeedqtd, $totRESPUESTASqtd)))));
				$totRESPUESTASavgTIMEqtd =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($totRESPUESTASsecqtd, $totRESPUESTASqtd)))));
				if (round(MathZDC($totRESPUESTASspeedqtd, $totRESPUESTASqtd))>$max_qtd_avganswerspeed) {$max_qtd_avganswerspeed=round(MathZDC($totRESPUESTASspeedqtd, $totRESPUESTASqtd));}
				$qtd_graph_stats[$qa][12]=round(MathZDC($totRESPUESTASspeedqtd, $totRESPUESTASqtd));
				$qtd_graph_stats[$qa][16]=round(MathZDC($totRESPUESTASsecqtd, $totRESPUESTASqtd));
				$totRESPUESTAStalkTIMEqtd =	sprintf("%10s", floor(MathZDC($totRESPUESTASsecqtd, 3600)).date(":i:s", mktime(0, 0, $totRESPUESTASsecqtd)));
				$totRESPUESTASwrapTIMEqtd =	sprintf("%10s", floor(MathZDC(($totRESPUESTASqtd*15), 3600)).date(":i:s", mktime(0, 0, ($totRESPUESTASqtd*15))));
				if (($totRESPUESTASqtd*15)>$max_qtd_totalwraptime) {$max_qtd_totalwraptime=($totRESPUESTASqtd*15);}
				$qtd_graph_stats[$qa][13]=($totRESPUESTASqtd*15);
				$qtd_graph_stats[$qa][14]=($totRESPUESTASsecqtd+($totRESPUESTASqtd*15));
				$qtd_graph_stats[$qa][15]=$totRESPUESTASsecqtd;
				$totRESPUESTAStotTIMEqtd =	sprintf("%10s", floor(MathZDC(($totRESPUESTASsecqtd+($totRESPUESTASqtd*15)), 3600)).date(":i:s", mktime(0, 0, ($totRESPUESTASsecqtd+($totRESPUESTASqtd*15)))));
				$totAGENTSqtd=count(array_count_values($AGENTS_qtd_array));
				$totAGENTSqtd =	sprintf("%8s", $totAGENTSqtd);
				$totRESPUESTASqtd =	sprintf("%8s", $totRESPUESTASqtd);
				...
				if (trim($totRESPUESTASqtd)>$max_qtd_answered) {$max_qtd_answered=trim($totRESPUESTASqtd);}
				...
				if (round(MathZDC($totRESPUESTASsecqtd, $totRESPUESTASqtd))>$max_qtd_avgtalktime) {$max_qtd_avgtalktime=round(MathZDC($totRESPUESTASsecqtd, $totRESPUESTASqtd));}
				if (trim($totRESPUESTASsecqtd)>$max_qtd_totaltalktime) {$max_qtd_totaltalktime=trim($totRESPUESTASsecqtd);}
				if (trim($totRESPUESTASsecqtd+($totRESPUESTASqtd*15))>$max_qtd_totalcalltime) {$max_qtd_totalcalltime=trim($totRESPUESTASsecqtd+($totRESPUESTASqtd*15));}
				...
				$qtd_graph_stats[$qa][2]=trim($totRESPUESTASqtd);
				...
				$qtd_graph_stats[$qa][6]=trim($totRESPUESTASavgspeedTIMEqtd);
				$qtd_graph_stats[$qa][7]=trim($totRESPUESTASavgTIMEqtd);
				$qtd_graph_stats[$qa][8]=trim($totRESPUESTAStalkTIMEqtd);
				$qtd_graph_stats[$qa][9]=trim($totRESPUESTASwrapTIMEqtd);
				$qtd_graph_stats[$qa][10]=trim($totRESPUESTAStotTIMEqtd);
				$qtd_graph_stats[$qa][17]=trim($totAGENTSqtd);
				$qa++;

				$ASCII_text.="|                                       QTD | $totCALLSqtd | $totRESPUESTASqtd | $totAGENTSqtd | $totABANDONSqtd | $totABANDONSpctqtd%| $totABANDONSavgTIMEqtd | $totRESPUESTASavgspeedTIMEqtd | $totRESPUESTASavgTIMEqtd | $totRESPUESTAStalkTIMEqtd | $totRESPUESTASwrapTIMEqtd | $totRESPUESTAStotTIMEqtd |";
				$CSV_text.="\"QTD\",\"$totCALLSqtd\",\"$totRESPUESTASqtd\",\"$totAGENTSqtd\",\"$totABANDONSqtd\",\"$totABANDONSpctqtd%\",\"$totABANDONSavgTIMEqtd\",\"$totRESPUESTASavgspeedTIMEqtd\",\"$totRESPUESTASavgTIMEqtd\",\"$totRESPUESTAStalkTIMEqtd\",\"$totRESPUESTASwrapTIMEqtd\",\"$totRESPUESTAStotTIMEqtd\"";
				for ($s=0; $s<count($status_array); $s++) {
		...
		$totRESPUESTASwtd+=$totRESPUESTASdate[$d];
		$totRESPUESTASsecwtd+=$totRESPUESTASsecdate[$d];
		$totRESPUESTASspeedwtd+=$totRESPUESTASspeeddate[$d];
		$totABANDONSwtd+=$totABANDONSdate[$d];
		$totABANDONSsecwtd+=$totABANDONSsecdate[$d];
		$totCALLSmtd+=$totCALLSdate[$d];
		$totRESPUESTASmtd+=$totRESPUESTASdate[$d];
		$totRESPUESTASsecmtd+=$totRESPUESTASsecdate[$d];
		$totRESPUESTASspeedmtd+=$totRESPUESTASspeeddate[$d];
		$totABANDONSmtd+=$totABANDONSdate[$d];
		$totABANDONSsecmtd+=$totABANDONSsecdate[$d];
		$totCALLSqtd+=$totCALLSdate[$d];
		$totRESPUESTASqtd+=$totRESPUESTASdate[$d];
		$totRESPUESTASsecqtd+=$totRESPUESTASsecdate[$d];
		$totRESPUESTASspeedqtd+=$totRESPUESTASspeeddate[$d];
		...
		if (trim($totRESPUESTASdate[$d])>$max_answered) {$max_answered=trim($totRESPUESTASdate[$d]);}
		...
		if (round(MathZDC($totRESPUESTASsecdate[$d], $totRESPUESTASdate[$d]))>$max_avgtalktime) 
			{$max_avgtalktime=round(MathZDC($totRESPUESTASsecdate[$d], $totRESPUESTASdate[$d]));}

		if (trim($totRESPUESTASsecdate[$d])>$max_totaltalktime) {$max_totaltalktime=trim($totRESPUESTASsecdate[$d]);}
		if (trim($totRESPUESTASsecdate[$d]+($totRESPUESTASdate[$d]*15))>$max_totalcalltime) {$max_totalcalltime=trim($totRESPUESTASsecdate[$d]+($totRESPUESTASdate[$d]*15));}
		$graph_stats[$d][0]="$daySTART[$d] - $dayEND[$d]";
		$graph_stats[$d][1]=trim($totCALLSdate[$d]);
		$graph_stats[$d][2]=trim($totRESPUESTASdate[$d]);
		$graph_stats[$d][3]=trim($totABANDONSdate[$d]);
		$graph_stats[$d][4]=trim($totABANDONSpctDATE[$d]);
		$graph_stats[$d][5]=trim($totABANDONSavgTIME[$d]);
		$graph_stats[$d][6]=trim($totRESPUESTASavgspeedTIME[$d]);
		$graph_stats[$d][7]=trim($totRESPUESTASavgTIME[$d]);
		$graph_stats[$d][8]=trim($totRESPUESTAStalkTIME[$d]);
		$graph_stats[$d][9]=trim($totRESPUESTASwrapTIME[$d]);
		$graph_stats[$d][10]=trim($totRESPUESTAStotTIME[$d]);
		$graph_stats[$d][17]=trim($totAGENTSday);

		$ASCII_text.="| $daySTART[$d] - $dayEND[$d] | $totCALLSdate[$d] | $totRESPUESTASdate[$d] | $totAGENTSday | $totABANDONSdate[$d] | $totABANDONSpctDATE[$d]%| $totABANDONSavgTIME[$d] | $totRESPUESTASavgspeedTIME[$d] | $totRESPUESTASavgTIME[$d] | $totRESPUESTAStalkTIME[$d] | $totRESPUESTASwrapTIME[$d] | $totRESPUESTAStotTIME[$d] |";
		$CSV_text.="\"$daySTART[$d] - $dayEND[$d]\",\"$totCALLSdate[$d]\",\"$totRESPUESTASdate[$d]\",\"$totAGENTSday\",\"$totABANDONSdate[$d]\",\"$totABANDONSpctDATE[$d]%\",\"$totABANDONSavgTIME[$d]\",\"$totRESPUESTASavgspeedTIME[$d]\",\"$totRESPUESTASavgTIME[$d]\",\"$totRESPUESTAStalkTIME[$d]\",\"$totRESPUESTASwrapTIME[$d]\",\"$totRESPUESTAStotTIME[$d]\"";
		for ($s=0; $s<count($status_array); $s++) {
	...
	$totTIME_MS =		sprintf("%9s", $totTIME_MS);
		...
		$FtotRESPUESTASavgspeedTIME =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($FtotRESPUESTASspeed, $FtotRESPUESTAS)))));
		$FtotRESPUESTASavgTIME =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($FtotRESPUESTASsec, $FtotRESPUESTAS)))));
		$FtotRESPUESTAStalkTIME =	sprintf("%10s", floor(MathZDC($FtotRESPUESTASsec, 3600)).date(":i:s", mktime(0, 0, $FtotRESPUESTASsec)));
		$FtotRESPUESTASwrapTIME =	sprintf("%10s", floor(MathZDC(($FtotRESPUESTAS*15), 3600)).date(":i:s", mktime(0, 0, ($FtotRESPUESTAS*15))));
		$FtotRESPUESTAStotTIME =	sprintf("%10s", floor(MathZDC(($FtotRESPUESTASsec+($FtotRESPUESTAS*15)), 3600)).date(":i:s", mktime(0, 0, ($FtotRESPUESTASsec+($FtotRESPUESTAS*15)))));
		$FtotRESPUESTAS =	sprintf("%8s", $FtotRESPUESTAS);
		...
		if (date("w", strtotime($daySTART[$d]))>0) 
			...
			if (trim($totRESPUESTASavgTIMEwtd)>$max_wtd_avgtalktime) {$max_wtd_avgtalktime=trim($totRESPUESTASavgTIMEwtd);}
			if (trim($totRESPUESTASsecwtd)>$max_wtd_totaltalktime) {$max_wtd_totaltalktime=trim($totRESPUESTASsecwtd);}
			if (trim($totRESPUESTASsecwtd+($totRESPUESTASwtd*15))>$max_wtd_totalcalltime) {$max_wtd_totalcalltime=trim($totRESPUESTASsecwtd+($totRESPUESTASwtd*15));}
			...
			$wtd_RESPUESTAED_graph=preg_replace('/DAILY/', 'WEEK-TO-DATE',$RESPUESTAED_graph);
			...
			$wtd_AVGRESPUESTASPEED_graph=preg_replace('/DAILY/', 'WEEK-TO-DATE',$AVGRESPUESTASPEED_graph);
			...
			for ($q=0; $q<count($wtd_graph_stats); $q++) {
				...
				$wtd_RESPUESTAED_graph.="  <tr><td class='chart_td$class'>".$wtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$wtd_graph_stats[$q][2], $max_wtd_answered))."' height='16' />".$wtd_graph_stats[$q][2]."</td></tr>";
				...
				$wtd_AVGRESPUESTASPEED_graph.="  <tr><td class='chart_td$class'>".$wtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$wtd_graph_stats[$q][12], $max_wtd_avganswerspeed))."' height='16' />".$wtd_graph_stats[$q][6]."</td></tr>";
		...
		if (date("d", strtotime($daySTART[$d]))!=1) 
			...
			if (round(MathZDC($totRESPUESTASsecmtd, $totRESPUESTASmtd))>$max_mtd_avgtalktime)
				{$max_mtd_avgtalktime=round(MathZDC($totRESPUESTASsecmtd, $totRESPUESTASmtd));}
			...
			$mtd_RESPUESTAED_graph=preg_replace('/DAILY/', 'MONTH-TO-DATE',$RESPUESTAED_graph);
			...
			$mtd_AVGRESPUESTASPEED_graph=preg_replace('/DAILY/', 'MONTH-TO-DATE',$AVGRESPUESTASPEED_graph);
			...
			for ($q=0; $q<count($mtd_graph_stats); $q++) {
				...
				$mtd_RESPUESTAED_graph.="  <tr><td class='chart_td$class'>".$mtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$mtd_graph_stats[$q][2], $max_mtd_answered))."' height='16' />".$mtd_graph_stats[$q][2]."</td></tr>";
				...
				$mtd_AVGRESPUESTASPEED_graph.="  <tr><td class='chart_td$class'>".$mtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$mtd_graph_stats[$q][12], $max_mtd_avganswerspeed))."' height='16' />".$mtd_graph_stats[$q][6]."</td></tr>";
				...
				$graph_totRESPUESTASmtd+=$mtd_graph_stats[$q][2];
				...
				$graph_totRESPUESTASavgspeedTIMEmtd+=$mtd_graph_stats[$q][6];
				$graph_totRESPUESTASavgTIMEmtd+=$mtd_graph_stats[$q][7];
				$graph_totRESPUESTAStalkTIMEmtd+=$mtd_graph_stats[$q][8];
				$graph_totRESPUESTASwrapTIMEmtd+=$mtd_graph_stats[$q][9];
				$graph_totRESPUESTAStotTIMEmtd+=$mtd_graph_stats[$q][10];
			}			
	...
	#			{
			...
			if ( (round(MathZDC($totRESPUESTASsecqtd, $totRESPUESTASqtd))>$max_qtd_avgtalktime) )
				{$max_qtd_avgtalktime=round(MathZDC($totRESPUESTASsecqtd, $totRESPUESTASqtd));}
			...
			$qtd_RESPUESTAED_graph=preg_replace('/DAILY/', 'QUARTER-TO-DATE',$RESPUESTAED_graph);
			...
			$qtd_AVGRESPUESTASPEED_graph=preg_replace('/DAILY/', 'QUARTER-TO-DATE',$AVGRESPUESTASPEED_graph);
			...
			for ($q=0; $q<count($qtd_graph_stats); $q++) {
				...
				$qtd_RESPUESTAED_graph.="  <tr><td class='chart_td$class'>".$qtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$qtd_graph_stats[$q][2], $max_qtd_answered))."' height='16' />".$qtd_graph_stats[$q][2]."</td></tr>";
				...
				$qtd_AVGRESPUESTASPEED_graph.="  <tr><td class='chart_td$class'>".$qtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$qtd_graph_stats[$q][12], $max_qtd_avganswerspeed))."' height='16' />".$qtd_graph_stats[$q][6]."</td></tr>";
				...
				$graph_totRESPUESTASqtd+=$qtd_graph_stats[$q][2];
				...
				$graph_totRESPUESTASavgspeedTIMEqtd+=$qtd_graph_stats[$q][6];
				$graph_totRESPUESTASavgTIMEqtd+=$qtd_graph_stats[$q][7];
				$graph_totRESPUESTAStalkTIMEqtd+=$qtd_graph_stats[$q][8];
				$graph_totRESPUESTASwrapTIMEqtd+=$qtd_graph_stats[$q][9];
				$graph_totRESPUESTAStotTIMEqtd+=$qtd_graph_stats[$q][10];
			}
	...
	#			}
			...
			for ($q=0; $q<count($graph_stats); $q++) {
				...
				$RESPUESTAED_graph.="  <tr><td class='chart_td$class'>".$graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$graph_stats[$q][2], $max_answered))."' height='16' />".$graph_stats[$q][2]."</td></tr>";
				...
				$AVGRESPUESTASPEED_graph.="  <tr><td class='chart_td$class'>".$graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$graph_stats[$q][12], $max_avganswerspeed))."' height='16' />".$graph_stats[$q][6]."</td></tr>";
			...
			$RESPUESTAED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTAS)."</th></tr></table>";
			...
			$AVGRESPUESTASPEED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTASavgspeedTIME)."</th></tr></table>";
			$AVGTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTASavgTIME)."</th></tr></table>";
			$TOTALTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTAStalkTIME)."</th></tr></table>";
			$TOTALWRAPTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTASwrapTIME)."</th></tr></table>";
			$TOTALCALLTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTAStotTIME)."</th></tr></table>";
			$JS_onload.="\tDrawGraph('OFFERED', '1');\n"; 
			$JS_text.="function DrawGraph(graph, th_id) {\n";
			$JS_text.="	var OFFERED_graph=\"$OFFERED_graph\";\n";
			$JS_text.="	var RESPUESTAED_graph=\"$RESPUESTAED_graph\";\n";
			...
			$JS_text.="	var AVGRESPUESTASPEED_graph=\"$AVGRESPUESTASPEED_graph\";\n";
			...
			$wtd_RESPUESTAED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTAS)."</th></tr></table>";
			...
			$wtd_AVGRESPUESTASPEED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTASavgspeedTIME)."</th></tr></table>";
			$wtd_AVGTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTASavgTIME)."</th></tr></table>";
			$wtd_TOTALTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTAStalkTIME)."</th></tr></table>";
			$wtd_TOTALWRAPTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTASwrapTIME)."</th></tr></table>";
			$wtd_TOTALCALLTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTAStotTIME)."</th></tr></table>";
			$JS_onload.="\tDrawWTDGraph('OFFERED', '1');\n"; 
			$JS_text.="function DrawWTDGraph(graph, th_id) {\n";
			$JS_text.="	var OFFERED_graph=\"$wtd_OFFERED_graph\";\n";
			$JS_text.="	var RESPUESTAED_graph=\"$wtd_RESPUESTAED_graph\";\n";
			...
			$JS_text.="	var AVGRESPUESTASPEED_graph=\"$wtd_AVGRESPUESTASPEED_graph\";\n";
			...
			$mtd_RESPUESTAED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTAS)."</th></tr></table>";
			...
			$mtd_AVGRESPUESTASPEED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTASavgspeedTIME)."</th></tr></table>";
			$mtd_AVGTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTASavgTIME)."</th></tr></table>";
			$mtd_TOTALTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTAStalkTIME)."</th></tr></table>";
			$mtd_TOTALWRAPTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTASwrapTIME)."</th></tr></table>";
			$mtd_TOTALCALLTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTAStotTIME)."</th></tr></table>";
			$JS_onload.="\tDrawMTDGraph('OFFERED', '1');\n"; 
			$JS_text.="function DrawMTDGraph(graph, th_id) {\n";
			$JS_text.="	var OFFERED_graph=\"$mtd_OFFERED_graph\";\n";
			$JS_text.="	var RESPUESTAED_graph=\"$mtd_RESPUESTAED_graph\";\n";
			...
			$JS_text.="	var AVGRESPUESTASPEED_graph=\"$mtd_AVGRESPUESTASPEED_graph\";\n";
			...
			$qtd_RESPUESTAED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTAS)."</th></tr></table>";
			...
			$qtd_AVGRESPUESTASPEED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTASavgspeedTIME)."</th></tr></table>";
			$qtd_AVGTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTASavgTIME)."</th></tr></table>";
			$qtd_TOTALTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTAStalkTIME)."</th></tr></table>";
			$qtd_TOTALWRAPTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTASwrapTIME)."</th></tr></table>";
			$qtd_TOTALCALLTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPUESTAStotTIME)."</th></tr></table>";
			$JS_onload.="\tDrawQTDGraph('OFFERED', '1');\n"; 
			$JS_text.="function DrawQTDGraph(graph, th_id) {\n";
			$JS_text.="	var OFFERED_graph=\"$qtd_OFFERED_graph\";\n";
			$JS_text.="	var RESPUESTAED_graph=\"$qtd_RESPUESTAED_graph\";\n";
			...
			$JS_text.="	var AVGRESPUESTASPEED_graph=\"$qtd_AVGRESPUESTASPEED_graph\";\n";
	...
	$ASCII_text.="$MAINH\n";
	$ASCII_text.="|                                    TOTALS | $FtotCALLS | $FtotRESPUESTAS | $FtotAGENTS | $FtotABANDONS | $FtotABANDONSpct%| $FtotABANDONSavgTIME | $FtotRESPUESTASavgspeedTIME | $FtotRESPUESTASavgTIME | $FtotRESPUESTAStalkTIME | $FtotRESPUESTASwrapTIME | $FtotRESPUESTAStotTIME |";
	$CSV_text.="\"TOTALS\",\"$FtotCALLS\",\"$FtotRESPUESTAS\",\"$FtotAGENTS\",\"$FtotABANDONS\",\"$FtotABANDONSpct%\",\"$FtotABANDONSavgTIME\",\"$FtotRESPUESTASavgspeedTIME\",\"$FtotRESPUESTASavgTIME\",\"$FtotRESPUESTAStalkTIME\",\"$FtotRESPUESTASwrapTIME\",\"$FtotRESPUESTAStotTIME\"";
	for ($s=0; $s<count($status_array); $s++) {
