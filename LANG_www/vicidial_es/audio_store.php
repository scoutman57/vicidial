...
<title>ADMINISTRATION: Almacén de Audio
<?php
...
?>
<TABLE WIDTH=<?php echo $page_width ?> BGCOLOR=#E6E6E6 cellpadding=2 cellspacing=0><TR BGCOLOR=#E6E6E6><TD ALIGN=LEFT><FONT FACE="ARIAL,HELVETICA" SIZE=2><B> &nbsp; Almacén de Audio</TD><TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA" SIZE=2><B> &nbsp; </TD></TR>
...
<table align=center width="700" border=0 cellpadding=5 cellspacing=0 bgcolor=#D9E6FE>
  <tr>
	<td align=right width="35%"><B><font face="arial, helvetica" size=2>Cargar Archivo de Audio:</font></B></td>
	<td align=left width="65%"><input type=file name="audiofile" value=""> <?php echo "$NWB#audio_store$NWE"; ?></td>
  </tr>
  <tr>
	<td align=center colspan=2><input type=submit name=submit value=submit></td>
  </tr>
  <tr><td align=left><font size=1> &nbsp; </font></td><td align=right><font size=1>Almacén de Audio- &nbsp; &nbsp; VERSIÓN: <?php echo $version ?> &nbsp; &nbsp; CONSTRUCCION: <?php echo $build ?> &nbsp; &nbsp; </td></tr>
</table>
</form>
<BR><BR>
<CENTER><B>Le recomendamos ENCARECIDAMENTE cargar unicamente alrchivo de audio .wav 16 bits Mono 8k (.wav)</B>
<BR><BR><font size=1>Todos los espacios se eliminan de los nombres de archivo de audio cargados </font><BR><BR>
...
echo "</B></B><br><br><a href=\"admin.php?ADD=720000000000000&category=AUDIOSTORE&stage=manualupload\">Haga clic aquí para ver un registro de los archivos cargados al almacén de audio</FONT>\n";
