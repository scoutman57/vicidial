...
$report_name = 'Exportar Informe de Marcaciones';
$db_source = 'M';
$file_exported=0;
...
##### END RUN THE EXPORT AND OUTPUT FLAT DATA FILE #####
	...
	echo "<CENTER><BR>\n";
	echo "<FONT SIZE=3 FACE=\"Arial,Helvetica\"><B>Exportar Informe de Marcaciones";
	if ($ivr_export == 'YES')
		{echo " IVR";}
	echo "</B></FONT><BR><BR>\n";
...
if ($file_exported > 0)
	...
	$stmt="INSERT INTO vicidial_admin_log set event_date='$NOW_TIME', user='$PHP_AUTH_USER', ip_address='$ip', event_section='LEADS', event_type='EXPORT', record_id='', event_code='ADMIN EXPORTAR INFORME DE MARCACIONES', event_sql=\"$SQL_log\", event_notes='';";
	if ($DB) {echo "|$stmt|\n";}
	$rslt=mysql_to_mysqli($stmt, $link);
	}
