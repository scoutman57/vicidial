...
function ShowProgress(good, bad, total, dup, inv, post) 
	...
	parent.lead_count.document.write('<html><body><table border=0 width=200 cellpadding=10 cellspacing=0 align=center valign=top><tr bgcolor="#000000"><th colspan=2><font face="arial, helvetica" size=3 color=white>Estado actual del archivo:</font></th></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B>Good:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+good+'</B></font></td></tr><tr bgcolor="#990000"><td align=right><font face="arial, helvetica" size=2 color=white><B>Bad:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+bad+'</B></font></td></tr><tr bgcolor="#000099"><td align=right><font face="arial, helvetica" size=2 color=white><B>Total:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+total+'</B></font></td></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B> &nbsp; </B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B> &nbsp; </B></font></td></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B>Duplicate:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+dup+'</B></font></td></tr></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B>Invalid:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+inv+'</B></font></td></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B>Postal Match:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+post+'</B></font></td></tr></table><body></html>');
...
if ( (!$OK_to_process) or ( ($leadfile) and ($file_layout!="standard" && $file_layout!="template") ) )
	...
	if ($file_layout!="custom") 
		...
		<table align=center width="780" border=0 cellpadding=5 cellspacing=0 bgcolor=#D9E6FE>
		  <tr>
			<td align=right width="35%"><B><font face="arial, helvetica" size=2>Cargar Contactos de este archivo:</font></B></td>
			<td align=left width="65%"><input type=file name="leadfile" value="<?php echo $leadfile ?>"> <?php echo "$NWB#list_loader$NWE"; ?></td>
		  </tr>
		  <tr>
			<td align=right width="25%"><font face="arial, helvetica" size=2>ID de Lista Override: </font></td>
			<td align=left width="75%"><font face="arial, helvetica" size=1>
			<select name='list_id_override' onchange="PopulateEstados(this.value)">
			<option value='in_file' selected='yes'>Cargar desde un archivo de prospectos</option>
			<?php
		  ...
		  <tr>
			<td align=right width="25%"><font face="arial, helvetica" size=2>Invalidar Código Teléfonico: </font></td>
			<td align=left width="75%"><font face="arial, helvetica" size=1>
		  ...
		  <tr>
			<td align=right><B><font face="arial, helvetica" size=2>Plantilla de archivo a utilizar:</font></B></td>
			<td align=left><font face="arial, helvetica" size=2><input type=radio name="file_layout" value="standard" checked>Standard Format&nbsp;&nbsp;&nbsp;&nbsp;<input type=radio name="file_layout" value="custom">Plantilla Personalizada&nbsp;&nbsp;&nbsp;&nbsp;<input type=radio name="file_layout" value="template">Custom Template <?php echo "$NWB#list_loader-file_layout$NWE"; ?></td>
		  </tr>
		  <tr>
			<td align=right valign=top><B><font face="arial, helvetica" size=2>Plantilla Personalizada a utilizar:</font></B></td>
...
<?php
				...
				if (mysqli_num_rows($template_rslt)>0) {
					echo "<option value='' selected>--Seleccione Plantilla Personalizada--</option>";
...
?>
			</select> <a href='AST_admin_template_maker.php'><font face="arial, helvetica" size=1>constructor de Plantillas</font></a><?php echo "$NWB#list_loader-template_id$NWE"; ?><BR><a href='#' onClick="TemplateSpecs()"><font face="arial, helvetica" size=1>View template info</font></a></td>
		  <tr>
			<td align=right width="25%"><font face="arial, helvetica" size=2>Verificar Duplicidad de Contacto:</font></td>
			...
			<option value="DUPLIST">CHECK FOR DUPLICATES BY PHONE IN LISTA  ID</option>
			<option value="DUPCAMP">COMPRUEBAR DUPLICADOS POR TELEFONO EN TODAS LAS LISTAS DE LA CAMPAÑA</option>
			<option value="DUPSYS">COMPRUEBAR DUPLICADOS POR TELEFONO EN TODO EL SISTEMA</option>
			<option value="DUPTITLEALTPHONELIST">CHECK FOR DUPLICATES BY TITLE/ALT-PHONE IN LISTA  ID</option>
	...
	<tr bgcolor="#D9E6FE">
		<td width='25%' align="right"><font class="standard">Estado Duplicate Check:</font></td>
		<td width='75%'>
		<span id='statuses_display'>
		  ...
		  <tr>
			...
			<option value="CÓDIGOÁREA">CHECK FOR VALID CÓDIGOÁREA</option>
			<option value="PREFIX_CÓDIGOÁREA">CHECK FOR VALID PREFIX and CÓDIGOÁREA</option>
			<option value="NANPA">CHECK FOR VALID NANPA PREFIX and CÓDIGOÁREA</option>
			</select></td>
		  </tr>
		  <tr>
			<td align=right width="25%"><font face="arial, helvetica" size=2>Búsqueda de Zona horaria de Contacto:</font></td>
			...
			<option value="NANPA">NANPA CÓDIGOÁREA PREFIX FIRST</option>
			</select></td>
		  </tr>
		<tr>
			<td align=center colspan=2><input type=submit value="REMITIR" name='submit_file'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button onClick="javascript:document.location='admin_listloader_fourth_gen.php'" value="RECARGAR" name='reload_page'></td>
		  </tr>
		  <tr><td align=left><font size=1> &nbsp; &nbsp; &nbsp; &nbsp; <a href="admin.php?ADD=100" target="_parent">VOLVER A ADMIN</a> &nbsp; &nbsp; &nbsp; &nbsp; <a href="./admin_listloader_third_gen.php">Old Lead Loader</a> &nbsp; &nbsp; </font></td><td align=right><font size=1>LIST LOADER 4th Gen- &nbsp; &nbsp; VERSIÓN: <?php echo $version ?> &nbsp; &nbsp; CONSTRUCCION: <?php echo $build ?> &nbsp; &nbsp; </td></tr>
		</table>
		<?php 
	...
	<tr>
	<td align=right width="35%"><B><font face="arial, helvetica" size=2>ID de Lista Override:</font></B></td>
	<td align=left width="75%"><font face="arial, helvetica" size=2><?php echo $list_id_override ?></font></td>
	</tr>
	<tr>
	<td align=right width="35%"><B><font face="arial, helvetica" size=2>Invalidar Código Teléfonico:</font></B></td>
	...
	<input type=hidden name='leadfile_name' value="<?php echo $leadfile_name ?>">
	<input type=hidden name='DB' value="<?php echo $DB ?>">
	<a href="admin_listloader_fourth_gen.php">Load Another Lead File</a> &nbsp; &nbsp; &nbsp; &nbsp;</font></B> <font size=1>VERSIÓN: <?php echo $version ?> &nbsp; &nbsp; CONSTRUCCION: <?php echo $build ?>
	</font></td>
	</tr></table>
	<BR><BR><BR><BR>
	<?php
...
if ($OK_to_process) 
	...
	if (count($field_check)>=2) 
		...
		flush();
		$file=fopen("$lead_file", "r");
		print "<center><font face='arial, helvetica' size=3 color='#009900'><B>Procesando file...\n";
		...
		if (strlen($list_id_override)>0) 
			{
			print "<BR><BR>LISTA  ID OVERRIDE FOR THIS FILE: $list_id_override<BR><BR>";
			}

		if (strlen($phone_code_override)>0) 
			{
			print "<BR><BR>INVALIDAR CÓDIGO TELÉFONO PARA ESTE ARCHIVO: $phone_code_override<BR><BR>";
			}
		if (strlen($status_dedupe_str)>0) 
			{
			print "<BR>OMITIENDO DUPLICADOS CONTRA siguientes estados SOLAMENTE: $status_dedupe_str<BR>\n";
			}
		...
		if ($custom_fields_enabled > 0)
			...
			$stmt="MOSTRAR TABLAS LIKE \"custom_$list_id_override\";";
			if ($DB>0) {echo "$stmt\n";}
			$rslt=mysql_to_mysqli($stmt, $link);
		...
		while (!feof($file)) 
			...
			if (strlen($buffer)>0) 
				...
				if ( (preg_match("/CÓDIGOÁREA/",$usacan_check)) and ($valid_number > 0) )
					{
					...
					if ($valid_number < 1)
						{
						$invalid_reason = "INVALID PHONE NUMBER CÓDIGOÁREA";
						}
					}
				if ( (preg_match("/NANPA/",$usacan_check)) and ($valid_number > 0) )
					...
					if ($valid_number < 1)
						{
						$invalid_reason = "INVALID PHONE NUMBER NANPA CÓDIGOÁREA PREFIX";
						}
					}
				...
				if ( ($valid_number>0) and ($dup_lead<1) and ($list_id >= 100 ))
					...
					if ($bad < 1000000)
						...
						if ( $list_id < 100 )
							{
							print "<BR></b><font size=1 color=red>record $total BAD- PHONE: $phone_number ROW: |$row[0]| INVALID LISTA  ID</font><b>\n";
							}
						else
							{
							if ($valid_number < 1)
		...
		{
		print "<center><font face='arial, helvetica' size=3 color='#990000'><B>ERROR: El archivo no tiene el número requerido de campos para procesarlo.</B></font></center>";
		}
	}
...
if (($leadfile) && ($LF_path))
	...
	if ($file_layout=="template"  && $template_id) 
		...
		if (count($field_check)>=2) 
			...
			$file=fopen("$lead_file", "r");
			$total=0; $good=0; $bad=0; $dup=0; $post=0; $phone_list='';
			print "<center><font face='arial, helvetica' size=3 color='#009900'><B>Procesando $delim_name file using template $template_id... ($tab_count|$pipe_count)\n";
			if (strlen($list_id_override)>0) 
				{
				print "<BR>LISTA  ID OVERRIDE FOR THIS FILE: $list_id_override<BR>";
				}
			if (strlen($phone_code_override)>0) 
				{
				print "<BR>INVALIDAR CÓDIGO TELÉFONO PARA ESTE ARCHIVO: $phone_code_override<BR>\n";
				}
			if (strlen($template_statuses)>0) 
				{
				print "<BR>OMITIENDO DUPLICADOS CONTRA siguientes estados SOLAMENTE: ".preg_replace('/\'/', '', $template_statuses)."<BR>\n";
				}
			while (!feof($file)) 
				{
				$record++;
...
/*
	...
	if ($file_layout=="standard") 
		...
		if (count($field_check)>=2) 
			...
			$file=fopen("$lead_file", "r");
			$total=0; $good=0; $bad=0; $dup=0; $post=0; $phone_list='';
			print "<center><font face='arial, helvetica' size=3 color='#009900'><B>Procesando $delim_name file... ($tab_count|$pipe_count)\n";
	...
	##### BEGIN field chooser #####
		...
		flush();
		$file=fopen("$lead_file", "r");
		print "<center><font face='arial, helvetica' size=3 color='#009900'><B>Procesando $delim_name file...\n";
		...
		print "    <th colspan=2><input type=submit name='OK_to_process' value='ACEPTABLE PROCESAR'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button onClick=\"javascript:document.location='admin_listloader_fourth_gen.php'\" value=\"RECARGAR\" name='reload_page'></th>\r\n";
		print "  </tr>\r\n";
		print "</table>\r\n";
