...
<title>ADMINISTRATION: Campaña Listas Reset
...
if ( ($LOGuser_level >= 9) and $LOGmodify_campaigns>0 and $LOGmodify_lists>0 and ( (preg_match("/Administration Change Log/",$LOGallowed_reports)) or (preg_match("/ALL INFORMES/",$LOGallowed_reports)) ) )
	{
	...
	echo "<br><B>Restablecer Lead-Called Estado para campañas:</B><BR><BR>\n";
	...
	echo "<option value='Y'>Activo lists only</option>";
	echo "<option value=''>All lists</option>";
	echo "</select>";
	echo "</td>";
	echo "<td align='right'><input type='submit' name='submit_campaign_reset' value='REMITIR'></td></tr>";
