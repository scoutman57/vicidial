...
$report_name = 'UsuarioReloj de tiempo Report';
$db_source = 'M';
...
$MAIN.="<FONT class=\"select_bold\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; <a href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date&order=$order&user=$user&ENVIAR=$ENVIAR&file_download=1\">DESCARGAR</a><FONT class=\"select_bold\" COLOR=BLACK SIZE=2> &nbsp; | &nbsp; <a href=\"./admin.php?ADD=999999\">INFORMES</a> </FONT>\n";
...
$MAIN.="UsuarioReloj de tiempo Report                        $NOW_TIME\n";

$CSV_text.="\"UsuarioReloj de tiempo Report - $NOW_TIME\"\n";
...
if (!$report_display_type || $report_display_type=="TEXT") 
	...
	$MAIN.="</PRE>\n";
	$MAIN.="<table cellspacing=\"0\" cellpadding=\"0\" summary=\"CONVOCATORIA colgar RAZÓN ESTADÍSTICAS\" class=\"horizontalgraph\">\n";
	...
	for ($i=0; $i<count($ct_ary); $i++) {
		...
		$MAIN.="	<td class=\"chart_td value$class\"><img src=\"../vicidial/images/bar.png\" alt=\"\" width=\"".round(400*$ct_ary[$i][1]/$high_ct)."\" height=\"16\" />".$ct_ary[$i][1]."</td>\n";
		$MAIN.="  </tr>\n";
	}
	$MAIN.="  <tr>\n";
