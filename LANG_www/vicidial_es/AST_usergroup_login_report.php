...
$report_name = 'Grupo Del Usuario Login Report';
$db_source = 'M';
...
if ($REMITIR=="REMITIR") 
	{
	$ASCII_text="+--------------------------------+----------+----------------------+---------------------+---------------------+----------+-----------------+-----------------+----------------------+--------------+-----------------+-----------------+-----------------+\n";
	$ASCII_text.="| USER NAME                      | ID       | GRUPO DE USUARIOS           | FIRST LOGIN DATE    | LAST LOGIN DATE     | CAMPAIGN | SERVIDOR IP       | COMPUTER IP     | EXTENSION            | BROWSER      | PHONE LOGIN     |  SERVIDOR PHONE   | PHONE IP        |\n";
	$ASCII_text.="+--------------------------------+----------+----------------------+---------------------+---------------------+----------+-----------------+-----------------+----------------------+--------------+-----------------+-----------------+-----------------+\n";

	$CSV_text="\"Usuario group login report\",\"Usuario groups:\",\"$user_group_string\"\n\n";
	$CSV_text.="\"Usuario name\",\"Usuario ID\",\"Usuario group\",\"First login date\",\"Last login date\",\"ID De la Campaña\",\"IP del Servidor\",\"Computer IP\",\"Extension\",\"Browser\",\"Phone login\",\"Server phone\",\"Phone IP\"\n";
