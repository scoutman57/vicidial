...
if (strlen($group[0]) < 1)
	...
	$OUToutput .= "Average Call Length for all HA en segundo:    $average_ci_seconds     Total Time: $CIsec\n";
	...
	$ASCII_text .= "\n";
	$ASCII_text .= "---------- CONVOCATORIA colgar RAZÓN ESTADÍSTICAS\n";
	$ASCII_text .= "+----------------------+------------+\n";
	...
	$GRAPH.="<caption align='top'>CONVOCATORIA colgar RAZÓN ESTADÍSTICAS</caption>";
	$GRAPH.="<tr>\n";
