...
$MAIN.="<BR><BR><BR><CENTER><INPUT TYPE=submit NAME=ENVIAR VALUE=ENVIAR></CENTER>\n";
$MAIN.="</FONT>\n";
...
$MAIN.=$rpt_title;
$MAIN.="Email log results: $group_string          $NOW_TIME        <a href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&ENVIAR=$ENVIAR&file_download=1&date_type=$date_type&email_type=$email_type\">DESCARGAR</a>\n";
