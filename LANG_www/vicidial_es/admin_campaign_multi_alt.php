...
if ($camp_multi < 1)
	{
	echo "Esta campaña no está establecido en Auto-Alt-Dial MULTI_LEAD\n";
	exit;
	}
...
if ($action == "BLANK")
	...
	echo "<br>Multi-plomo Auto ajustes de marcado Alt Formulario<form action=$PHP_SELF method=POST>\n";
	...
	echo "<tr bgcolor=#B6D3FC><td align=right>Lista de Secundaria Orden: </td><td align=left><select size=1 name=lead_order_secondary><option>LEAD_ASCEND</option><option>LEAD_DESCEND</option><option>CALLTIME_ASCEND</option><option>CALLTIME_DESCEND</option><option SELECTED>$lead_order_secondary</option></select></td></tr>\n";
