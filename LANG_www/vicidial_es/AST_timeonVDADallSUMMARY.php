...
if (!isset($types))			{$types='DEMOSTRACIÓN ALL CAMPAÑAS';}
...
$MAIN.="<option value=\"DEMOSTRACIÓN ALL CAMPAÑAS\"";
	if ($types == 'DEMOSTRACIÓN ALL CAMPAÑAS') {$MAIN.=" selected";} 
$MAIN.=">DEMOSTRACIÓN ALL CAMPAÑAS</option>";
...
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>DIAL MÉTODO:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DIALmethod &nbsp; &nbsp; </TD>";
$MAIN.="</TR>";
$CSV_text.="\"DIALABLE LEADS:\",\"$DAleads\",\"CALLS TODAY:\",\"$callsTODAY\",\"AVG AGENTS:\",\"$agentsONEMIN\",\"DIAL MÉTODO:\",\"$DIALmethod\"\n";
