...
if (!isset($types))			{$types='MOSTRAR ALL CAMPAÑAS';}
...
$MAIN.="<b>Tiempo Real All Campañas Summary</b> &nbsp; &nbsp; &nbsp; \n";
...
$MAIN.=" &nbsp; &nbsp; &nbsp;<a href=\"$PHP_SELF?group=$group&RR=$RR&DB=$DB&adastats=$adastats&types=$types&file_download=1\">DESCARGAR</a> | <a href=\"./admin.php?ADD=999999\">INFORMES</a>";
$MAIN.="\n";
...
$MAIN.="<option value=\"MOSTRAR ALL CAMPAÑAS\"";
	if ($types == 'MOSTRAR ALL CAMPAÑAS') {$MAIN.=" selected";} 
$MAIN.=">MOSTRAR ALL CAMPAÑAS</option>";
...
$MAIN.="</select> \n";
$MAIN.="<input type=submit name=submit value='REMITIR'>\n";
$MAIN.="<BR><BR>\n\n";
...
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>DIAL NIVEL:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DIALlev&nbsp; &nbsp; </TD>";
...
$CSV_text.="\"DIAL NIVEL:\",\"$DIALlev\",\"TRUNK SHORT/FILL:\",\"$balanceSHORT / $balanceFILL\",\"FILTER:\",\"$DIALfilter\",\"TIME:\",\"$NOW_TIME\"\n";

if ($adastats>1)
	{
	$MAIN.="<TR BGCOLOR=\"#CCCCCC\">";
	$MAIN.="<TD ALIGN=RIGHT><font size=2>&nbsp; <B>MAX NIVEL:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $maxDIALlev &nbsp; </TD>";
	...
	$MAIN.="</TR>";
	$CSV_text.="\"MAX NIVEL:\",\"$maxDIALlev\",\"DROPPED MAX:\",\"$DROPmax\",\"TARGET DIFF:\",\"$targetDIFF\",\"INTENSITY:\",\"$ADAintense\"\n";
...
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>MÉTODO MARCACION:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DIALmethod &nbsp; &nbsp; </TD>";
$MAIN.="</TR>";
$CSV_text.="\"DIALABLE LEADS:\",\"$DAleads\",\"CALLS TODAY:\",\"$callsTODAY\",\"AVG AGENTS:\",\"$agentsONEMIN\",\"MÉTODO MARCACION:\",\"$DIALmethod\"\n";

$MAIN.="<TR>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>HOPPER NIVEL:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $HOPlev &nbsp; &nbsp; </TD>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>DROPPED / RESPUESTAED:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $dropsTODAY / $answersTODAY &nbsp; </TD>";
...
$MAIN.="</TR>";
$CSV_text.="\"HOPPER NIVEL:\",\"$HOPlev\",\"DROPPED / RESPUESTAED:\",\"$dropsTODAY / $answersTODAY\",\"DL DIFF:\",\"$diffONEMIN\",\"STATUSES:\",\"$DIALstatuses\"\n";
...
$parked_to_print = mysqli_num_rows($rslt);
	...
	{
	$MAIN.=" LLAMADAS EN ESPERA NO ACTIVAS \n";
