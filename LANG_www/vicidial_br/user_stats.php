...
if ($did < 1)
	...
	$MAIN.="<tr><td><font size=2>EVENTO</td><td align=right><font size=2> DATA</td><td align=right><font size=2> CAMPANHA</td><td align=right><font size=2> GROUP</td><td align=right><font size=2>HOURS:MM:SS</td><td align=right><font size=2>SESSION</td><td align=right><font size=2>SERVER</td><td align=right><font size=2>PHONE</td><td align=right><font size=2>COMPUTER</td></tr>\n";

	$CSV_text2.="\"AGENTE HORÁRIO DE LOGIN/LOGOUT\"\n";
	$CSV_text2.="\"\",\"EVENT\",\"DATE\",\"CAMPANHA\",\"GROUP\",\"HOURS:MM:SS\",\"SESSION\",\"SERVER\",\"PHONE\",\"COMPUTER\"\n";
