...
$report_name = 'Called Counts ID da Listas Report';
$db_source = 'M';
...
$HEADER.="			selectedCampanhas += document.getElementById('group').options[i].value+\"|\";\n";
$HEADER.="		} \n";
$HEADER.="	}\n";
$HEADER.="\n";
$HEADER.="	// Limpar Lista menu\n";
$HEADER.="	document.getElementById('list_ids').options.length=0;\n";
$HEADER.="	var new_list = new Opção();\n";
...
$HEADER.="		var campaign_matches = selectedCampanhas.match(campaignID);\n";
...
$MAIN.="<TABLE CELLSPACING=3><TR><TD VALIGN=TOP><input type='checkbox' name='override_date' value='1' checked>All dates<BR><BR>Datas:<BR>";
...
$MAIN.="Listas: <font size=1>(opcional, possivelmente lento)</font><BR>\n";
$MAIN.=$list_options;
...
if (strlen($QUERY_STRING) > 5)
	...
	$CSV_text="";
	$MAIN.="<center>\n";
	$MAIN.="<br><b>CALLED COUNTS WITHIN LIST(S) $list_id_title_str$date_range_title:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"$PHP_SELF?DB=$DB$groupQS$list_idQS&query_date=$query_date&end_date=$end_date&override_date=$override_date&ENVIAR=$ENVIAR&file_download=1\">[DOWNLOAD]</a></b><br>\n";
	$CSV_text.="CALLED COUNTS WITHIN LIST(S) $list_id_title_str$date_range_title:\n";
	$MAIN.="<TABLE width=700 cellspacing=1>\n";
	$MAIN.="<tr><td align=left><font size=1>STATUS</td><td align=center><font size=1>NOME DO STATUS</td>";
	$CSV_text.="\"STATUS\",\"NOME DO STATUS\",";
