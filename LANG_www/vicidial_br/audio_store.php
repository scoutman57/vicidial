...
if ( (!preg_match("/\|$ip\|/", $server_ips)) and ($formIPvalid < 1) )
	...
	if( (strlen($PHP_AUTH_USER)<2) or (strlen($PHP_AUTH_PW)<2) or (!$auth))
		...
		echo "Nome ou Senha inválidos: |$PHP_AUTH_USER|$PHP_AUTH_PW|$ip|\n";
		exit;
		}
	}
...
<table align=center width="700" border=0 cellpadding=5 cellspacing=0 bgcolor=#D9E6FE>
  ...
  <tr><td align=left><font size=1> &nbsp; </font></td><td align=right><font size=1>Audio de la tienda- &nbsp; &nbsp; VERSÃO: <?php echo $version ?> &nbsp; &nbsp; BUILD: <?php echo $build ?> &nbsp; &nbsp; </td></tr>
</table>
</form>
<BR><BR>
<CENTER><B>Recomendamos fortemente que carregar apenas 16bit Mono 8k arquivos de áudio PCM WAV(.wav)</B>
<BR><BR><font size=1>Todos os espaços serão removidos de enviados os nomes dos arquivos de áudio </font><BR><BR>
...
if ($auth_delete > 0)
	{
	echo "<center><BR><BR>Arquivo a ser excluído:<BR>\n";
...
echo "</B></B><br><br><a href=\"admin.php?ADD=720000000000000&category=AUDIOSTORE&stage=manualupload\">Clique aqui para ver um registro dos uploads para o armazenamento de áudio</FONT>\n";
