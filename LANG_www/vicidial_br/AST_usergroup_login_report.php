...
$report_name = 'Grupo do Usuário Login Report';
$db_source = 'M';
...
if ($ENVIAR=="ENVIAR") 
	{
	$ASCII_text="+--------------------------------+----------+----------------------+---------------------+---------------------+----------+-----------------+-----------------+----------------------+--------------+-----------------+-----------------+-----------------+\n";
	$ASCII_text.="| USER NAME                      | ID       | GRUPO DE USUÁRIOS           | FIRST LOGIN DATE    | LAST LOGIN DATE     | CAMPANHA | SERVIDOR IP       | COMPUTER IP     | EXTENSION            | BROWSER      | PHONE LOGIN     |  SERVIDOR PHONE   | PHONE IP        |\n";
	$ASCII_text.="+--------------------------------+----------+----------------------+---------------------+---------------------+----------+-----------------+-----------------+----------------------+--------------+-----------------+-----------------+-----------------+\n";

	$CSV_text="\"Usuário group login report\",\"Usuário groups:\",\"$user_group_string\"\n\n";
	$CSV_text.="\"Usuário name\",\"Usuário ID\",\"Usuário group\",\"First login date\",\"Last login date\",\"ID da Campanha\",\"IP do Servidor\",\"Computer IP\",\"Extension\",\"Browser\",\"Phone login\",\"Server phone\",\"Phone IP\"\n";
