...
if (!isset($types))			{$types='MOSTRAR ALL CAMPANHAS';}

$report_name = 'Tempo Real Campanha Summary';
$db_source = 'M';
...
$MAIN.="<b>Tempo Real All Campanhas Summary</b> &nbsp; &nbsp; &nbsp; \n";
...
$MAIN.=" &nbsp; &nbsp; &nbsp;<a href=\"$PHP_SELF?group=$group&RR=$RR&DB=$DB&adastats=$adastats&types=$types&file_download=1\">DOWNLOAD</a> | <a href=\"./admin.php?ADD=999999\">RELATÓRIOS</a>";
$MAIN.="\n";
...
$MAIN.="<option value=\"MOSTRAR ALL CAMPANHAS\"";
	if ($types == 'MOSTRAR ALL CAMPANHAS') {$MAIN.=" selected";} 
$MAIN.=">MOSTRAR ALL CAMPANHAS</option>";
...
$MAIN.="</select> \n";
$MAIN.="<input type=submit name=submit value='ENVIAR'>\n";
$MAIN.="<BR><BR>\n\n";
...
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>DIAL NÍVEL:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DIALlev&nbsp; &nbsp; </TD>";
...
$CSV_text.="\"DIAL NÍVEL:\",\"$DIALlev\",\"TRUNK SHORT/FILL:\",\"$balanceSHORT / $balanceFILL\",\"FILTER:\",\"$DIALfilter\",\"TIME:\",\"$NOW_TIME\"\n";

if ($adastats>1)
	{
	$MAIN.="<TR BGCOLOR=\"#CCCCCC\">";
	$MAIN.="<TD ALIGN=RIGHT><font size=2>&nbsp; <B>MAX NÍVEL:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $maxDIALlev &nbsp; </TD>";
	...
	$MAIN.="</TR>";
	$CSV_text.="\"MAX NÍVEL:\",\"$maxDIALlev\",\"DROPPED MAX:\",\"$DROPmax\",\"TARGET DIFF:\",\"$targetDIFF\",\"INTENSITY:\",\"$ADAintense\"\n";
...
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>MÉTODO DE DISC.:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DIALmethod &nbsp; &nbsp; </TD>";
$MAIN.="</TR>";
$CSV_text.="\"DIALABLE LEADS:\",\"$DAleads\",\"CALLS TODAY:\",\"$callsTODAY\",\"AVG AGENTS:\",\"$agentsONEMIN\",\"MÉTODO DE DISC.:\",\"$DIALmethod\"\n";

$MAIN.="<TR>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>HOPPER NÍVEL:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $HOPlev &nbsp; &nbsp; </TD>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>DROPPED / RESPOSTAED:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $dropsTODAY / $answersTODAY &nbsp; </TD>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>DL DIFF:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $diffONEMIN &nbsp; &nbsp; </TD>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>STATUS:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DIALstatuses &nbsp; &nbsp; </TD>";
$MAIN.="</TR>";
$CSV_text.="\"HOPPER NÍVEL:\",\"$HOPlev\",\"DROPPED / RESPOSTAED:\",\"$dropsTODAY / $answersTODAY\",\"DL DIFF:\",\"$diffONEMIN\",\"STATUS:\",\"$DIALstatuses\"\n";
...
if ($VSCagentcalls > 0)
	...
	$MAIN.="<TR>";
	$MAIN.="<TD ALIGN=RIGHT><font size=2><B>AGENTE AVG WAIT:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $avgwaitTODAY &nbsp;</TD>";
	...
	$MAIN.="</TR>";
	$CSV_text.="\"AGENTE AVG WAIT:\",\"$avgwaitTODAY\",\"AVG CUSTTIME:\",\"$avgcustTODAY\",\"AVG ACW:\",\"$avgacwTODAY\",\"AVG PAUSE:\",\"$avgpauseTODAY\"\n";
	}
