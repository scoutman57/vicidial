...
$ASCII_text="\n";
$ASCII_text.="---------- TEMPO DE ESPERA POR SEGUNDOS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&ENVIAR=$ENVIAR&file_download=2\">DOWNLOAD</a>\n";
$ASCII_text.="+-------------------------------------------------------------------------------------------+------------+\n";
$ASCII_text.="|     0     5    10    15    20    25    30    35    40    45    50    55    60    90   +90 | TOTAL      |\n";
$ASCII_text.="+-------------------------------------------------------------------------------------------+------------+\n";

$CSV_text2.="\n\"TEMPO DE ESPERA POR SEGUNDOS\"\n";
...
$ASCII_text="\n";
$ASCII_text.="           CALL RESPOSTAED TIME AND PERCENT BREAKDOWN IN SECONDS\n";
$ASCII_text.="          +-------------------------------------------------------------------------------------------+------------+\n";
$ASCII_text.="          |     0     5    10    15    20    25    30    35    40    45    50    55    60    90   +90 | TOTAL      |\n";
$ASCII_text.="----------+-------------------------------------------------------------------------------------------+------------+\n";

$CSV_text2.="\n\"CALL RESPOSTAED TIME AND PERCENT BREAKDOWN IN SECONDS\"\n";
$CSV_text2.="\"\",\"0\",\"5\",\"10\",\"15\",\"20\",\"25\",\"30\",\"35\",\"40\",\"45\",\"50\",\"55\",\"60\",\"90\",\"+90\",\"TOTAL\"\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- ESTATÍSTICA DE MOTIVO DE DESLIGAMENTO       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&ENVIAR=$ENVIAR&file_download=3\">DOWNLOAD</a>\n";
$ASCII_text.="+----------------------+------------+\n";
...
if ($report_display_type=="HTML") 
	...
	$GRAPH_text="</PRE>\n";
	$GRAPH_text.="<table cellspacing=\"0\" cellpadding=\"0\" summary=\"ESTATÍSTICA DE MOTIVO DE DESLIGAMENTO\" class=\"horizontalgraph\">\n";
	$GRAPH_text.="  <caption align=\"top\">ESTATÍSTICA DE MOTIVO DE DESLIGAMENTO</caption>\n";
	$GRAPH_text.="  <tr>\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- CALL STATUS STATS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&ENVIAR=$ENVIAR&file_download=4\">DOWNLOAD</a>\n";
$ASCII_text.="+--------+----------------------+----------------------+------------+------------+----------+----------+\n";
$ASCII_text.="| STATUS | DESCRIPTION          | CATEGORIA             | CALLS      | TOTAL TIME | AVG TIME |CALLS/HOUR|\n";
$ASCII_text.="+--------+----------------------+----------------------+------------+------------+----------+----------+\n";
...
$CSV_text4.="\n\"CALL STATUS STATS\"\n";
$CSV_text4.="\"STATUS\",\"DESCRIPTION\",\"CATEGORIA\",\"CALLS\",\"TOTAL TIME\",\"AVG TIME\",\"CALLS/HOUR\"\n";
...
$CSV_text5.="\"CATEGORIA\",\"CALLS\",\"DESCRIPTION\"\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- CALL INITIAL QUEUE POSITION BREAKDOWN       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&ENVIAR=$ENVIAR&file_download=6\">DOWNLOAD</a>\n";
$ASCII_text.="+-------------------------------------------------------------------------------------+------------+\n";
...
$ASCII_text.="GRÁFICO TOTAL DE CHAMADAS A CADA 15 MINUTOS TAKEN INTO THIS IN-GROUP\n";
...
$MAIN.="\n";
$MAIN.="---------- CALL RESPOSTAED TIME BREAKDOWN IN SECONDS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&ENVIAR=$ENVIAR&file_download=8\">DOWNLOAD</a>\n";
$MAIN.="+------+-------------------------------------------------------------------------------------------+------------+\n";
$MAIN.="| HOUR |     0     5    10    15    20    25    30    35    40    45    50    55    60    90   +90 | TOTAL      |\n";
$MAIN.="+------+-------------------------------------------------------------------------------------------+------------+\n";

$CSV_text8.="\n\"CALL RESPOSTAED TIME BREAKDOWN IN SECONDS\"\n";
