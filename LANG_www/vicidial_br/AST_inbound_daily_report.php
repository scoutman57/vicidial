...
$MAIN.="<TR><TD align='left'><FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2><INPUT TYPE=checkbox NAME=hourly_breakdown VALUE='checked' $hourly_breakdown>Show hourly results<BR><INPUT TYPE=checkbox NAME=show_disposition_statuses VALUE='checked' $show_disposition_statuses>Show disposition statuses<BR><INPUT TYPE=checkbox NAME=ignore_afterhours VALUE='checked' $ignore_afterhours>Ignore after-hours calls</FONT></TD><TD align='right'><a href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date$selected_group_URLstr&shift=$shift&hourly_breakdown=$hourly_breakdown&show_disposition_statuses=$show_disposition_statuses&ENVIAR=$ENVIAR&file_download=1\">DOWNLOAD</a> | <a href=\"./admin.php?ADD=3111&group_id=$group\">ALTERAR</a> | <a href=\"./admin.php?ADD=999999\">RELATÓRIOS</a></TD></TR>\n";
...
#		}
	...
	while ($i < $records_to_grab)
		...
		if ($row[6]!="VDCL" && $row[6]!="") {$ag[$i] = $row[6];} # Usuário
		# $fTOTAL_agents["$row[6]"]++;
	...
	#	$qrtQUEUE[$j]=0; $qrtQUEUEsec[$j]=0; $qrtQUEUEmax[$j]=0;
		...
		$totRESPOSTASdate[$j]=0;
		$totRESPOSTASsecdate[$j]=0;
		$totRESPOSTASspeeddate[$j]=0;
		$i=0;
		$agents_array=array();
		while ($i < $records_to_grab)
			{
	...
	#			$dtt = $dt[$i];
				...
				if (ereg('ABANDON|NOAGENT|QUEUETIMEOUT|AFTERHOURS|MAXCALLS', $tr[$i])) 
					...
					if (($ls[$i]-$qs[$i]-15)>0) {  ## Patch by Joe J - can cause negative time values if removed.
						$totRESPOSTASsecdate[$j]+=($ls[$i]-$qs[$i]-15);
						$FtotRESPOSTASsec+=($ls[$i]-$qs[$i]-15);
					}
	...
	*/
	...
	$MAIN2="| SHIFT                                     | CALLS   | CALLS    | AGENTS   | CALLS     | ABANDON | ABANDON | RESPOSTA | TALK   | TALK       | WRAP       | CALL       |";
	$MAIN3="| DATE-TIME RANGE                           | OFFERED | RESPOSTAED | RESPOSTAED | ABANDONED | PERCENT | TIME    | SPEED  | TIME   | TIME       | TIME       | TIME       |";
	$CSV_text1="";
	$CSV_text2="";
	$CSV_text3="";
	...
	$CSV_text.="\"\",\"CALLS\",\"CALLS\",\"AGENTS\",\"CALLS\",\"ABANDON\",\"ABANDON\",\"RESPOSTA\",\"TALK\",\"TALK\",\"WRAP\",\"CALL\"$CSV_text2\n";
	$CSV_text.="\"SHIFT DATE-TIME RANGE\",\"OFFERED\",\"RESPOSTAED\",\"RESPOSTAED\",\"ABANDONED\",\"PERCENT\",\"TIME\",\"SPEED\",\"TIME\",\"TIME\",\"TIME\",\"TIME\"$CSV_text3\n";
	...
	$GRAPH="<a name='multigroup_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800'><tr><th width='10%' class='grey_graph_cell' id='multigroup_graph1'><a href='#' onClick=\"DrawGraph('OFFERED', '1'); return false;\">TOTAL DE CHAMADAS OFFERED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph2'><a href='#' onClick=\"DrawGraph('RESPOSTAED', '2'); return false;\">TOTAL DE CHAMADAS RESPOSTAED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph11'><a href='#' onClick=\"DrawGraph('AGENTS', '11'); return false;\">TOTAL AGENTS RESPOSTAED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph3'><a href='#' onClick=\"DrawGraph('ABANDONED', '3'); return false;\">TOTAL DE CHAMADAS ABANDONED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph4'><a href='#' onClick=\"DrawGraph('ABANDONPCT', '4'); return false;\">TOTAL ABANDON PERCENT</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph5'><a href='#' onClick=\"DrawGraph('AVGABANDONTIME', '5'); return false;\">AVG ABANDON TIME</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph6'><a href='#' onClick=\"DrawGraph('AVGRESPOSTASPEED', '6'); return false;\">AVG RESPOSTA SPEED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph7'><a href='#' onClick=\"DrawGraph('AVGTALKTIME', '7'); return false;\">AVG TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph8'><a href='#' onClick=\"DrawGraph('TOTALTALKTIME', '8'); return false;\">TOTAL TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph9'><a href='#' onClick=\"DrawGraph('TOTALWRAPTIME', '9'); return false;\">TOTAL WRAP TIME</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph10'><a href='#' onClick=\"DrawGraph('TOTALCALLTIME', '10'); return false;\">TOTAL CALL TIME</a></th></tr><tr><td colspan='11' class='graph_span_cell' align='center'><span id='stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
	$MTD_GRAPH="<BR><BR><a name='MTD_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800'><tr><th width='10%' class='grey_graph_cell' id='MTD_graph1'><a href='#' onClick=\"DrawMTDGraph('OFFERED', '1'); return false;\">TOTAL DE CHAMADAS OFFERED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph2'><a href='#' onClick=\"DrawMTDGraph('RESPOSTAED', '2'); return false;\">TOTAL DE CHAMADAS RESPOSTAED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph11'><a href='#' onClick=\"DrawMTDGraph('AGENTS', '11'); return false;\">TOTAL AGENTS RESPOSTAED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph3'><a href='#' onClick=\"DrawMTDGraph('ABANDONED', '3'); return false;\">TOTAL DE CHAMADAS ABANDONED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph4'><a href='#' onClick=\"DrawMTDGraph('ABANDONPCT', '4'); return false;\">TOTAL ABANDON PERCENT</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph5'><a href='#' onClick=\"DrawMTDGraph('AVGABANDONTIME', '5'); return false;\">AVG ABANDON TIME</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph6'><a href='#' onClick=\"DrawMTDGraph('AVGRESPOSTASPEED', '6'); return false;\">AVG RESPOSTA SPEED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph7'><a href='#' onClick=\"DrawMTDGraph('AVGTALKTIME', '7'); return false;\">AVG TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph8'><a href='#' onClick=\"DrawMTDGraph('TOTALTALKTIME', '8'); return false;\">TOTAL TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph9'><a href='#' onClick=\"DrawMTDGraph('TOTALWRAPTIME', '9'); return false;\">TOTAL WRAP TIME</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph10'><a href='#' onClick=\"DrawMTDGraph('TOTALCALLTIME', '10'); return false;\">TOTAL CALL TIME</a></th></tr><tr><td colspan='11' class='graph_span_cell' align='center'><span id='MTD_stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
	$WTD_GRAPH="<BR><BR><a name='WTD_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800'><tr><th width='10%' class='grey_graph_cell' id='WTD_graph1'><a href='#' onClick=\"DrawWTDGraph('OFFERED', '1'); return false;\">TOTAL DE CHAMADAS OFFERED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph2'><a href='#' onClick=\"DrawWTDGraph('RESPOSTAED', '2'); return false;\">TOTAL DE CHAMADAS RESPOSTAED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph11'><a href='#' onClick=\"DrawWTDGraph('AGENTS', '11'); return false;\">TOTAL AGENTS RESPOSTAED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph3'><a href='#' onClick=\"DrawWTDGraph('ABANDONED', '3'); return false;\">TOTAL DE CHAMADAS ABANDONED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph4'><a href='#' onClick=\"DrawWTDGraph('ABANDONPCT', '4'); return false;\">TOTAL ABANDON PERCENT</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph5'><a href='#' onClick=\"DrawWTDGraph('AVGABANDONTIME', '5'); return false;\">AVG ABANDON TIME</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph6'><a href='#' onClick=\"DrawWTDGraph('AVGRESPOSTASPEED', '6'); return false;\">AVG RESPOSTA SPEED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph7'><a href='#' onClick=\"DrawWTDGraph('AVGTALKTIME', '7'); return false;\">AVG TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph8'><a href='#' onClick=\"DrawWTDGraph('TOTALTALKTIME', '8'); return false;\">TOTAL TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph9'><a href='#' onClick=\"DrawWTDGraph('TOTALWRAPTIME', '9'); return false;\">TOTAL WRAP TIME</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph10'><a href='#' onClick=\"DrawWTDGraph('TOTALCALLTIME', '10'); return false;\">TOTAL CALL TIME</a></th></tr><tr><td colspan='11' class='graph_span_cell' align='center'><span id='WTD_stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
	$QTD_GRAPH="<BR><BR><a name='QTD_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800'><tr><th width='10%' class='grey_graph_cell' id='QTD_graph1'><a href='#' onClick=\"DrawQTDGraph('OFFERED', '1'); return false;\">TOTAL DE CHAMADAS OFFERED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph2'><a href='#' onClick=\"DrawQTDGraph('RESPOSTAED', '2'); return false;\">TOTAL DE CHAMADAS RESPOSTAED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph11'><a href='#' onClick=\"DrawQTDGraph('AGENTS', '11'); return false;\">TOTAL AGENTS RESPOSTAED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph3'><a href='#' onClick=\"DrawQTDGraph('ABANDONED', '3'); return false;\">TOTAL DE CHAMADAS ABANDONED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph4'><a href='#' onClick=\"DrawQTDGraph('ABANDONPCT', '4'); return false;\">TOTAL ABANDON PERCENT</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph5'><a href='#' onClick=\"DrawQTDGraph('AVGABANDONTIME', '5'); return false;\">AVG ABANDON TIME</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph6'><a href='#' onClick=\"DrawQTDGraph('AVGRESPOSTASPEED', '6'); return false;\">AVG RESPOSTA SPEED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph7'><a href='#' onClick=\"DrawQTDGraph('AVGTALKTIME', '7'); return false;\">AVG TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph8'><a href='#' onClick=\"DrawQTDGraph('TOTALTALKTIME', '8'); return false;\">TOTAL TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph9'><a href='#' onClick=\"DrawQTDGraph('TOTALWRAPTIME', '9'); return false;\">TOTAL WRAP TIME</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph10'><a href='#' onClick=\"DrawQTDGraph('TOTALCALLTIME', '10'); return false;\">TOTAL CALL TIME</a></th></tr><tr><td colspan='11' class='graph_span_cell' align='center'><span id='QTD_stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
	...
	$OFFERED_graph=$graph_header."<th class='thgraph' scope='col'>TOTAL DE CHAMADAS OFFERED</th></tr>";
	$RESPOSTAED_graph=$graph_header."<th class='thgraph' scope='col'>TOTAL DE CHAMADAS RESPOSTAED </th></tr>";
	$AGENTS_graph=$graph_header."<th class='thgraph' scope='col'>TOTAL AGENTS RESPOSTAED </th></tr>";
	$ABANDONED_graph=$graph_header."<th class='thgraph' scope='col'>TOTAL DE CHAMADAS ABANDONED</th></tr>";
	...
	$AVGRESPOSTASPEED_graph=$graph_header."<th class='thgraph' scope='col'>AVG RESPOSTA SPEED</th></tr>";
	...
	$totRESPOSTASsecwtd=0;
	$totRESPOSTASspeedwtd=0;
	$totABANDONSwtd=0;
	$totABANDONSsecwtd=0;
	$totSTATUSwtd=array();
	...
	$totRESPOSTASsecmtd=0;
	$totRESPOSTASspeedmtd=0;
	$totABANDONSmtd=0;
	$totABANDONSsecmtd=0;
	$totSTATUSmtd=array();
	...
	while ($d < $TOTintervals)
		...
		if (date("w", strtotime($daySTART[$d]))==0 && date("w", strtotime($daySTART[$d-1]))!=0 && $d>0) 
			...
			if (trim($totRESPOSTASwtd)>$max_wtd_answered) {$max_wtd_answered=trim($totRESPOSTASwtd);}
			...
			$wtd_graph_stats[$wa][2]=trim($totRESPOSTASwtd);
			...
			$wtd_graph_stats[$wa][6]=trim($totRESPOSTASavgspeedTIMEwtd);
			$wtd_graph_stats[$wa][7]=trim($totRESPOSTASavgTIMEwtd);
			$wtd_graph_stats[$wa][8]=trim($totRESPOSTAStalkTIMEwtd);
			$wtd_graph_stats[$wa][9]=trim($totRESPOSTASwrapTIMEwtd);
			$wtd_graph_stats[$wa][10]=trim($totRESPOSTAStotTIMEwtd);
			$wtd_graph_stats[$wa][17]=trim($totAGENTSwtd);
			$wa++;

			$ASCII_text.="$MAINH\n";
			$ASCII_text.="|                                       WTD | $totCALLSwtd | $totRESPOSTASwtd | $totAGENTSwtd | $totABANDONSwtd | $totABANDONSpctwtd%| $totABANDONSavgTIMEwtd | $totRESPOSTASavgspeedTIMEwtd | $totRESPOSTASavgTIMEwtd | $totRESPOSTAStalkTIMEwtd | $totRESPOSTASwrapTIMEwtd | $totRESPOSTAStotTIMEwtd |";
			$CSV_text.="\"WTD\",\"$totCALLSwtd\",\"$totRESPOSTASwtd\",\"$totAGENTSwtd\",\"$totABANDONSwtd\",\"$totABANDONSpctwtd%\",\"$totABANDONSavgTIMEwtd\",\"$totRESPOSTASavgspeedTIMEwtd\",\"$totRESPOSTASavgTIMEwtd\",\"$totRESPOSTAStalkTIMEwtd\",\"$totRESPOSTASwrapTIMEwtd\",\"$totRESPOSTAStotTIMEwtd\"";
			for ($s=0; $s<count($status_array); $s++) {
				$ASCII_text.=" ".sprintf("%10s", ($totSTATUSwtd[$status_array[$s][0]]+0))." |";
				$CSV_text.=",\"".sprintf("%10s", ($totSTATUSwtd[$status_array[$s][0]]+0))."\"";
			}
			$ASCII_text.="\n";
			$CSV_text.="\n";
			$ASCII_text.="$MAINH\n";
		...
		if (date("d", strtotime($daySTART[$d]))==1 && $d>0 && date("d", strtotime($daySTART[$d-1]))!=1) 
			...
			if (trim($totRESPOSTASmtd)>$max_mtd_answered) {$max_mtd_answered=trim($totRESPOSTASmtd);}
			...
			$mtd_graph_stats[$ma][2]=trim($totRESPOSTASmtd);
			...
			$mtd_graph_stats[$ma][6]=trim($totRESPOSTASavgspeedTIMEmtd);
			$mtd_graph_stats[$ma][7]=trim($totRESPOSTASavgTIMEmtd);
			$mtd_graph_stats[$ma][8]=trim($totRESPOSTAStalkTIMEmtd);
			$mtd_graph_stats[$ma][9]=trim($totRESPOSTASwrapTIMEmtd);
			$mtd_graph_stats[$ma][10]=trim($totRESPOSTAStotTIMEmtd);
			$mtd_graph_stats[$ma][17]=trim($totAGENTSmtd);
			$ma++;

			$ASCII_text.="$MAINH\n";
			$ASCII_text.="|                                       MTD | $totCALLSmtd | $totRESPOSTASmtd | $totAGENTSmtd | $totABANDONSmtd | $totABANDONSpctmtd%| $totABANDONSavgTIMEmtd | $totRESPOSTASavgspeedTIMEmtd | $totRESPOSTASavgTIMEmtd | $totRESPOSTAStalkTIMEmtd | $totRESPOSTASwrapTIMEmtd | $totRESPOSTAStotTIMEmtd |";
			$CSV_text.="\"MTD\",\"$totCALLSmtd\",\"$totRESPOSTASmtd\",\"$totAGENTSmtd\",\"$totABANDONSmtd\",\"$totABANDONSpctmtd%\",\"$totABANDONSavgTIMEmtd\",\"$totRESPOSTASavgspeedTIMEmtd\",\"$totRESPOSTASavgTIMEmtd\",\"$totRESPOSTAStalkTIMEmtd\",\"$totRESPOSTASwrapTIMEmtd\",\"$totRESPOSTAStotTIMEmtd\"";
			for ($s=0; $s<count($status_array); $s++) {
				$ASCII_text.=" ".sprintf("%10s", ($totSTATUSmtd[$status_array[$s][0]]+0))." |";
				$CSV_text.=",\"".sprintf("%10s", ($totSTATUSmtd[$status_array[$s][0]]+0))."\"";
			}
			$ASCII_text.="\n";
			$CSV_text.="\n";
			$ASCII_text.="$MAINH\n";
		...
		$totRESPOSTASspeedwtd+=$totRESPOSTASspeeddate[$d];
		$totABANDONSwtd+=$totABANDONSdate[$d];
		$totABANDONSsecwtd+=$totABANDONSsecdate[$d];
		$totCALLSmtd+=$totCALLSdate[$d];
		$totRESPOSTASmtd+=$totRESPOSTASdate[$d];
		$totRESPOSTASsecmtd+=$totRESPOSTASsecdate[$d];
		$totRESPOSTASspeedmtd+=$totRESPOSTASspeeddate[$d];
		$totABANDONSmtd+=$totABANDONSdate[$d];
		$totABANDONSsecmtd+=$totABANDONSsecdate[$d];
		$totCALLSqtd+=$totCALLSdate[$d];
		$totRESPOSTASqtd+=$totRESPOSTASdate[$d];
		$totRESPOSTASsecqtd+=$totRESPOSTASsecdate[$d];
		$totRESPOSTASspeedqtd+=$totRESPOSTASspeeddate[$d];
		...
		if (trim($totRESPOSTASdate[$d])>$max_answered) {$max_answered=trim($totRESPOSTASdate[$d]);}
		...
		$graph_stats[$d][2]=trim($totRESPOSTASdate[$d]);
		$graph_stats[$d][3]=trim($totABANDONSdate[$d]);
		$graph_stats[$d][4]=trim($totABANDONSpctDATE[$d]);
		$graph_stats[$d][5]=trim($totABANDONSavgTIME[$d]);
		$graph_stats[$d][6]=trim($totRESPOSTASavgspeedTIME[$d]);
		$graph_stats[$d][7]=trim($totRESPOSTASavgTIME[$d]);
		$graph_stats[$d][8]=trim($totRESPOSTAStalkTIME[$d]);
		$graph_stats[$d][9]=trim($totRESPOSTASwrapTIME[$d]);
		$graph_stats[$d][10]=trim($totRESPOSTAStotTIME[$d]);
		$graph_stats[$d][17]=trim($totAGENTSday);

		$ASCII_text.="| $daySTART[$d] - $dayEND[$d] | $totCALLSdate[$d] | $totRESPOSTASdate[$d] | $totAGENTSday | $totABANDONSdate[$d] | $totABANDONSpctDATE[$d]%| $totABANDONSavgTIME[$d] | $totRESPOSTASavgspeedTIME[$d] | $totRESPOSTASavgTIME[$d] | $totRESPOSTAStalkTIME[$d] | $totRESPOSTASwrapTIME[$d] | $totRESPOSTAStotTIME[$d] |";
		$CSV_text.="\"$daySTART[$d] - $dayEND[$d]\",\"$totCALLSdate[$d]\",\"$totRESPOSTASdate[$d]\",\"$totAGENTSday\",\"$totABANDONSdate[$d]\",\"$totABANDONSpctDATE[$d]%\",\"$totABANDONSavgTIME[$d]\",\"$totRESPOSTASavgspeedTIME[$d]\",\"$totRESPOSTASavgTIME[$d]\",\"$totRESPOSTAStalkTIME[$d]\",\"$totRESPOSTASwrapTIME[$d]\",\"$totRESPOSTAStotTIME[$d]\"";
		for ($s=0; $s<count($status_array); $s++) {
			$ASCII_text.=" ".sprintf("%10s", ($totSTATUSdate[$d][$status_array[$s][0]]+0))." |";
			$CSV_text.=",\"".sprintf("%10s", ($totSTATUSdate[$d][$status_array[$s][0]]+0))."\"";
			$totSTATUSwtd[$status_array[$s][0]]+=$totSTATUSdate[$d][$status_array[$s][0]];
			$totSTATUSmtd[$status_array[$s][0]]+=$totSTATUSdate[$d][$status_array[$s][0]];
			$totSTATUSqtd[$status_array[$s][0]]+=$totSTATUSdate[$d][$status_array[$s][0]];
		}
		$ASCII_text.="\n";
		$CSV_text.="\n";
	...
	if ($totCALLSsec > 0)
		...
		if (date("w", strtotime($daySTART[$d]))>0) 
			...
			if (trim($totRESPOSTASavgTIMEwtd)>$max_wtd_avgtalktime) {$max_wtd_avgtalktime=trim($totRESPOSTASavgTIMEwtd);}
			if (trim($totRESPOSTASsecwtd)>$max_wtd_totaltalktime) {$max_wtd_totaltalktime=trim($totRESPOSTASsecwtd);}
			if (trim($totRESPOSTASsecwtd+($totRESPOSTASwtd*15))>$max_wtd_totalcalltime) {$max_wtd_totalcalltime=trim($totRESPOSTASsecwtd+($totRESPOSTASwtd*15));}
			...
			$wtd_RESPOSTAED_graph=preg_replace('/DAILY/', 'WEEK-TO-DATE',$RESPOSTAED_graph);
			...
			$wtd_AVGRESPOSTASPEED_graph=preg_replace('/DAILY/', 'WEEK-TO-DATE',$AVGRESPOSTASPEED_graph);
		...
		if (date("d", strtotime($daySTART[$d]))!=1) 
			...
			$mtd_RESPOSTAED_graph=preg_replace('/DAILY/', 'MONTH-TO-DATE',$RESPOSTAED_graph);
			...
			$mtd_AVGRESPOSTASPEED_graph=preg_replace('/DAILY/', 'MONTH-TO-DATE',$AVGRESPOSTASPEED_graph);
			...
			for ($q=0; $q<count($mtd_graph_stats); $q++) {
				...
				$graph_totRESPOSTASavgspeedTIMEmtd+=$mtd_graph_stats[$q][6];
				$graph_totRESPOSTASavgTIMEmtd+=$mtd_graph_stats[$q][7];
				$graph_totRESPOSTAStalkTIMEmtd+=$mtd_graph_stats[$q][8];
				$graph_totRESPOSTASwrapTIMEmtd+=$mtd_graph_stats[$q][9];
				$graph_totRESPOSTAStotTIMEmtd+=$mtd_graph_stats[$q][10];
			}			
	...
	#			}
			...
			$AVGRESPOSTASPEED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTASavgspeedTIME)."</th></tr></table>";
			$AVGTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTASavgTIME)."</th></tr></table>";
			$TOTALTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTAStalkTIME)."</th></tr></table>";
			$TOTALWRAPTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTASwrapTIME)."</th></tr></table>";
			$TOTALCALLTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTAStotTIME)."</th></tr></table>";
			$JS_onload.="\tDrawGraph('OFFERED', '1');\n"; 
			$JS_text.="function DrawGraph(graph, th_id) {\n";
			$JS_text.="	var OFFERED_graph=\"$OFFERED_graph\";\n";
			$JS_text.="	var RESPOSTAED_graph=\"$RESPOSTAED_graph\";\n";
			...
			$JS_text.="	var AVGRESPOSTASPEED_graph=\"$AVGRESPOSTASPEED_graph\";\n";
			...
			$wtd_RESPOSTAED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTAS)."</th></tr></table>";
			...
			$wtd_AVGRESPOSTASPEED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTASavgspeedTIME)."</th></tr></table>";
			$wtd_AVGTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTASavgTIME)."</th></tr></table>";
			$wtd_TOTALTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTAStalkTIME)."</th></tr></table>";
			$wtd_TOTALWRAPTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTASwrapTIME)."</th></tr></table>";
			$wtd_TOTALCALLTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTAStotTIME)."</th></tr></table>";
			$JS_onload.="\tDrawWTDGraph('OFFERED', '1');\n"; 
			$JS_text.="function DrawWTDGraph(graph, th_id) {\n";
			$JS_text.="	var OFFERED_graph=\"$wtd_OFFERED_graph\";\n";
			$JS_text.="	var RESPOSTAED_graph=\"$wtd_RESPOSTAED_graph\";\n";
			...
			$JS_text.="	var AVGRESPOSTASPEED_graph=\"$wtd_AVGRESPOSTASPEED_graph\";\n";
			...
			$mtd_RESPOSTAED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTAS)."</th></tr></table>";
			...
			$mtd_AVGRESPOSTASPEED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTASavgspeedTIME)."</th></tr></table>";
			$mtd_AVGTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTASavgTIME)."</th></tr></table>";
			$mtd_TOTALTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTAStalkTIME)."</th></tr></table>";
			$mtd_TOTALWRAPTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTASwrapTIME)."</th></tr></table>";
			$mtd_TOTALCALLTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTAStotTIME)."</th></tr></table>";
			$JS_onload.="\tDrawMTDGraph('OFFERED', '1');\n"; 
			$JS_text.="function DrawMTDGraph(graph, th_id) {\n";
			$JS_text.="	var OFFERED_graph=\"$mtd_OFFERED_graph\";\n";
			$JS_text.="	var RESPOSTAED_graph=\"$mtd_RESPOSTAED_graph\";\n";
			...
			$JS_text.="	var AVGRESPOSTASPEED_graph=\"$mtd_AVGRESPOSTASPEED_graph\";\n";
			...
			$qtd_RESPOSTAED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTAS)."</th></tr></table>";
			...
			$qtd_AVGRESPOSTASPEED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTASavgspeedTIME)."</th></tr></table>";
			$qtd_AVGTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTASavgTIME)."</th></tr></table>";
			$qtd_TOTALTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTAStalkTIME)."</th></tr></table>";
			$qtd_TOTALWRAPTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTASwrapTIME)."</th></tr></table>";
			$qtd_TOTALCALLTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotRESPOSTAStotTIME)."</th></tr></table>";
			$JS_onload.="\tDrawQTDGraph('OFFERED', '1');\n"; 
			$JS_text.="function DrawQTDGraph(graph, th_id) {\n";
			$JS_text.="	var OFFERED_graph=\"$qtd_OFFERED_graph\";\n";
			$JS_text.="	var RESPOSTAED_graph=\"$qtd_RESPOSTAED_graph\";\n";
			...
			$JS_text.="	var AVGRESPOSTASPEED_graph=\"$qtd_AVGRESPOSTASPEED_graph\";\n";
	...
	$ASCII_text.="$MAINH\n";
	$ASCII_text.="|                                    TOTALS | $FtotCALLS | $FtotRESPOSTAS | $FtotAGENTS | $FtotABANDONS | $FtotABANDONSpct%| $FtotABANDONSavgTIME | $FtotRESPOSTASavgspeedTIME | $FtotRESPOSTASavgTIME | $FtotRESPOSTAStalkTIME | $FtotRESPOSTASwrapTIME | $FtotRESPOSTAStotTIME |";
	$CSV_text.="\"TOTALS\",\"$FtotCALLS\",\"$FtotRESPOSTAS\",\"$FtotAGENTS\",\"$FtotABANDONS\",\"$FtotABANDONSpct%\",\"$FtotABANDONSavgTIME\",\"$FtotRESPOSTASavgspeedTIME\",\"$FtotRESPOSTASavgTIME\",\"$FtotRESPOSTAStalkTIME\",\"$FtotRESPOSTASwrapTIME\",\"$FtotRESPOSTAStotTIME\"";
	for ($s=0; $s<count($status_array); $s++) {
		$ASCII_text.=" ".sprintf("%10s", ($totSTATUS[$status_array[$s][0]]+0))." |";
		$CSV_text.=",\"".sprintf("%10s", ($totSTATUS[$status_array[$s][0]]+0))."\"";
	}
	$ASCII_text.="\n";
	$CSV_text.="\n\n\n";
	$ASCII_text.="$MAINH\n\n\n";
	...
	if ($show_disposition_statuses) 
		...
		for ($s=0; $s<count($status_array); $s++) {
			...
			$status_count=$totSTATUS[$status_array[$s][0]]+0;
			#$MAIN.=" ".sprintf("%8s", ($totSTATUS[$status_array[$s][0]]+0))." |";
			#$CSV_text.=",\"".sprintf("%8s", ($totSTATUS[$status_array[$s][0]]+0))."\"";
