...
if ( (!$OK_to_process) or ( ($leadfile) and ($file_layout!="standard") ) )
	...
	if ($file_layout!="custom") 
		...
		<tr>
		  ...
		  <tr><td align=left><font size=1> &nbsp; &nbsp; &nbsp; &nbsp; <a href="admin.php?ADD=100" target="_parent">TORNA AD AMMINISTRAZIONE</a> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </font></td><td align=right><font size=1>LIST LOADER 3rd Gen- &nbsp; &nbsp; VERSIONE: <?php echo $version ?> &nbsp; &nbsp; BUILD: <?php echo $build ?> &nbsp; &nbsp; </td></tr>
		</table>
		<?php 
