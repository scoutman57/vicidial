...
if ($INVIA && $query_date) {
	...
	if (mysqli_num_rows($rslt)>0) {
		...
		$HTML_text.="<TR><TH class='small_standard_bold grey_graph_cell'>SERVER IP</th><TH class='small_standard_bold grey_graph_cell'>CUENTA</th></tr>";
		...
		$ASCII_text.="+-----------------+---------+\n\n\n";
		$HTML_text.="<TR><TH class='small_standard_bold grey_graph_cell'>TOTALE</th><TH class='small_standard_bold grey_graph_cell'>$total_count</th></tr></table>";
		...
		$ASCII_text.="--- LAGGED LOG RECORDS FOR $query_date, $query_date_D TO $query_date_T $server_rpt_string, RECORDS #$lower_limit-$upper_limit               <a href=\"$PHP_SELF?INVIA=$INVIA&DB=$DB&type=$type&query_date=$query_date&query_date_D=$query_date_D&query_date_T=$query_date_T$url_typeQS&lower_limit=$lower_limit&upper_limit=$upper_limit&file_download=1\">[DOWNLOAD]</a>\n";
		$lagged_rpt.="+--------------+------------+-----------------+---------------------+-----------+----------+--------+----------------------+----------------------+----------------------+\n";
		$lagged_rpt.="| AGENT LOG ID | USER       | SERVER IP       | EVENT TIME          | LEAD ID   | CAMPAIGN | STATUS | Utente Group           | COMMENTS             | UNIQUE ID            |\n";
		$lagged_rpt.="+--------------+------------+-----------------+---------------------+-----------+----------+--------+----------------------+----------------------+----------------------+\n";

		$HTML_text.="<BR><BR><table border='0' cellpadding='0' cellspacing='2' width='1000'>";
		$HTML_rpt.="<TR><TH colspan='9' class='small_standard_bold grey_graph_cell'>LAGGED LOG RECORDS FOR $query_date, $query_date_D TO $query_date_T $server_rpt_string, RECORDS #$lower_limit-$upper_limit</TH><TD align='right' class='small_standard_bold grey_graph_cell'><a href=\"$PHP_SELF?INVIA=$INVIA&DB=$DB&type=$type&query_date=$query_date&query_date_D=$query_date_D&query_date_T=$query_date_T$url_typeQS&lower_limit=$lower_limit&upper_limit=$upper_limit&file_download=1\">[DOWNLOAD]</a></td></TR>";
		$HTML_rpt.="<TR><TH class='small_standard_bold grey_graph_cell' width='90'>AGENT LOG ID</TH><TH class='small_standard_bold grey_graph_cell' width='80'>UTENTE</TH><TH class='small_standard_bold grey_graph_cell' width='120'>SERVER IP</TH><TH class='small_standard_bold grey_graph_cell' width='100'>EVENT TIME</TH><TH class='small_standard_bold grey_graph_cell' width='80'>LEAD ID</TH><TH class='small_standard_bold grey_graph_cell' width='80'>CAMPAGNA</TH><TH class='small_standard_bold grey_graph_cell' width='60'>ESITO</TH><TH class='small_standard_bold grey_graph_cell' width='80'>Utente Group</TH><TH class='small_standard_bold grey_graph_cell' width='160'>COMMENTS</TH><TH class='small_standard_bold grey_graph_cell' width='120'>UNIQUE ID</TH></TR>";

		$CSV_text="\"AGENT LOG ID\",\"USER\",\"SERVER IP\",\"EVENT TIME\",\"LEAD ID\",\"CAMPAIGN\",\"STATUS\",\"Utente Group\",\"COMMENTS\",\"UNIQUE ID\"\n";
		...
		if ($ll>=1) {
			$lagged_rpt_hf.="<a href=\"$PHP_SELF?INVIA=$INVIA&DB=$DB&report_display_type=$report_display_type&type=$type&query_date=$query_date&query_date_D=$query_date_D&query_date_T=$query_date_T$url_typeQS&lower_limit=$ll\">[<<< PREV 1000 records]</a>";
			$HTML_rpt_hf.="<Td colspan='$HTML_colspan' class='small_standard_bold grey_graph_cell' align='left'><a href=\"$PHP_SELF?INVIA=$INVIA&DB=$DB&report_display_type=$report_display_type&type=$type&query_date=$query_date&query_date_D=$query_date_D&query_date_T=$query_date_T$url_typeQS&lower_limit=$ll\">[<<< PREV 1000 records]</a></TH>";
		...
		if (($lower_limit+1000)<mysqli_num_rows($rpt_rslt)) {
			...
			$lagged_rpt_hf.="<a href=\"$PHP_SELF?INVIA=$INVIA&DB=$DB&report_display_type=$report_display_type&type=$type&query_date=$query_date&query_date_D=$query_date_D&query_date_T=$query_date_T$url_typeQS&lower_limit=".($lower_limit+1000)."\">[NEXT $max_limit records >>>]</a>";
			$HTML_rpt_hf.="<Td colspan='$HTML_colspan' class='small_standard_bold grey_graph_cell' align='right'><a href=\"$PHP_SELF?INVIA=$INVIA&DB=$DB&report_display_type=$report_display_type&type=$type&query_date=$query_date&query_date_D=$query_date_D&query_date_T=$query_date_T$url_typeQS&lower_limit=".($lower_limit+1000)."\">[NEXT $max_limit records >>>]</a></TH>";
		} else {
			$lagged_rpt_hf.=sprintf("%23s", " ");
		}
		$HTML_rpt_hf.="</TR>";
