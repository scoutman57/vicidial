...
var ar_rinfrescare=<?php echo "$RR;"; ?>
...
function realtime_refresh_display()
	...
	if (ar_seconds > 0)
		{
		document.getElementById("rinfrescare_countdown").innerHTML = "" + ar_seconds + "";
		ar_seconds = (ar_seconds - 1);
		setTimeout("realtime_rinfrescare_display()",1000);
		}
	else
		{
		document.getElementById("rinfrescare_countdown").innerHTML = "0";
		ar_seconds = ar_rinfrescare;
...
echo " &nbsp; &nbsp; &nbsp; rinfrescare: <span id=rinfrescare_countdown name=rinfrescare_countdown></span>\n\n";
