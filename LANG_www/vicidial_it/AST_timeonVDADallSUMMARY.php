...
if (!isset($types))			{$types='MOSTRA ALL CAMPAGNE';}
...
$MAIN.="<b>Real-Time All Campagne Summary</b> &nbsp; &nbsp; &nbsp; \n";
$MAIN.="<a href=\"$PHP_SELF?group=$group&RR=4000&DB=$DB&adastats=$adastats&types=$types\">STOP</a> | ";
$MAIN.="<a href=\"$PHP_SELF?group=$group&RR=40&DB=$DB&adastats=$adastats&types=$types\">PIU LENTO</a> | ";
$MAIN.="<a href=\"$PHP_SELF?group=$group&RR=4&DB=$DB&adastats=$adastats&types=$types\">INIZIA</a> ";
$MAIN.=" &nbsp; &nbsp; </FONT>\n";
if ($adastats<2)
	{
	$MAIN.="<a href=\"$PHP_SELF?group=$group&RR=$RR&DB=$DB&adastats=2&types=$types\"><font size=1>+ VISUALIZZA PIU DATI</font></a>";
	}
else
	{
	$MAIN.="<a href=\"$PHP_SELF?group=$group&RR=$RR&DB=$DB&adastats=1&types=$types\"><font size=1>- VISUALIZZA MENO DATI</font></a>";
	}
$MAIN.=" &nbsp; &nbsp; &nbsp;<a href=\"$PHP_SELF?group=$group&RR=$RR&DB=$DB&adastats=$adastats&types=$types&file_download=1\">DOWNLOAD</a> | <a href=\"./admin.php?ADD=999999\">REPORT</a>";
$MAIN.="\n";
...
$MAIN.="<option value=\"MOSTRA ALL CAMPAGNE\"";
	if ($types == 'MOSTRA ALL CAMPAGNE') {$MAIN.=" selected";} 
$MAIN.=">MOSTRA ALL CAMPAGNE</option>";
...
$MAIN.="</select> \n";
$MAIN.="<input type=submit name=submit value='INVIA'>\n";
$MAIN.="<BR><BR>\n\n";
...
$MAIN.="<a href=\"./admin.php?ADD=34&campaign_id=$group\">Modifica</a>\n";
$CSV_text.="\"$group\"\n";
...
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>LIVELLO CHIAMATE:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DIALlev&nbsp; &nbsp; </TD>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>TRUNK SHORT/FILL:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $balanceSHORT / $balanceFILL &nbsp; &nbsp; </TD>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>FILTRO:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DIALfilter &nbsp; </TD>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B> DATA:</B> &nbsp; </TD><TD ALIGN=LEFT><font size=2> $NOW_TIME </TD>";
$MAIN.="";
$MAIN.="</TR>";

$CSV_text.="\"LIVELLO CHIAMATE:\",\"$DIALlev\",\"TRUNK SHORT/FILL:\",\"$balanceSHORT / $balanceFILL\",\"FILTRO:\",\"$DIALfilter\",\"TIME:\",\"$NOW_TIME\"\n";

if ($adastats>1)
	{
	$MAIN.="<TR BGCOLOR=\"#CCCCCC\">";
	$MAIN.="<TD ALIGN=RIGHT><font size=2>&nbsp; <B>LIVELLO MAX:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $maxDIALlev &nbsp; </TD>";
	$MAIN.="<TD ALIGN=RIGHT><font size=2><B>ABBATTIMENTO MAX:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DROPmax% &nbsp; &nbsp;</TD>";
	...
	$MAIN.="</TR>";
	$CSV_text.="\"MAX LIVELLO:\",\"$maxDIALlev\",\"ABBATTIMENTO MAX:\",\"$DROPmax\",\"TARGET DIFF:\",\"$targetDIFF\",\"INTENSITY:\",\"$ADAintense\"\n";

	$MAIN.="<TR BGCOLOR=\"#CCCCCC\">";
	$MAIN.="<TD ALIGN=RIGHT><font size=2><B>TIMEOUT CHIAMATA:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DIALtimeout &nbsp;</TD>";
	...
	$MAIN.="</TR>";
	$CSV_text.="\"TIMEOUT CHIAMATA:\",\"$DIALtimeout\",\"TAPER TIME:\",\"$TAPERtime\",\"LOCAL TIME:\",\"$CALLtime\",\"AVAIL ONLY:\",\"$ADAavailonly\"\n";
	}

$MAIN.="<TR>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>CONTATTI CHIAMABILI:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DAleads &nbsp; &nbsp; </TD>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>CHIAMATE OGGI:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $callsTODAY &nbsp; &nbsp; </TD>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>MEDIA OPERATORI:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $agentsONEMIN &nbsp; &nbsp; </TD>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>METODO CHIAMATA:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DIALmethod &nbsp; &nbsp; </TD>";
$MAIN.="</TR>";
$CSV_text.="\"CONTATTI CHIAMABILI:\",\"$DAleads\",\"CALLS TODAY:\",\"$callsTODAY\",\"MEDIA OPERATORI:\",\"$agentsONEMIN\",\"METODO CHIAMATA:\",\"$DIALmethod\"\n";

$MAIN.="<TR>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>LIVELLO CODA CHIAMATE:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $HOPlev &nbsp; &nbsp; </TD>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>ABBATTUTE / RISPOSTE:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $dropsTODAY / $answersTODAY &nbsp; </TD>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>DL DIFF:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $diffONEMIN &nbsp; &nbsp; </TD>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>ESITI:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DIALstatuses &nbsp; &nbsp; </TD>";
$MAIN.="</TR>";
$CSV_text.="\"LIVELLO CODA CHIAMATE:\",\"$HOPlev\",\"DROPPED / RISPOSTAED:\",\"$dropsTODAY / $answersTODAY\",\"DL DIFF:\",\"$diffONEMIN\",\"ESITI:\",\"$DIALstatuses\"\n";

$MAIN.="<TR>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>CONTATTI IN CODA:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $VDhop &nbsp; &nbsp; </TD>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>PERCENT ABBATTIMENTO:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; ";
...
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>ORDINE:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DIALorder &nbsp; &nbsp; </TD>";
$MAIN.="</TR>";
$CSV_text.="\"CONTATTI IN CODA:\",\"$VDhop\",\"PERCENT ABBATTIMENTO:\",\"$drpctTODAY%\",\"DIFF:\",\"$diffpctONEMIN%\",\"ORDINE:\",\"$DIALorder\"\n";
...
$parked_to_print = mysqli_num_rows($rslt);
	...
	{
	$MAIN.=" NESSUNA CHIAMATA IN ATTESA\n";
...
$talking_to_print = mysqli_num_rows($rslt);
	...
	{
	$MAIN.=" NESSUN OPERATORE AL TELEFONO<BR>\n";
