...
if ($download_type == 'systemdnc')
	...
	if ($leads_count < 1)
		{
		echo "Non ci sono numeri di telefono in elenco: SYSTEM INTERNAL DNC\n";
		exit;
		}
	}
elseif ($download_type == 'dnc')
	...
	if ($leads_count < 1)
		{
		echo "Non ci sono cavi in ​​lista Campagna DNC: $group_id\n";
		exit;
		}
	}
elseif ($download_type == 'fpgn')
	...
	if ($leads_count < 1)
		{
		echo "Non ci sono contatti in questo gruppo cellulare filtro: $group_id\n";
		exit;
		}
	}
else
	...
	if ($leads_count < 1)
		{
		echo "Esistono no leads in list_id: $list_id\n";
		exit;
		}
	}
