...
$MAIN.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date&group=$group&shift=$shift&hourly_breakdown=$hourly_breakdown&INVIA=$INVIA&file_download=1\">DOWNLOAD</a> | <a href=\"./admin.php?ADD=3111&group_id=$group\">MODIFICA</a> | <a href=\"./admin.php?ADD=999999\">REPORT</a><BR><INPUT TYPE=checkbox NAME=hourly_breakdown VALUE='checked' $hourly_breakdown>Show hourly results</FONT>\n";
$MAIN.="</FORM>\n\n";
...
if (!$group)
	...
	$CSV_text.="Selected in-gruppo: $group\n";
	...
	*/
	...
	$ASCII_text.="| SHIFT                                     | CALLS   | CALLS    | CALLS     | ABANDON | ABANDON | RISPOSTA | TALK   | TALK       | WRAP       | CALL       |\n";
	$ASCII_text.="| DATE-TIME RANGE                           | OFFERED | RISPOSTAED | ABANDONED | PERCENT | TIME    | SPEED  | TIME   | TIME       | TIME       | TIME       |\n";
	$ASCII_text.="+-------------------------------------------+---------+----------+-----------+---------+---------+--------+--------+------------+------------+------------+\n";
	$CSV_text.="\"\",\"TOTAL\",\"TOTAL\",\"TOTAL\",\"TOTAL\",\"AVG\",\"AVG\",\"AVG\",\"TOTAL\",\"TOTAL\",\"TOTAL\"\n";
	$CSV_text.="\"\",\"CALLS\",\"CALLS\",\"CALLS\",\"ABANDON\",\"ABANDON\",\"RISPOSTA\",\"TALK\",\"TALK\",\"WRAP\",\"CALL\"\n";
	$CSV_text.="\"SHIFT DATE-TIME RANGE\",\"OFFERED\",\"RISPOSTAED\",\"ABANDONED\",\"PERCENT\",\"TIME\",\"SPEED\",\"TIME\",\"TIME\",\"TIME\",\"TIME\"\n";
	...
	$GRAPH="<a name='multigroup_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800'><tr><th width='10%' class='grey_graph_cell' id='multigroup_graph1'><a href='#' onClick=\"DrawGraph('OFFERED', '1'); return false;\">TOTALE CHIAMATE OFFERED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph2'><a href='#' onClick=\"DrawGraph('RISPOSTAED', '2'); return false;\">TOTALE CHIAMATE RISPOSTAED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph3'><a href='#' onClick=\"DrawGraph('ABANDONED', '3'); return false;\">TOTALE CHIAMATE ABANDONED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph4'><a href='#' onClick=\"DrawGraph('ABANDONPCT', '4'); return false;\">TOTAL ABANDON PERCENT</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph5'><a href='#' onClick=\"DrawGraph('AVGABANDONTIME', '5'); return false;\">AVG ABANDON TIME</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph6'><a href='#' onClick=\"DrawGraph('AVGRISPOSTASPEED', '6'); return false;\">AVG RISPOSTA SPEED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph7'><a href='#' onClick=\"DrawGraph('AVGTALKTIME', '7'); return false;\">AVG TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph8'><a href='#' onClick=\"DrawGraph('TOTALTALKTIME', '8'); return false;\">TOTAL TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph9'><a href='#' onClick=\"DrawGraph('TOTALWRAPTIME', '9'); return false;\">TOTAL WRAP TIME</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph10'><a href='#' onClick=\"DrawGraph('TOTALCALLTIME', '10'); return false;\">TOTAL CALL TIME</a></th></tr><tr><td colspan='10' class='graph_span_cell' align='center'><span id='stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
	$MTD_GRAPH="<BR><BR><a name='MTD_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800'><tr><th width='10%' class='grey_graph_cell' id='MTD_graph1'><a href='#' onClick=\"DrawMTDGraph('OFFERED', '1'); return false;\">TOTALE CHIAMATE OFFERED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph2'><a href='#' onClick=\"DrawMTDGraph('RISPOSTAED', '2'); return false;\">TOTALE CHIAMATE RISPOSTAED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph3'><a href='#' onClick=\"DrawMTDGraph('ABANDONED', '3'); return false;\">TOTALE CHIAMATE ABANDONED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph4'><a href='#' onClick=\"DrawMTDGraph('ABANDONPCT', '4'); return false;\">TOTAL ABANDON PERCENT</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph5'><a href='#' onClick=\"DrawMTDGraph('AVGABANDONTIME', '5'); return false;\">AVG ABANDON TIME</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph6'><a href='#' onClick=\"DrawMTDGraph('AVGRISPOSTASPEED', '6'); return false;\">AVG RISPOSTA SPEED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph7'><a href='#' onClick=\"DrawMTDGraph('AVGTALKTIME', '7'); return false;\">AVG TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph8'><a href='#' onClick=\"DrawMTDGraph('TOTALTALKTIME', '8'); return false;\">TOTAL TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph9'><a href='#' onClick=\"DrawMTDGraph('TOTALWRAPTIME', '9'); return false;\">TOTAL WRAP TIME</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph10'><a href='#' onClick=\"DrawMTDGraph('TOTALCALLTIME', '10'); return false;\">TOTAL CALL TIME</a></th></tr><tr><td colspan='10' class='graph_span_cell' align='center'><span id='MTD_stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
	$WTD_GRAPH="<BR><BR><a name='WTD_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800'><tr><th width='10%' class='grey_graph_cell' id='WTD_graph1'><a href='#' onClick=\"DrawWTDGraph('OFFERED', '1'); return false;\">TOTALE CHIAMATE OFFERED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph2'><a href='#' onClick=\"DrawWTDGraph('RISPOSTAED', '2'); return false;\">TOTALE CHIAMATE RISPOSTAED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph3'><a href='#' onClick=\"DrawWTDGraph('ABANDONED', '3'); return false;\">TOTALE CHIAMATE ABANDONED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph4'><a href='#' onClick=\"DrawWTDGraph('ABANDONPCT', '4'); return false;\">TOTAL ABANDON PERCENT</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph5'><a href='#' onClick=\"DrawWTDGraph('AVGABANDONTIME', '5'); return false;\">AVG ABANDON TIME</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph6'><a href='#' onClick=\"DrawWTDGraph('AVGRISPOSTASPEED', '6'); return false;\">AVG RISPOSTA SPEED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph7'><a href='#' onClick=\"DrawWTDGraph('AVGTALKTIME', '7'); return false;\">AVG TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph8'><a href='#' onClick=\"DrawWTDGraph('TOTALTALKTIME', '8'); return false;\">TOTAL TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph9'><a href='#' onClick=\"DrawWTDGraph('TOTALWRAPTIME', '9'); return false;\">TOTAL WRAP TIME</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph10'><a href='#' onClick=\"DrawWTDGraph('TOTALCALLTIME', '10'); return false;\">TOTAL CALL TIME</a></th></tr><tr><td colspan='10' class='graph_span_cell' align='center'><span id='WTD_stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
	$QTD_GRAPH="<BR><BR><a name='QTD_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800'><tr><th width='10%' class='grey_graph_cell' id='QTD_graph1'><a href='#' onClick=\"DrawQTDGraph('OFFERED', '1'); return false;\">TOTALE CHIAMATE OFFERED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph2'><a href='#' onClick=\"DrawQTDGraph('RISPOSTAED', '2'); return false;\">TOTALE CHIAMATE RISPOSTAED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph3'><a href='#' onClick=\"DrawQTDGraph('ABANDONED', '3'); return false;\">TOTALE CHIAMATE ABANDONED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph4'><a href='#' onClick=\"DrawQTDGraph('ABANDONPCT', '4'); return false;\">TOTAL ABANDON PERCENT</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph5'><a href='#' onClick=\"DrawQTDGraph('AVGABANDONTIME', '5'); return false;\">AVG ABANDON TIME</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph6'><a href='#' onClick=\"DrawQTDGraph('AVGRISPOSTASPEED', '6'); return false;\">AVG RISPOSTA SPEED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph7'><a href='#' onClick=\"DrawQTDGraph('AVGTALKTIME', '7'); return false;\">AVG TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph8'><a href='#' onClick=\"DrawQTDGraph('TOTALTALKTIME', '8'); return false;\">TOTAL TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph9'><a href='#' onClick=\"DrawQTDGraph('TOTALWRAPTIME', '9'); return false;\">TOTAL WRAP TIME</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph10'><a href='#' onClick=\"DrawQTDGraph('TOTALCALLTIME', '10'); return false;\">TOTAL CALL TIME</a></th></tr><tr><td colspan='10' class='graph_span_cell' align='center'><span id='QTD_stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
	...
	*/	$totCALLSdate[$d] =	sprintf("%7s", $totCALLSdate[$d]);
		...
		if ($totRISPOSTASdate[$d]>0)
			{
			$totRISPOSTASavgspeedTIME[$d] =	sprintf("%6s", date("i:s", mktime(0, 0, round($totRISPOSTASspeeddate[$d]/$totRISPOSTASdate[$d]))));
			$totRISPOSTASavgTIME[$d] =	sprintf("%6s", date("i:s", mktime(0, 0, round($totRISPOSTASsecdate[$d]/$totRISPOSTASdate[$d]))));
			if (round($totRISPOSTASspeeddate[$d]/$totRISPOSTASdate[$d])>$max_avganswerspeed) {$max_avganswerspeed=round($totRISPOSTASspeeddate[$d]/$totRISPOSTASdate[$d]);}
			$graph_stats[$d][12]=round($totRISPOSTASspeeddate[$d]/$totRISPOSTASdate[$d]);
			$graph_stats[$d][16]=round($totRISPOSTASsecdate[$d]/$totRISPOSTASdate[$d]);
			}
		else
			{
			$totRISPOSTASdate[$d]="0";
			$totRISPOSTASavgspeedTIME[$d] = " 00:00";
			$totRISPOSTASavgTIME[$d] = " 00:00";
			$graph_stats[$d][12]=0;
			$graph_stats[$d][16]=0;
			}
		$totRISPOSTAStalkTIME[$d] =	sprintf("%10s", floor($totRISPOSTASsecdate[$d]/3600).date(":i:s", mktime(0, 0, $totRISPOSTASsecdate[$d])));
		$totRISPOSTASwrapTIME[$d] =	sprintf("%10s", floor(($totRISPOSTASdate[$d]*15)/3600).date(":i:s", mktime(0, 0, ($totRISPOSTASdate[$d]*15))));
		...
		$totRISPOSTAStotTIME[$d] =	sprintf("%10s", floor(($totRISPOSTASsecdate[$d]+($totRISPOSTASdate[$d]*15))/3600).date(":i:s", mktime(0, 0, ($totRISPOSTASsecdate[$d]+($totRISPOSTASdate[$d]*15)))));
		...
		if (date("w", strtotime($daySTART[$d]))==0 && date("w", strtotime($daySTART[$d-1]))!=0 && $d>0) 
			...
			if ($totRISPOSTASwtd>0)
				{
				$totRISPOSTASavgspeedTIMEwtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totRISPOSTASspeedwtd/$totRISPOSTASwtd))));
				$totRISPOSTASavgTIMEwtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totRISPOSTASsecwtd/$totRISPOSTASwtd))));
				if (round($totRISPOSTASspeedwtd/$totRISPOSTASwtd)>$max_wtd_avganswerspeed) {$max_wtd_avganswerspeed=round($totRISPOSTASspeedwtd/$totRISPOSTASwtd);}
				$wtd_graph_stats[$wa][12]=round($totRISPOSTASspeedwtd/$totRISPOSTASwtd);
				$wtd_graph_stats[$wa][16]=round($totRISPOSTASsecwtd/$totRISPOSTASwtd);
				}
			else
				{
				$totRISPOSTASavgspeedTIMEwtd = " 00:00";
				$totRISPOSTASavgTIMEwtd = " 00:00";
				$wtd_graph_stats[$wa][12]=0;
				$wtd_graph_stats[$wa][16]=0;
				}
			$totRISPOSTAStalkTIMEwtd =	sprintf("%10s", floor($totRISPOSTASsecwtd/3600).date(":i:s", mktime(0, 0, $totRISPOSTASsecwtd)));
			$totRISPOSTASwrapTIMEwtd =	sprintf("%10s", floor(($totRISPOSTASwtd*15)/3600).date(":i:s", mktime(0, 0, ($totRISPOSTASwtd*15))));
			...
			$totRISPOSTAStotTIMEwtd =	sprintf("%10s", floor(($totRISPOSTASsecwtd+($totRISPOSTASwtd*15))/3600).date(":i:s", mktime(0, 0, ($totRISPOSTASsecwtd+($totRISPOSTASwtd*15)))));
			...
			if (round($totRISPOSTASsecwtd/$totRISPOSTASwtd)>$max_wtd_avgtalktime) {$max_wtd_avgtalktime=round($totRISPOSTASsecwtd/$totRISPOSTASwtd);}
			...
			$ASCII_text.="+-------------------------------------------+---------+----------+-----------+---------+---------+--------+--------+------------+------------+------------+\n";
			$ASCII_text.="|                                       WTD | $totCALLSwtd | $totRISPOSTASwtd | $totABANDONSwtd | $totABANDONSpctwtd%| $totABANDONSavgTIMEwtd | $totRISPOSTASavgspeedTIMEwtd | $totRISPOSTASavgTIMEwtd | $totRISPOSTAStalkTIMEwtd | $totRISPOSTASwrapTIMEwtd | $totRISPOSTAStotTIMEwtd |\n";
			$ASCII_text.="+-------------------------------------------+---------+----------+-----------+---------+---------+--------+--------+------------+------------+------------+\n";
			$CSV_text.="\"WTD\",\"$totCALLSwtd\",\"$totRISPOSTASwtd\",\"$totABANDONSwtd\",\"$totABANDONSpctwtd%\",\"$totABANDONSavgTIMEwtd\",\"$totRISPOSTASavgspeedTIMEwtd\",\"$totRISPOSTASavgTIMEwtd\",\"$totRISPOSTAStalkTIMEwtd\",\"$totRISPOSTASwrapTIMEwtd\",\"$totRISPOSTAStotTIMEwtd\"\n";
			$totCALLSwtd=0;
			$totRISPOSTASwtd=0;
			$totRISPOSTASsecwtd=0;
			$totRISPOSTASspeedwtd=0;
		...
		if (date("d", strtotime($daySTART[$d]))==1 && $d>0 && date("d", strtotime($daySTART[$d-1]))!=1) {
			...
			if ($totRISPOSTASmtd>0)
				{
				$totRISPOSTASavgspeedTIMEmtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totRISPOSTASspeedmtd/$totRISPOSTASmtd))));
				$totRISPOSTASavgTIMEmtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totRISPOSTASsecmtd/$totRISPOSTASmtd))));
				if (round($totRISPOSTASspeedmtd/$totRISPOSTASmtd)>$max_mtd_avganswerspeed) {$max_mtd_avganswerspeed=round($totRISPOSTASspeedmtd/$totRISPOSTASmtd);}
				$mtd_graph_stats[$ma][12]=round($totRISPOSTASspeedmtd/$totRISPOSTASmtd);
				$mtd_graph_stats[$ma][16]=round($totRISPOSTASsecmtd/$totRISPOSTASmtd);
				}
			else
				{
				$totRISPOSTASavgspeedTIMEmtd = " 00:00";
				$totRISPOSTASavgTIMEmtd = " 00:00";
				$mtd_graph_stats[$ma][12]=0;
				$mtd_graph_stats[$ma][16]=0;
				}
			$totRISPOSTAStalkTIMEmtd =	sprintf("%10s", floor($totRISPOSTASsecmtd/3600).date(":i:s", mktime(0, 0, $totRISPOSTASsecmtd)));
			$totRISPOSTASwrapTIMEmtd =	sprintf("%10s", floor(($totRISPOSTASmtd*15)/3600).date(":i:s", mktime(0, 0, ($totRISPOSTASmtd*15))));
			...
			$totRISPOSTAStotTIMEmtd =	sprintf("%10s", floor(($totRISPOSTASsecmtd+($totRISPOSTASmtd*15))/3600).date(":i:s", mktime(0, 0, ($totRISPOSTASsecmtd+($totRISPOSTASmtd*15)))));
			...
			if (round($totRISPOSTASsecmtd/$totRISPOSTASmtd)>$max_mtd_avgtalktime) {$max_mtd_avgtalktime=round($totRISPOSTASsecmtd/$totRISPOSTASmtd);}
			...
			$ASCII_text.="+-------------------------------------------+---------+----------+-----------+---------+---------+--------+--------+------------+------------+------------+\n";
			$ASCII_text.="|                                       MTD | $totCALLSmtd | $totRISPOSTASmtd | $totABANDONSmtd | $totABANDONSpctmtd%| $totABANDONSavgTIMEmtd | $totRISPOSTASavgspeedTIMEmtd | $totRISPOSTASavgTIMEmtd | $totRISPOSTAStalkTIMEmtd | $totRISPOSTASwrapTIMEmtd | $totRISPOSTAStotTIMEmtd |\n";
			$ASCII_text.="+-------------------------------------------+---------+----------+-----------+---------+---------+--------+--------+------------+------------+------------+\n";
			$CSV_text.="\"MTD\",\"$totCALLSmtd\",\"$totRISPOSTASmtd\",\"$totABANDONSmtd\",\"$totABANDONSpctmtd%\",\"$totABANDONSavgTIMEmtd\",\"$totRISPOSTASavgspeedTIMEmtd\",\"$totRISPOSTASavgTIMEmtd\",\"$totRISPOSTAStalkTIMEmtd\",\"$totRISPOSTASwrapTIMEmtd\",\"$totRISPOSTAStotTIMEmtd\"\n";
			$totCALLSmtd=0;
			$totRISPOSTASmtd=0;
			$totRISPOSTASsecmtd=0;
			$totRISPOSTASspeedmtd=0;
			...
			if (date("m", strtotime($daySTART[$d]))==1 || date("m", strtotime($daySTART[$d]))==4 || date("m", strtotime($daySTART[$d]))==7 || date("m", strtotime($daySTART[$d]))==10) # Quarterly line
				...
				if ($totRISPOSTASqtd>0)
					{
					$totRISPOSTASavgspeedTIMEqtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totRISPOSTASspeedqtd/$totRISPOSTASqtd))));
					$totRISPOSTASavgTIMEqtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totRISPOSTASsecqtd/$totRISPOSTASqtd))));
					if (round($totRISPOSTASspeedqtd/$totRISPOSTASqtd)>$max_qtd_avganswerspeed) {$max_qtd_avganswerspeed=round($totRISPOSTASspeedqtd/$totRISPOSTASqtd);}
					$qtd_graph_stats[$qa][12]=round($totRISPOSTASspeedqtd/$totRISPOSTASqtd);
					$qtd_graph_stats[$qa][16]=round($totRISPOSTASsecqtd/$totRISPOSTASqtd);
					}
				else
					{
					$totRISPOSTASavgspeedTIMEqtd = " 00:00";
					$totRISPOSTASavgTIMEqtd = " 00:00";
					$qtd_graph_stats[$qa][12]=0;
					$qtd_graph_stats[$qa][16]=0;
					}
				$totRISPOSTAStalkTIMEqtd =	sprintf("%10s", floor($totRISPOSTASsecqtd/3600).date(":i:s", mktime(0, 0, $totRISPOSTASsecqtd)));
				$totRISPOSTASwrapTIMEqtd =	sprintf("%10s", floor(($totRISPOSTASqtd*15)/3600).date(":i:s", mktime(0, 0, ($totRISPOSTASqtd*15))));
				...
				$totRISPOSTAStotTIMEqtd =	sprintf("%10s", floor(($totRISPOSTASsecqtd+($totRISPOSTASqtd*15))/3600).date(":i:s", mktime(0, 0, ($totRISPOSTASsecqtd+($totRISPOSTASqtd*15)))));
				...
				if (round($totRISPOSTASsecqtd/$totRISPOSTASqtd)>$max_qtd_avgtalktime) {$max_qtd_avgtalktime=round($totRISPOSTASsecqtd/$totRISPOSTASqtd);}
				...
				$ASCII_text.="|                                       QTD | $totCALLSqtd | $totRISPOSTASqtd | $totABANDONSqtd | $totABANDONSpctqtd%| $totABANDONSavgTIMEqtd | $totRISPOSTASavgspeedTIMEqtd | $totRISPOSTASavgTIMEqtd | $totRISPOSTAStalkTIMEqtd | $totRISPOSTASwrapTIMEqtd | $totRISPOSTAStotTIMEqtd |\n";
				$ASCII_text.="+-------------------------------------------+---------+----------+-----------+---------+---------+--------+--------+------------+------------+------------+\n";
				$CSV_text.="\"QTD\",\"$totCALLSqtd\",\"$totRISPOSTASqtd\",\"$totABANDONSqtd\",\"$totABANDONSpctqtd%\",\"$totABANDONSavgTIMEqtd\",\"$totRISPOSTASavgspeedTIMEqtd\",\"$totRISPOSTASavgTIMEqtd\",\"$totRISPOSTAStalkTIMEqtd\",\"$totRISPOSTASwrapTIMEqtd\",\"$totRISPOSTAStotTIMEqtd\"\n";
				$totCALLSqtd=0;
				$totRISPOSTASqtd=0;
				$totRISPOSTASsecqtd=0;
				$totRISPOSTASspeedqtd=0;
		...
		if (round($totRISPOSTASsecdate[$d]/$totRISPOSTASdate[$d])>$max_avgtalktime) {$max_avgtalktime=round($totRISPOSTASsecdate[$d]/$totRISPOSTASdate[$d]);}
		...
		$ASCII_text.="| $daySTART[$d] - $dayEND[$d] | $totCALLSdate[$d] | $totRISPOSTASdate[$d] | $totABANDONSdate[$d] | $totABANDONSpctDATE[$d]%| $totABANDONSavgTIME[$d] | $totRISPOSTASavgspeedTIME[$d] | $totRISPOSTASavgTIME[$d] | $totRISPOSTAStalkTIME[$d] | $totRISPOSTASwrapTIME[$d] | $totRISPOSTAStotTIME[$d] |\n";
		$CSV_text.="\"$daySTART[$d] - $dayEND[$d]\",\"$totCALLSdate[$d]\",\"$totRISPOSTASdate[$d]\",\"$totABANDONSdate[$d]\",\"$totABANDONSpctDATE[$d]%\",\"$totABANDONSavgTIME[$d]\",\"$totRISPOSTASavgspeedTIME[$d]\",\"$totRISPOSTASavgTIME[$d]\",\"$totRISPOSTAStalkTIME[$d]\",\"$totRISPOSTASwrapTIME[$d]\",\"$totRISPOSTAStotTIME[$d]\"\n";
	...
	if ($totCALLSsec > 0)
		...
		if ($FtotRISPOSTAS>0) 
			{
			$FtotRISPOSTASavgspeedTIME =	sprintf("%6s", date("i:s", mktime(0, 0, round($FtotRISPOSTASspeed/$FtotRISPOSTAS))));
			$FtotRISPOSTASavgTIME =	sprintf("%6s", date("i:s", mktime(0, 0, round($FtotRISPOSTASsec/$FtotRISPOSTAS))));
			}
		else 
			{
			$FtotRISPOSTASavgspeedTIME =	sprintf("%6s", "00:00");
			$FtotRISPOSTASavgTIME =	sprintf("%6s", "00:00");
			}
		$FtotRISPOSTAStalkTIME =	sprintf("%10s", floor($FtotRISPOSTASsec/3600).date(":i:s", mktime(0, 0, $FtotRISPOSTASsec)));
		$FtotRISPOSTASwrapTIME =	sprintf("%10s", floor(($FtotRISPOSTAS*15)/3600).date(":i:s", mktime(0, 0, ($FtotRISPOSTAS*15))));
		$FtotRISPOSTAStotTIME =	sprintf("%10s", floor(($FtotRISPOSTASsec+($FtotRISPOSTAS*15))/3600).date(":i:s", mktime(0, 0, ($FtotRISPOSTASsec+($FtotRISPOSTAS*15)))));
		...
		if (date("w", strtotime($daySTART[$d]))>0) 
			...
			for ($q=0; $q<count($wtd_graph_stats); $q++) {
				...
				$wtd_RISPOSTAED_graph.="  <tr><td class='chart_td$class'>".$wtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$wtd_graph_stats[$q][2]/$max_wtd_answered)."' height='16' />".$wtd_graph_stats[$q][2]."</td></tr>";
				...
				$wtd_AVGRISPOSTASPEED_graph.="  <tr><td class='chart_td$class'>".$wtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$wtd_graph_stats[$q][12]/$max_wtd_avganswerspeed)."' height='16' />".$wtd_graph_stats[$q][6]."</td></tr>";
		...
		if (date("d", strtotime($daySTART[$d]))!=1) 
			...
			for ($q=0; $q<count($mtd_graph_stats); $q++) {
				...
				$mtd_RISPOSTAED_graph.="  <tr><td class='chart_td$class'>".$mtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$mtd_graph_stats[$q][2]/$max_mtd_answered)."' height='16' />".$mtd_graph_stats[$q][2]."</td></tr>";
				...
				$mtd_AVGRISPOSTASPEED_graph.="  <tr><td class='chart_td$class'>".$mtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$mtd_graph_stats[$q][12]/$max_mtd_avganswerspeed)."' height='16' />".$mtd_graph_stats[$q][6]."</td></tr>";
	...
	#			{
				...
				for ($q=0; $q<count($qtd_graph_stats); $q++) {
					...
					$qtd_RISPOSTAED_graph.="  <tr><td class='chart_td$class'>".$qtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$qtd_graph_stats[$q][2]/$max_qtd_answered)."' height='16' />".$qtd_graph_stats[$q][2]."</td></tr>";
					...
					$qtd_AVGRISPOSTASPEED_graph.="  <tr><td class='chart_td$class'>".$qtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$qtd_graph_stats[$q][12]/$max_qtd_avganswerspeed)."' height='16' />".$qtd_graph_stats[$q][6]."</td></tr>";
	...
	#			}
			...
			for ($q=0; $q<count($graph_stats); $q++) {
				...
				$RISPOSTAED_graph.="  <tr><td class='chart_td$class'>".$graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$graph_stats[$q][2]/$max_answered)."' height='16' />".$graph_stats[$q][2]."</td></tr>";
				...
				$AVGRISPOSTASPEED_graph.="  <tr><td class='chart_td$class'>".$graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$graph_stats[$q][12]/$max_avganswerspeed)."' height='16' />".$graph_stats[$q][6]."</td></tr>";
	...
	$ASCII_text.="+-------------------------------------------+---------+----------+-----------+---------+---------+--------+--------+------------+------------+------------+\n";
	$ASCII_text.="|                                    TOTALI | $FtotCALLS | $FtotRISPOSTAS | $FtotABANDONS | $FtotABANDONSpct%| $FtotABANDONSavgTIME | $FtotRISPOSTASavgspeedTIME | $FtotRISPOSTASavgTIME | $FtotRISPOSTAStalkTIME | $FtotRISPOSTASwrapTIME | $FtotRISPOSTAStotTIME |\n";
	$ASCII_text.="+-------------------------------------------+---------+----------+-----------+---------+---------+--------+--------+------------+------------+------------+\n";
	$CSV_text.="\"TOTALI\",\"$FtotCALLS\",\"$FtotRISPOSTAS\",\"$FtotABANDONS\",\"$FtotABANDONSpct%\",\"$FtotABANDONSavgTIME\",\"$FtotRISPOSTASavgspeedTIME\",\"$FtotRISPOSTASavgTIME\",\"$FtotRISPOSTAStalkTIME\",\"$FtotRISPOSTASwrapTIME\",\"$FtotRISPOSTAStotTIME\"\n";
