...
$report_name = 'Called Counts ID Listas Report';
$db_source = 'M';
...
$HEADER.="function LoadListe(FromBox) {\n";
$HEADER.="	if (!FromBox) {alert(\"NO\"); return false;}\n";
$HEADER.="	var selectedCampagnas=\"|\";\n";
...
$HEADER.="			selectedCampagnas += document.getElementById('group').options[i].value+\"|\";\n";
$HEADER.="		} \n";
$HEADER.="	}\n";
$HEADER.="\n";
$HEADER.="	// Cancella elenco menu\n";
$HEADER.="	document.getElementById('list_ids').options.length=0;\n";
$HEADER.="	var new_list = new Opzione();\n";
...
$HEADER.="		var campaign_matches = selectedCampagnas.match(campaignID);\n";
...
$MAIN.="<TABLE CELLSPACING=3><TR><TD VALIGN=TOP><input type='checkbox' name='override_date' value='1' checked>All dates<BR><BR>Date:<BR>";
...
$MAIN.="Liste: <font size=1>(optional, possibilmente lento)</font><BR>\n";
$MAIN.=$list_options;
...
if (strlen($QUERY_STRING) > 5)
	...
	$CSV_text="";
	$MAIN.="<center>\n";
	$MAIN.="<br><b>CALLED COUNTS WITHIN LIST(S) $list_id_title_str$date_range_title:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"$PHP_SELF?DB=$DB$groupQS$list_idQS&query_date=$query_date&end_date=$end_date&override_date=$override_date&INVIA=$INVIA&file_download=1\">[DOWNLOAD]</a></b><br>\n";
	$CSV_text.="CALLED COUNTS WITHIN LIST(S) $list_id_title_str$date_range_title:\n";
	$MAIN.="<TABLE width=700 cellspacing=1>\n";
	$MAIN.="<tr><td align=left><font size=1>ESITO</td><td align=center><font size=1>NOME ESITO</td>";
	$CSV_text.="\"STATUS\",\"NOME ESITO\",";
	...
	$MAIN.="<td align=center><font size=1>SUBTOTALE</td></tr>\n";
	$CSV_text.="\"SUBTOTAL\"\n";
	...
	$MAIN.="<tr><td align=center colspan=2><b><font size=1>TOTALE</td>";
	$CSV_text.="\"\",\"TOTAL\",";
	$first = $all_called_first;
	while ($first <= $all_called_last)
		{
