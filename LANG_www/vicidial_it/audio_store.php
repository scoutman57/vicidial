...
if ( (!preg_match("/\|$ip\|/", $server_ips)) and ($formIPvalid < 1) )
	...
	if( (strlen($PHP_AUTH_USER)<2) or (strlen($PHP_AUTH_PW)<2) or (!$auth))
		...
		echo "Utentename/Password non validi: |$PHP_AUTH_USER|$PHP_AUTH_PW|$ip|\n";
		exit;
		}
	}
...
<table align=center width="700" border=0 cellpadding=5 cellspacing=0 bgcolor=#D9E6FE>
  <tr>
	<td align=right width="35%"><B><font face="arial, helvetica" size=2>Audio file da caricare:</font></B></td>
	<td align=left width="65%"><input type=file name="audiofile" value=""> <?php echo "$NWB#audio_store$NWE"; ?></td>
  </tr>
  <tr>
	<td align=center colspan=2><input type=submit name=submit value=submit></td>
  </tr>
  <tr><td align=left><font size=1> &nbsp; </font></td><td align=right><font size=1>Audio Store- &nbsp; &nbsp; VERSIONE: <?php echo $version ?> &nbsp; &nbsp; BUILD: <?php echo $build ?> &nbsp; &nbsp; </td></tr>
</table>
</form>
<BR><BR>
<CENTER><B>Si consiglia VIVAMENTE caricare solo 16bit Mono 8k file audio WAV PCM(.wav)</B>
<BR><BR><font size=1>Tutti gli spazi saranno rimossi dai nomi dei file audio caricati </font><BR><BR>
...
if ($auth_delete > 0)
	{
	echo "<center><BR><BR>File da eliminare:<BR>\n";
...
echo "</B></B><br><br><a href=\"admin.php?ADD=720000000000000&category=AUDIOSTORE&stage=manualupload\">Clicca qui per vedere un registro degli arrivi al negozio audio</FONT>\n";
