...
if (strlen($group[0]) < 1)
	...
	while ($i < $listids_to_print)
		...
		$FLAGS_graph.="  <tr><td class='chart_td first'>ΑΝΘΡΩΠΙΝΗ ΑΠΑΝΤΗΣΗ</td><td nowrap class='chart_td value first'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$HA_count/$max_flags)."' height='16' />$HA_count ($HA_percent%)</td></tr>";
