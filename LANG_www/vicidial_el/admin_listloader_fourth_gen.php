...
function ShowProgress(good, bad, total, dup, inv, post) 
	...
	parent.lead_count.document.write('<html><body><table border=0 width=200 cellpadding=10 cellspacing=0 align=center valign=top><tr bgcolor="#000000"><th colspan=2><font face="arial, helvetica" size=3 color=white>Κατάσταση αρχείου:</font></th></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B>Good:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+good+'</B></font></td></tr><tr bgcolor="#990000"><td align=right><font face="arial, helvetica" size=2 color=white><B>Bad:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+bad+'</B></font></td></tr><tr bgcolor="#000099"><td align=right><font face="arial, helvetica" size=2 color=white><B>Total:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+total+'</B></font></td></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B> &nbsp; </B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B> &nbsp; </B></font></td></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B>Duplicate:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+dup+'</B></font></td></tr></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B>Invalid:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+inv+'</B></font></td></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B>Postal Match:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+post+'</B></font></td></tr></table><body></html>');
	...
	if ($file_layout!="custom") 
		...
		<table align=center width="780" border=0 cellpadding=5 cellspacing=0 bgcolor=#D9E6FE>
		  ...
		  <tr>
			...
			<select name='list_id_override' onchange="PopulateΚαθεστώτων(this.value)">
			<option value='in_file' selected='yes'>Φόρτωση αρχείων από μόλυβδο</option>
			<?php
		  ...
		  <tr>
			...
			<td align=left><font face="arial, helvetica" size=2><input type=radio name="file_layout" value="standard" checked>Standard Format&nbsp;&nbsp;&nbsp;&nbsp;<input type=radio name="file_layout" value="custom">Εμφάνιση συνήθειας&nbsp;&nbsp;&nbsp;&nbsp;<input type=radio name="file_layout" value="template">Custom Template <?php echo "$NWB#list_loader-file_layout$NWE"; ?></td>
		  </tr>
		  <tr>
			<td align=right valign=top><B><font face="arial, helvetica" size=2>Προσαρμοσμένη πρότυπο που θα χρησιμοποιηθεί:</font></B></td>
...
<?php
				...
				if (mysqli_num_rows($template_rslt)>0) {
					echo "<option value='' selected>--Επιλέξτε προσαρμοσμένο πρότυπο--</option>";
...
?>
			</select> <a href='AST_admin_template_maker.php'><font face="arial, helvetica" size=1>οικοδόμος πρότυπο</font></a><?php echo "$NWB#list_loader-template_id$NWE"; ?><BR><a href='#' onClick="TemplateSpecs()"><font face="arial, helvetica" size=1>View template info</font></a></td>
		  <tr>
	...
	<tr bgcolor="#D9E6FE">
		<td width='25%' align="right"><font class="standard">Κατάσταση Διπλότυπο Έλεγχος:</font></td>
		<td width='75%'>
		...
		<tr>
			<td align=center colspan=2><input type=submit value="ΕΠΙΒΕΒΑΙΩΣΗ" name='submit_file'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button onClick="javascript:document.location='admin_listloader_fourth_gen.php'" value="ΞΕΚΙΝΑ ΠΑΛΙ" name='reload_page'></td>
		  </tr>
		  <tr><td align=left><font size=1> &nbsp; &nbsp; &nbsp; &nbsp; <a href="admin.php?ADD=100" target="_parent">ΠΙΣΩ ΣΤΗ ΔΙΑΧΕΙΡΙΣΗ</a> &nbsp; &nbsp; &nbsp; &nbsp; <a href="./admin_listloader_third_gen.php">Old Lead Loader</a> &nbsp; &nbsp; </font></td><td align=right><font size=1>LIST LOADER 4th Gen- &nbsp; &nbsp; ΕΚΔΟΣΗ: <?php echo $version ?> &nbsp; &nbsp; ΔΗΜΙΟΥΡΓΙΑ: <?php echo $build ?> &nbsp; &nbsp; </td></tr>
		</table>
		<?php 
	...
	<tr>
	<td align=right width="35%"><B><font face="arial, helvetica" size=2>ID Λίστας Override:</font></B></td>
	<td align=left width="75%"><font face="arial, helvetica" size=2><?php echo $list_id_override ?></font></td>
	</tr>
	<tr>
	<td align=right width="35%"><B><font face="arial, helvetica" size=2>Μήκη Override:</font></B></td>
	...
	<input type=hidden name='leadfile_name' value="<?php echo $leadfile_name ?>">
	<input type=hidden name='DB' value="<?php echo $DB ?>">
	<a href="admin_listloader_fourth_gen.php">Load Another Lead File</a> &nbsp; &nbsp; &nbsp; &nbsp;</font></B> <font size=1>ΕΚΔΟΣΗ: <?php echo $version ?> &nbsp; &nbsp; ΔΗΜΙΟΥΡΓΙΑ: <?php echo $build ?>
	</font></td>
	</tr></table>
	<BR><BR><BR><BR>
	<?php
...
if ($OK_to_process) 
	...
	if (count($field_check)>=2) 
		...
		flush();
		$file=fopen("$lead_file", "r");
		print "<center><font face='arial, helvetica' size=3 color='#009900'><B>Επεξεργασίαfile...\n";
		...
		if (strlen($status_dedupe_str)>0) 
			{
			print "<BR>Παραλείποντας DUPLICATES ΚΑΤΑ ΠΑΡΑΚΑΤΩ ΚΑΤΑΣΤΑΣΕΙΣ ΜΟΝΟ: $status_dedupe_str<BR>\n";
			}
		...
		if ($custom_fields_enabled > 0)
			...
			$stmt="ΕΜΦΑΝΙΣΗ ΠΙΝΑΚΑΣS LIKE \"custom_$list_id_override\";";
			if ($DB>0) {echo "$stmt\n";}
			$rslt=mysql_to_mysqli($stmt, $link);
			...
			if (strlen($buffer)>0) 
				...
				if ( ($valid_number>0) and ($dup_lead<1) and ($list_id >= 100 ))
					...
					if ($bad < 1000000)
						...
						if ( $list_id < 100 )
							{
							print "<BR></b><font size=1 color=red>record $total BAD- PHONE: $phone_number ROW: |$row[0]| INVALID ID ΛΙΣΤΑΣ</font><b>\n";
							}
						else
							{
							if ($valid_number < 1)
...
if (($leadfile) && ($LF_path))
	...
	if ($file_layout=="template"  && $template_id) 
		...
		if (count($field_check)>=2) 
			...
			$file=fopen("$lead_file", "r");
			$total=0; $good=0; $bad=0; $dup=0; $post=0; $phone_list='';
			print "<center><font face='arial, helvetica' size=3 color='#009900'><B>Επεξεργασία$delim_name file using template $template_id... ($tab_count|$pipe_count)\n";
			if (strlen($list_id_override)>0) 
				{
				print "<BR>ID ΛΙΣΤΑΣ OVERRIDE FOR THIS FILE: $list_id_override<BR>";
				}
			if (strlen($phone_code_override)>0) 
				{
				print "<BR>ΣΥΜΠΛΗΡΩΜΑΤΙΚΗ ΠΡΟΜΉΘΕΙΑ ΤΗΛΕΦΩΝΙΚΟΥ ΚΩΔΙΚΑ ΓΙΑ ΑΥΤΟ ΤΟ ΑΡΧΕΙΟ: $phone_code_override<BR>\n";
				}
			if (strlen($template_statuses)>0) 
				{
				print "<BR>Παραλείποντας DUPLICATES ΚΑΤΑ ΠΑΡΑΚΑΤΩ ΚΑΤΑΣΤΑΣΕΙΣ ΜΟΝΟ: ".preg_replace('/\'/', '', $template_statuses)."<BR>\n";
				}
			while (!feof($file)) 
				{
				$record++;
...
/*
	...
	if ($file_layout=="standard") 
		...
		if (count($field_check)>=2) 
			...
			$file=fopen("$lead_file", "r");
			$total=0; $good=0; $bad=0; $dup=0; $post=0; $phone_list='';
			print "<center><font face='arial, helvetica' size=3 color='#009900'><B>Επεξεργασία$delim_name file... ($tab_count|$pipe_count)\n";
	...
	##### BEGIN field chooser #####
		...
		flush();
		$file=fopen("$lead_file", "r");
		print "<center><font face='arial, helvetica' size=3 color='#009900'><B>Επεξεργασία$delim_name file...\n";
		...
		print "    <th colspan=2><input type=submit name='OK_to_process' value='ΟΚ ΓΙΑ ΕΠΕΞΕΡΓΑΣΙΑ'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button onClick=\"javascript:document.location='admin_listloader_fourth_gen.php'\" value=\"ΞΕΚΙΝΑ ΠΑΛΙ\" name='reload_page'></th>\r\n";
		print "  </tr>\r\n";
		print "</table>\r\n";
