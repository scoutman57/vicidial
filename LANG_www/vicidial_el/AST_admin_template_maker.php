...
?>
	...
	<tr valign="top">
		...
		<form id="listloader_file_primer" action="leadloader_template_display.php?form_action=prime_file" method="post" enctype="multipart/form-data" target="file_holder">
			<font class="standard">Δείγμα αρχείου τοποθέτηση πρότυπο:<BR><font size="-2">()</font></font><?php echo "$NWB#vicidial_template_maker-create_template$NWE"; ?><BR><BR><input type=file name="sample_template_file" value="<?php echo $sample_template_file; ?>" onChange="loadIFrame('prime_file', this.value); this.form.submit();">
		</form>
		</td>
		<td align="left" width='50%'><form action="<?php echo $PHP_SELF; ?>" method="post"><font class="standard">Επιλέξτε το πρότυπο για να διαγράψετε:</font><?php echo "$NWB#vicidial_template_maker-delete_template$NWE"; ?><BR><select name="template_id" onChange="loadIFrame('hide_new_template_form', '')">
<?php
...
<table border=0 cellpadding=3 cellspacing=1 width="100%" align="center">
	<tr>
		<th colspan="2" bgcolor="#330099"><font class="standard" color="white">Ορισμός στηλών για πεδία αρχείου<BR/><font size='-2'>(Επιλέγοντας μια διαφορετική λίστα θα επαναφέρετε στήλες)</font></font><?php echo "$NWB#vicidial_template_maker-assign_columns$NWE"; ?></th>
	</tr>
	<tr valign="top">
