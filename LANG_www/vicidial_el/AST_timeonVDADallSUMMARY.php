...
if (!isset($types))			{$types='ΕΜΦΑΝΙΣΗ ALL ΕΚΣΤΡΑΤΕΙΕΣ';}

$report_name = 'Real-Time Εκστρατεία Summary';
$db_source = 'M';
...
$MAIN.="<b>Real-Time All Εκστρατείες Summary</b> &nbsp; &nbsp; &nbsp; \n";
...
$MAIN.=" &nbsp; &nbsp; &nbsp;<a href=\"$PHP_SELF?group=$group&RR=$RR&DB=$DB&adastats=$adastats&types=$types&file_download=1\">ΛΗΨΗ</a> | <a href=\"./admin.php?ADD=999999\">ΑΝΑΦΟΡΕΣ</a>";
$MAIN.="\n";
...
$MAIN.="<option value=\"ΕΜΦΑΝΙΣΗ ALL ΕΚΣΤΡΑΤΕΙΕΣ\"";
	if ($types == 'ΕΜΦΑΝΙΣΗ ALL ΕΚΣΤΡΑΤΕΙΕΣ') {$MAIN.=" selected";} 
$MAIN.=">ΕΜΦΑΝΙΣΗ ALL ΕΚΣΤΡΑΤΕΙΕΣ</option>";
...
$MAIN.="</select> \n";
$MAIN.="<input type=submit name=submit value='ΕΠΙΒΕΒΑΙΩΣΗ'>\n";
$MAIN.="<BR><BR>\n\n";
...
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>DIAL ΕΠΙΠΕΔΟ:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DIALlev&nbsp; &nbsp; </TD>";
...
$CSV_text.="\"DIAL ΕΠΙΠΕΔΟ:\",\"$DIALlev\",\"TRUNK SHORT/FILL:\",\"$balanceSHORT / $balanceFILL\",\"FILTER:\",\"$DIALfilter\",\"TIME:\",\"$NOW_TIME\"\n";

if ($adastats>1)
	{
	$MAIN.="<TR BGCOLOR=\"#CCCCCC\">";
	$MAIN.="<TD ALIGN=RIGHT><font size=2>&nbsp; <B>MAX ΕΠΙΠΕΔΟ:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $maxDIALlev &nbsp; </TD>";
	...
	$MAIN.="</TR>";
	$CSV_text.="\"MAX ΕΠΙΠΕΔΟ:\",\"$maxDIALlev\",\"DROPPED MAX:\",\"$DROPmax\",\"TARGET DIFF:\",\"$targetDIFF\",\"INTENSITY:\",\"$ADAintense\"\n";
...
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>ΤΗΛΕΦΩΝΕΙΣΤΕ ΜΕΘΟΔΟΣ:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DIALmethod &nbsp; &nbsp; </TD>";
$MAIN.="</TR>";
$CSV_text.="\"DIALABLE LEADS:\",\"$DAleads\",\"CALLS TODAY:\",\"$callsTODAY\",\"AVG AGENTS:\",\"$agentsONEMIN\",\"ΤΗΛΕΦΩΝΕΙΣΤΕ ΜΕΘΟΔΟΣ:\",\"$DIALmethod\"\n";

$MAIN.="<TR>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>HOPPER ΕΠΙΠΕΔΟ:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $HOPlev &nbsp; &nbsp; </TD>";
$MAIN.="<TD ALIGN=RIGHT><font size=2><B>DROPPED / ΑΠΑΝΤΗΣΗED:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $dropsTODAY / $answersTODAY &nbsp; </TD>";
...
$MAIN.="</TR>";
$CSV_text.="\"HOPPER ΕΠΙΠΕΔΟ:\",\"$HOPlev\",\"DROPPED / ΑΠΑΝΤΗΣΗED:\",\"$dropsTODAY / $answersTODAY\",\"DL DIFF:\",\"$diffONEMIN\",\"STATUSES:\",\"$DIALstatuses\"\n";
...
if ($VSCagentcalls > 0)
	...
	$MAIN.="<TR>";
	$MAIN.="<TD ALIGN=RIGHT><font size=2><B>ΧΕΙΡΙΣΤΗΣAVG WAIT:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $avgwaitTODAY &nbsp;</TD>";
	...
	$MAIN.="</TR>";
	$CSV_text.="\"ΧΕΙΡΙΣΤΗΣAVG WAIT:\",\"$avgwaitTODAY\",\"AVG CUSTTIME:\",\"$avgcustTODAY\",\"AVG ACW:\",\"$avgacwTODAY\",\"AVG PAUSE:\",\"$avgpauseTODAY\"\n";
	}
...
$parked_to_print = mysql_num_rows($rslt);
	...
	{
	$MAIN.="ΔΕΝ ΥΠΑΡΧΟΥΝ ΕΝΕΡΓΕΣ ΚΛΗΣΕΙΣ ΣΕ ΑΝΑΜΟΝΗ \n";
