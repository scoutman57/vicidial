...
function realtime_refresh_display()
	...
	if (ar_seconds > 0)
		{
		document.getElementById("ανανέωσης_countdown").innerHTML = "" + ar_seconds + "";
		ar_seconds = (ar_seconds - 1);
		setTimeout("realtime_ανανέωσης_display()",1000);
		}
	else
		{
		document.getElementById("ανανέωσης_countdown").innerHTML = "0";
		ar_seconds = ar_ανανέωσης;
...
echo " &nbsp; &nbsp; &nbsp; ανανέωσης: <span id=ανανέωσης_countdown name=ανανέωσης_countdown></span>\n\n";
