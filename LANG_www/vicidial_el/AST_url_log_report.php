...
if ($ΕΠΙΒΕΒΑΙΩΣΗ && $url_type_ct>0) {
	...
	if (mysqli_num_rows($rslt)>0) {
		...
		$HTML_text.="<TR><TH class='small_standard_bold grey_graph_cell'>URL TYPE</th><TH class='small_standard_bold grey_graph_cell'>ΚΑΤΑΜΕΤΡΗΣΗ</th></tr>";
		...
		$ASCII_text.="--- URL LOG RECORDS FOR $query_date, $query_date_D TO $query_date_T $server_rpt_string, RECORDS #$lower_limit-$upper_limit               <a href=\"$PHP_SELF?ΕΠΙΒΕΒΑΙΩΣΗ=$ΕΠΙΒΕΒΑΙΩΣΗ&DB=$DB&type=$type&query_date=$query_date&query_date_D=$query_date_D&query_date_T=$query_date_T$url_typeQS&lower_limit=$lower_limit&upper_limit=$upper_limit&file_download=1\">[ΛΗΨΗ]</a>\n";
		$url_rpt.="+----------------------+---------------------+--------------+----------+----------------------------------------------------------------------------------+----------------------------------------------------------------------------------+\n";
		...
		$HTML_rpt.="<TR><TH colspan='5' class='small_standard_bold grey_graph_cell'>URL LOG RECORDS FOR $query_date, $query_date_D TO $query_date_T $server_rpt_string, RECORDS #$lower_limit-$upper_limit</TH><TD align='right' class='small_standard_bold grey_graph_cell'><a href=\"$PHP_SELF?ΕΠΙΒΕΒΑΙΩΣΗ=$ΕΠΙΒΕΒΑΙΩΣΗ&DB=$DB&type=$type&query_date=$query_date&query_date_D=$query_date_D&query_date_T=$query_date_T$url_typeQS&lower_limit=$lower_limit&upper_limit=$upper_limit&file_download=1\">[ΛΗΨΗ]</a></td></TR>";
		$HTML_rpt.="<TR><TH class='small_standard_bold grey_graph_cell' width='90'>UNIQUE ID</TH><TH class='small_standard_bold grey_graph_cell' width='120'>URL ΗΜΕΡΑ</TH><TH class='small_standard_bold grey_graph_cell' width='70'>URL TYPE</TH><TH class='small_standard_bold grey_graph_cell' width='70'>RESP SEC</TH><TH class='small_standard_bold grey_graph_cell' width='300'>URL</TH><TH class='small_standard_bold grey_graph_cell' width='300'>URL RESPONSE</TH></TR>";
		...
		if ($ll>=1) {
			$url_rpt_hf.="<a href=\"$PHP_SELF?ΕΠΙΒΕΒΑΙΩΣΗ=$ΕΠΙΒΕΒΑΙΩΣΗ&DB=$DB&report_display_type=$report_display_type&type=$type&query_date=$query_date&query_date_D=$query_date_D&query_date_T=$query_date_T$url_typeQS&lower_limit=$ll\">[<<< PREV 1000 records]</a>";
		...
		if (($lower_limit+1000)<mysqli_num_rows($rpt_rslt)) {
			...
			$url_rpt_hf.="<a href=\"$PHP_SELF?ΕΠΙΒΕΒΑΙΩΣΗ=$ΕΠΙΒΕΒΑΙΩΣΗ&DB=$DB&report_display_type=$report_display_type&type=$type&query_date=$query_date&query_date_D=$query_date_D&query_date_T=$query_date_T$url_typeQS&lower_limit=".($lower_limit+1000)."\">[NEXT $max_limit records >>>]</a>";
