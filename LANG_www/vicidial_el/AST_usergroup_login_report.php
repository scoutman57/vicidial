...
$report_name = 'Ομάδα Χρήστη Login Report';
$db_source = 'M';
...
if ($ΕΠΙΒΕΒΑΙΩΣΗ=="ΕΠΙΒΕΒΑΙΩΣΗ") 
	{
	$ASCII_text="+--------------------------------+----------+----------------------+---------------------+---------------------+----------+-----------------+-----------------+----------------------+--------------+-----------------+-----------------+-----------------+\n";
	$ASCII_text.="| USER NAME                      | ID       | ΟΜΑΔΑ ΧΡΗΣΤΩΝ           | FIRST LOGIN DATE    | LAST LOGIN DATE     | CAMPAIGN | ΔΙΑΚΟΜΙΣΤΗΣ IP       | COMPUTER IP     | EXTENSION            | BROWSER      | PHONE LOGIN     |  ΔΙΑΚΟΜΙΣΤΗΣ PHONE   | PHONE IP        |\n";
	$ASCII_text.="+--------------------------------+----------+----------------------+---------------------+---------------------+----------+-----------------+-----------------+----------------------+--------------+-----------------+-----------------+-----------------+\n";

	$CSV_text="\"Χρήστης group login report\",\"Χρήστης groups:\",\"$user_group_string\"\n\n";
	$CSV_text.="\"Χρήστης name\",\"Χρήστης ID\",\"Χρήστης group\",\"First login date\",\"Last login date\",\"ID Εκστρατείας\",\"IP Διακομιστή\",\"Computer IP\",\"Extension\",\"Browser\",\"Phone login\",\"Server phone\",\"Phone IP\"\n";
