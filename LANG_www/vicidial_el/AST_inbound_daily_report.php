...
$MAIN.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date&group=$group&shift=$shift&hourly_breakdown=$hourly_breakdown&ΕΠΙΒΕΒΑΙΩΣΗ=$ΕΠΙΒΕΒΑΙΩΣΗ&file_download=1\">ΛΗΨΗ</a> | <a href=\"./admin.php?ADD=3111&group_id=$group\">ΤΡΟΠΟΠΟΙΗΣΗ</a> | <a href=\"./admin.php?ADD=999999\">ΑΝΑΦΟΡΕΣ</a><BR><INPUT TYPE=checkbox NAME=hourly_breakdown VALUE='checked' $hourly_breakdown>Show hourly results</FONT>\n";
$MAIN.="</FORM>\n\n";
...
if (!$group)
	...
	*/
	...
	$ASCII_text.="| SHIFT                                     | CALLS   | CALLS    | CALLS     | ABANDON | ABANDON | ΑΠΑΝΤΗΣΗ | TALK   | TALK       | WRAP       | CALL       |\n";
	$ASCII_text.="| DATE-TIME RANGE                           | OFFERED | ΑΠΑΝΤΗΣΗED | ABANDONED | PERCENT | TIME    | SPEED  | TIME   | TIME       | TIME       | TIME       |\n";
	$ASCII_text.="+-------------------------------------------+---------+----------+-----------+---------+---------+--------+--------+------------+------------+------------+\n";
	$CSV_text.="\"\",\"TOTAL\",\"TOTAL\",\"TOTAL\",\"TOTAL\",\"AVG\",\"AVG\",\"AVG\",\"TOTAL\",\"TOTAL\",\"TOTAL\"\n";
	$CSV_text.="\"\",\"CALLS\",\"CALLS\",\"CALLS\",\"ABANDON\",\"ABANDON\",\"ΑΠΑΝΤΗΣΗ\",\"TALK\",\"TALK\",\"WRAP\",\"CALL\"\n";
	$CSV_text.="\"SHIFT DATE-TIME RANGE\",\"OFFERED\",\"ΑΠΑΝΤΗΣΗED\",\"ABANDONED\",\"PERCENT\",\"TIME\",\"SPEED\",\"TIME\",\"TIME\",\"TIME\",\"TIME\"\n";
	...
	*/	$totCALLSdate[$d] =	sprintf("%7s", $totCALLSdate[$d]);
		...
		if (date("w", strtotime($daySTART[$d]))==0 && date("w", strtotime($daySTART[$d-1]))!=0 && $d>0) 
			...
			$ASCII_text.="+-------------------------------------------+---------+----------+-----------+---------+---------+--------+--------+------------+------------+------------+\n";
			$ASCII_text.="|                                       WTD | $totCALLSwtd | $totΑΠΑΝΤΗΣΗSwtd | $totABANDONSwtd | $totABANDONSpctwtd%| $totABANDONSavgTIMEwtd | $totΑΠΑΝΤΗΣΗSavgspeedTIMEwtd | $totΑΠΑΝΤΗΣΗSavgTIMEwtd | $totΑΠΑΝΤΗΣΗStalkTIMEwtd | $totΑΠΑΝΤΗΣΗSwrapTIMEwtd | $totΑΠΑΝΤΗΣΗStotTIMEwtd |\n";
			$ASCII_text.="+-------------------------------------------+---------+----------+-----------+---------+---------+--------+--------+------------+------------+------------+\n";
			$CSV_text.="\"WTD\",\"$totCALLSwtd\",\"$totΑΠΑΝΤΗΣΗSwtd\",\"$totABANDONSwtd\",\"$totABANDONSpctwtd%\",\"$totABANDONSavgTIMEwtd\",\"$totΑΠΑΝΤΗΣΗSavgspeedTIMEwtd\",\"$totΑΠΑΝΤΗΣΗSavgTIMEwtd\",\"$totΑΠΑΝΤΗΣΗStalkTIMEwtd\",\"$totΑΠΑΝΤΗΣΗSwrapTIMEwtd\",\"$totΑΠΑΝΤΗΣΗStotTIMEwtd\"\n";
			$totCALLSwtd=0;
			$totΑΠΑΝΤΗΣΗSwtd=0;
			$totΑΠΑΝΤΗΣΗSsecwtd=0;
			$totΑΠΑΝΤΗΣΗSspeedwtd=0;
		...
		if (date("d", strtotime($daySTART[$d]))==1 && $d>0 && date("d", strtotime($daySTART[$d-1]))!=1) {
			...
			$ASCII_text.="+-------------------------------------------+---------+----------+-----------+---------+---------+--------+--------+------------+------------+------------+\n";
			$ASCII_text.="|                                       MTD | $totCALLSmtd | $totΑΠΑΝΤΗΣΗSmtd | $totABANDONSmtd | $totABANDONSpctmtd%| $totABANDONSavgTIMEmtd | $totΑΠΑΝΤΗΣΗSavgspeedTIMEmtd | $totΑΠΑΝΤΗΣΗSavgTIMEmtd | $totΑΠΑΝΤΗΣΗStalkTIMEmtd | $totΑΠΑΝΤΗΣΗSwrapTIMEmtd | $totΑΠΑΝΤΗΣΗStotTIMEmtd |\n";
			$ASCII_text.="+-------------------------------------------+---------+----------+-----------+---------+---------+--------+--------+------------+------------+------------+\n";
			$CSV_text.="\"MTD\",\"$totCALLSmtd\",\"$totΑΠΑΝΤΗΣΗSmtd\",\"$totABANDONSmtd\",\"$totABANDONSpctmtd%\",\"$totABANDONSavgTIMEmtd\",\"$totΑΠΑΝΤΗΣΗSavgspeedTIMEmtd\",\"$totΑΠΑΝΤΗΣΗSavgTIMEmtd\",\"$totΑΠΑΝΤΗΣΗStalkTIMEmtd\",\"$totΑΠΑΝΤΗΣΗSwrapTIMEmtd\",\"$totΑΠΑΝΤΗΣΗStotTIMEmtd\"\n";
			$totCALLSmtd=0;
			$totΑΠΑΝΤΗΣΗSmtd=0;
			$totΑΠΑΝΤΗΣΗSsecmtd=0;
			$totΑΠΑΝΤΗΣΗSspeedmtd=0;
			...
			if (date("m", strtotime($daySTART[$d]))==1 || date("m", strtotime($daySTART[$d]))==4 || date("m", strtotime($daySTART[$d]))==7 || date("m", strtotime($daySTART[$d]))==10) # Quarterly line
				...
				$ASCII_text.="|                                       QTD | $totCALLSqtd | $totΑΠΑΝΤΗΣΗSqtd | $totABANDONSqtd | $totABANDONSpctqtd%| $totABANDONSavgTIMEqtd | $totΑΠΑΝΤΗΣΗSavgspeedTIMEqt