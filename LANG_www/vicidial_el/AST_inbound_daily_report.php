...
#		}
	...
	*/
	...
	while ($d < $TOTintervals)
		...
		if ($totΑΠΑΝΤΗΣΗSdate[$d]>0)
			{
			$totΑΠΑΝΤΗΣΗSavgspeedTIME[$d] =	sprintf("%6s", date("i:s", mktime(0, 0, round($totΑΠΑΝΤΗΣΗSspeeddate[$d]/$totΑΠΑΝΤΗΣΗSdate[$d]))));
			$totΑΠΑΝΤΗΣΗSavgTIME[$d] =	sprintf("%6s", date("i:s", mktime(0, 0, round($totΑΠΑΝΤΗΣΗSsecdate[$d]/$totΑΠΑΝΤΗΣΗSdate[$d]))));
			if (round($totΑΠΑΝΤΗΣΗSspeeddate[$d]/$totΑΠΑΝΤΗΣΗSdate[$d])>$max_avganswerspeed) {$max_avganswerspeed=round($totΑΠΑΝΤΗΣΗSspeeddate[$d]/$totΑΠΑΝΤΗΣΗSdate[$d]);}
			$graph_stats[$d][12]=round($totΑΠΑΝΤΗΣΗSspeeddate[$d]/$totΑΠΑΝΤΗΣΗSdate[$d]);
			$graph_stats[$d][16]=round($totΑΠΑΝΤΗΣΗSsecdate[$d]/$totΑΠΑΝΤΗΣΗSdate[$d]);
			}
		else
			{
			$totΑΠΑΝΤΗΣΗSdate[$d]="0";
			$totΑΠΑΝΤΗΣΗSavgspeedTIME[$d] = " 00:00";
			$totΑΠΑΝΤΗΣΗSavgTIME[$d] = " 00:00";
			$graph_stats[$d][12]=0;
			$graph_stats[$d][16]=0;
			}
		$totΑΠΑΝΤΗΣΗStalkTIME[$d] =	sprintf("%10s", floor($totΑΠΑΝΤΗΣΗSsecdate[$d]/3600).date(":i:s", mktime(0, 0, $totΑΠΑΝΤΗΣΗSsecdate[$d])));
		$totΑΠΑΝΤΗΣΗSwrapTIME[$d] =	sprintf("%10s", floor(($totΑΠΑΝΤΗΣΗSdate[$d]*15)/3600).date(":i:s", mktime(0, 0, ($totΑΠΑΝΤΗΣΗSdate[$d]*15))));
		...
		$totΑΠΑΝΤΗΣΗStotTIME[$d] =	sprintf("%10s", floor(($totΑΠΑΝΤΗΣΗSsecdate[$d]+($totΑΠΑΝΤΗΣΗSdate[$d]*15))/3600).date(":i:s", mktime(0, 0, ($totΑΠΑΝΤΗΣΗSsecdate[$d]+($totΑΠΑΝΤΗΣΗSdate[$d]*15)))));
		...
		if (date("w", strtotime($daySTART[$d]))==0 && date("w", strtotime($daySTART[$d-1]))!=0 && $d>0) 
			...
			if ($totΑΠΑΝΤΗΣΗSwtd>0)
				{
				$totΑΠΑΝΤΗΣΗSavgspeedTIMEwtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totΑΠΑΝΤΗΣΗSspeedwtd/$totΑΠΑΝΤΗΣΗSwtd))));
				$totΑΠΑΝΤΗΣΗSavgTIMEwtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totΑΠΑΝΤΗΣΗSsecwtd/$totΑΠΑΝΤΗΣΗSwtd))));
				if (round($totΑΠΑΝΤΗΣΗSspeedwtd/$totΑΠΑΝΤΗΣΗSwtd)>$max_wtd_avganswerspeed) {$max_wtd_avganswerspeed=round($totΑΠΑΝΤΗΣΗSspeedwtd/$totΑΠΑΝΤΗΣΗSwtd);}
				$wtd_graph_stats[$wa][12]=round($totΑΠΑΝΤΗΣΗSspeedwtd/$totΑΠΑΝΤΗΣΗSwtd);
				$wtd_graph_stats[$wa][16]=round($totΑΠΑΝΤΗΣΗSsecwtd/$totΑΠΑΝΤΗΣΗSwtd);
				}
			else
				{
				$totΑΠΑΝΤΗΣΗSavgspeedTIMEwtd = " 00:00";
				$totΑΠΑΝΤΗΣΗSavgTIMEwtd = " 00:00";
				$wtd_graph_stats[$wa][12]=0;
				$wtd_graph_stats[$wa][16]=0;
				}
			$totΑΠΑΝΤΗΣΗStalkTIMEwtd =	sprintf("%10s", floor($totΑΠΑΝΤΗΣΗSsecwtd/3600).date(":i:s", mktime(0, 0, $totΑΠΑΝΤΗΣΗSsecwtd)));
			$totΑΠΑΝΤΗΣΗSwrapTIMEwtd =	sprintf("%10s", floor(($totΑΠΑΝΤΗΣΗSwtd*15)/3600).date(":i:s", mktime(0, 0, ($totΑΠΑΝΤΗΣΗSwtd*15))));
			...
			$totΑΠΑΝΤΗΣΗStotTIMEwtd =	sprintf("%10s", floor(($totΑΠΑΝΤΗΣΗSsecwtd+($totΑΠΑΝΤΗΣΗSwtd*15))/3600).date(":i:s", mktime(0, 0, ($totΑΠΑΝΤΗΣΗSsecwtd+($totΑΠΑΝΤΗΣΗSwtd*15)))));
			...
			if (round($totΑΠΑΝΤΗΣΗSsecwtd/$totΑΠΑΝΤΗΣΗSwtd)>$max_wtd_avgtalktime) {$max_wtd_avgtalktime=round($totΑΠΑΝΤΗΣΗSsecwtd/$totΑΠΑΝΤΗΣΗSwtd);}
		...
		if (date("d", strtotime($daySTART[$d]))==1 && $d>0 && date("d", strtotime($daySTART[$d-1]))!=1) 
			...
			if ($totΑΠΑΝΤΗΣΗSmtd>0)
				{
				$totΑΠΑΝΤΗΣΗSavgspeedTIMEmtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totΑΠΑΝΤΗΣΗSspeedmtd/$totΑΠΑΝΤΗΣΗSmtd))));
				$totΑΠΑΝΤΗΣΗSavgTIMEmtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totΑΠΑΝΤΗΣΗSsecmtd/$totΑΠΑΝΤΗΣΗSmtd))));
				if (round($totΑΠΑΝΤΗΣΗSspeedmtd/$totΑΠΑΝΤΗΣΗSmtd)>$max_mtd_avganswerspeed) {$max_mtd_avganswerspeed=round($totΑΠΑΝΤΗΣΗSspeedmtd/$totΑΠΑΝΤΗΣΗSmtd);}
				$mtd_graph_stats[$ma][12]=round($totΑΠΑΝΤΗΣΗSspeedmtd/$totΑΠΑΝΤΗΣΗSmtd);
				$mtd_graph_stats[$ma][16]=round($totΑΠΑΝΤΗΣΗSsecmtd/$totΑΠΑΝΤΗΣΗSmtd);
				}
			else
				{
				$totΑΠΑΝΤΗΣΗSavgspeedTIMEmtd = " 00:00";
				$totΑΠΑΝΤΗΣΗSavgTIMEmtd = " 00:00";
				$mtd_graph_stats[$ma][12]=0;
				$mtd_graph_stats[$ma][16]=0;
				}
			$totΑΠΑΝΤΗΣΗStalkTIMEmtd =	sprintf("%10s", floor($totΑΠΑΝΤΗΣΗSsecmtd/3600).date(":i:s", mktime(0, 0, $totΑΠΑΝΤΗΣΗSsecmtd)));
			$totΑΠΑΝΤΗΣΗSwrapTIMEmtd =	sprintf("%10s", floor(($totΑΠΑΝΤΗΣΗSmtd*15)/3600).date(":i:s", mktime(0, 0, ($totΑΠΑΝΤΗΣΗSmtd*15))));
			...
			$totΑΠΑΝΤΗΣΗStotTIMEmtd =	sprintf("%10s", floor(($totΑΠΑΝΤΗΣΗSsecmtd+($totΑΠΑΝΤΗΣΗSmtd*15))/3600).date(":i:s", mktime(0, 0, ($totΑΠΑΝΤΗΣΗSsecmtd+($totΑΠΑΝΤΗΣΗSmtd*15)))));
			$totAGENTSmtd=count(array_count_values($AGENTS_mtd_array));
			...
			if (round($totΑΠΑΝΤΗΣΗSsecmtd/$totΑΠΑΝΤΗΣΗSmtd)>$max_mtd_avgtalktime) {$max_mtd_avgtalktime=round($totΑΠΑΝΤΗΣΗSsecmtd/$totΑΠΑΝΤΗΣΗSmtd);}
			...
			if (date("m", strtotime($daySTART[$d]))==1 || date("m", strtotime($daySTART[$d]))==4 || date("m", strtotime($daySTART[$d]))==7 || date("m", strtotime($daySTART[$d]))==10) # Quarterly line
				...
				if ($totΑΠΑΝΤΗΣΗSqtd>0)
					{
					$totΑΠΑΝΤΗΣΗSavgspeedTIMEqtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totΑΠΑΝΤΗΣΗSspeedqtd/$totΑΠΑΝΤΗΣΗSqtd))));
					$totΑΠΑΝΤΗΣΗSavgTIMEqtd =	sprintf("%6s", date("i:s", mktime(0, 0, round($totΑΠΑΝΤΗΣΗSsecqtd/$totΑΠΑΝΤΗΣΗSqtd))));
					if (round($totΑΠΑΝΤΗΣΗSspeedqtd/$totΑΠΑΝΤΗΣΗSqtd)>$max_qtd_avganswerspeed) {$max_qtd_avganswerspeed=round($totΑΠΑΝΤΗΣΗSspeedqtd/$totΑΠΑΝΤΗΣΗSqtd);}
					$qtd_graph_stats[$qa][12]=round($totΑΠΑΝΤΗΣΗSspeedqtd/$totΑΠΑΝΤΗΣΗSqtd);
					$qtd_graph_stats[$qa][16]=round($totΑΠΑΝΤΗΣΗSsecqtd/$totΑΠΑΝΤΗΣΗSqtd);
					}
				else
					{
					$totΑΠΑΝΤΗΣΗSavgspeedTIMEqtd = " 00:00";
					$totΑΠΑΝΤΗΣΗSavgTIMEqtd = " 00:00";
					$qtd_graph_stats[$qa][12]=0;
					$qtd_graph_stats[$qa][16]=0;
					}
				$totΑΠΑΝΤΗΣΗStalkTIMEqtd =	sprintf("%10s", floor($totΑΠΑΝΤΗΣΗSsecqtd/3600).date(":i:s", mktime(0, 0, $totΑΠΑΝΤΗΣΗSsecqtd)));
				$totΑΠΑΝΤΗΣΗSwrapTIMEqtd =	sprintf("%10s", floor(($totΑΠΑΝΤΗΣΗSqtd*15)/3600).date(":i:s", mktime(0, 0, ($totΑΠΑΝΤΗΣΗSqtd*15))));
				...
				$totΑΠΑΝΤΗΣΗStotTIMEqtd =	sprintf("%10s", floor(($totΑΠΑΝΤΗΣΗSsecqtd+($totΑΠΑΝΤΗΣΗSqtd*15))/3600).date(":i:s", mktime(0, 0, ($totΑΠΑΝΤΗΣΗSsecqtd+($totΑΠΑΝΤΗΣΗSqtd*15)))));
				$totAGENTSqtd=count(array_count_values($AGENTS_qtd_array));
				...
				if (round($totΑΠΑΝΤΗΣΗSsecqtd/$totΑΠΑΝΤΗΣΗSqtd)>$max_qtd_avgtalktime) {$max_qtd_avgtalktime=round($totΑΠΑΝΤΗΣΗSsecqtd/$totΑΠΑΝΤΗΣΗSqtd);}
		...
		if (round($totΑΠΑΝΤΗΣΗSsecdate[$d]/$totΑΠΑΝΤΗΣΗSdate[$d])>$max_avgtalktime) {$max_avgtalktime=round($totΑΠΑΝΤΗΣΗSsecdate[$d]/$totΑΠΑΝΤΗΣΗSdate[$d]);}
	...
	if ($totCALLSsec > 0)
		...
		if ($FtotΑΠΑΝΤΗΣΗS>0) 
			{
			$FtotΑΠΑΝΤΗΣΗSavgspeedTIME =	sprintf("%6s", date("i:s", mktime(0, 0, round($FtotΑΠΑΝΤΗΣΗSspeed/$FtotΑΠΑΝΤΗΣΗS))));
			$FtotΑΠΑΝΤΗΣΗSavgTIME =	sprintf("%6s", date("i:s", mktime(0, 0, round($FtotΑΠΑΝΤΗΣΗSsec/$FtotΑΠΑΝΤΗΣΗS))));
			}
		else 
			{
			$FtotΑΠΑΝΤΗΣΗSavgspeedTIME =	sprintf("%6s", "00:00");
			$FtotΑΠΑΝΤΗΣΗSavgTIME =	sprintf("%6s", "00:00");
			}
		$FtotΑΠΑΝΤΗΣΗStalkTIME =	sprintf("%10s", floor($FtotΑΠΑΝΤΗΣΗSsec/3600).date(":i:s", mktime(0, 0, $FtotΑΠΑΝΤΗΣΗSsec)));
		$FtotΑΠΑΝΤΗΣΗSwrapTIME =	sprintf("%10s", floor(($FtotΑΠΑΝΤΗΣΗS*15)/3600).date(":i:s", mktime(0, 0, ($FtotΑΠΑΝΤΗΣΗS*15))));
		$FtotΑΠΑΝΤΗΣΗStotTIME =	sprintf("%10s", floor(($FtotΑΠΑΝΤΗΣΗSsec+($FtotΑΠΑΝΤΗΣΗS*15))/3600).date(":i:s", mktime(0, 0, ($FtotΑΠΑΝΤΗΣΗSsec+($FtotΑΠΑΝΤΗΣΗS*15)))));
		...
		if (date("w", strtotime($daySTART[$d]))>0) 
			...
			for ($q=0; $q<count($wtd_graph_stats); $q++) {
				...
				$wtd_ΑΠΑΝΤΗΣΗED_graph.="  <tr><td class='chart_td$class'>".$wtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$wtd_graph_stats[$q][2]/$max_wtd_answered)."' height='16' />".$wtd_graph_stats[$q][2]."</td></tr>";
				...
				$wtd_AVGΑΠΑΝΤΗΣΗSPEED_graph.="  <tr><td class='chart_td$class'>".$wtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$wtd_graph_stats[$q][12]/$max_wtd_avganswerspeed)."' height='16' />".$wtd_graph_stats[$q][6]."</td></tr>";
		...
		if (date("d", strtotime($daySTART[$d]))!=1) 
			...
			for ($q=0; $q<count($mtd_graph_stats); $q++) {
				...
				$mtd_ΑΠΑΝΤΗΣΗED_graph.="  <tr><td class='chart_td$class'>".$mtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$mtd_graph_stats[$q][2]/$max_mtd_answered)."' height='16' />".$mtd_graph_stats[$q][2]."</td></tr>";
				...
				$mtd_AVGΑΠΑΝΤΗΣΗSPEED_graph.="  <tr><td class='chart_td$class'>".$mtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$mtd_graph_stats[$q][12]/$max_mtd_avganswerspeed)."' height='16' />".$mtd_graph_stats[$q][6]."</td></tr>";
	...
	#			{
			$totAGENTSqtd=count(array_count_values($AGENTS_qtd_array));
				...
				for ($q=0; $q<count($qtd_graph_stats); $q++) {
					...
					$qtd_ΑΠΑΝΤΗΣΗED_graph.="  <tr><td class='chart_td$class'>".$qtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$qtd_graph_stats[$q][2]/$max_qtd_answered)."' height='16' />".$qtd_graph_stats[$q][2]."</td></tr>";
					...
					$qtd_AVGΑΠΑΝΤΗΣΗSPEED_graph.="  <tr><td class='chart_td$class'>".$qtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$qtd_graph_stats[$q][12]/$max_qtd_avganswerspeed)."' height='16' />".$qtd_graph_stats[$q][6]."</td></tr>";
	...
	#			}
			...
			for ($q=0; $q<count($graph_stats); $q++) {
				...
				$ΑΠΑΝΤΗΣΗED_graph.="  <tr><td class='chart_td$class'>".$graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$graph_stats[$q][2]/$max_answered)."' height='16' />".$graph_stats[$q][2]."</td></tr>";
				...
				$AVGΑΠΑΝΤΗΣΗSPEED_graph.="  <tr><td class='chart_td$class'>".$graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(400*$graph_stats[$q][12]/$max_avganswerspeed)."' height='16' />".$graph_stats[$q][6]."</td></tr>";
