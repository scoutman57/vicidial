...
$MAIN.="<INPUT TYPE=submit NAME=ΕΠΙΒΕΒΑΙΩΣΗ VALUE=ΥΠΟΒΑΛΛΩ></TD></TR>\n";
$MAIN.="<TR><TD align='left'><FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2><INPUT TYPE=checkbox NAME=hourly_breakdown VALUE='checked' $hourly_breakdown>Show hourly results<BR><INPUT TYPE=checkbox NAME=show_disposition_statuses VALUE='checked' $show_disposition_statuses>Show disposition statuses<BR><INPUT TYPE=checkbox NAME=ignore_afterhours VALUE='checked' $ignore_afterhours>Ignore after-hours calls</FONT></TD><TD align='right'><a href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date$selected_group_URLstr&shift=$shift&hourly_breakdown=$hourly_breakdown&show_disposition_statuses=$show_disposition_statuses&ΕΠΙΒΕΒΑΙΩΣΗ=$ΕΠΙΒΕΒΑΙΩΣΗ&file_download=1\">ΛΗΨΗ</a> | <a href=\"./admin.php?ADD=3111&group_id=$group\">ΤΡΟΠΟΠΟΙΗΣΗ</a> | <a href=\"./admin.php?ADD=999999\">ΑΝΑΦΟΡΕΣ</a></TD></TR>\n";
...
#		}
	...
	while ($i < $records_to_grab)
		...
		if ($row[6]!="VDCL" && $row[6]!="") {$ag[$i] = $row[6];} # Χρήστης
		# $fTOTAL_agents["$row[6]"]++;
	...
	#	$qrtQUEUE[$j]=0; $qrtQUEUEsec[$j]=0; $qrtQUEUEmax[$j]=0;
		...
		$totΑΠΑΝΤΗΣΗSdate[$j]=0;
		$totΑΠΑΝΤΗΣΗSsecdate[$j]=0;
		$totΑΠΑΝΤΗΣΗSspeeddate[$j]=0;
		$i=0;
		$agents_array=array();
		while ($i < $records_to_grab)
			{
	...
	#			$dtt = $dt[$i];
				...
				if (preg_match('/ABANDON|NOAGENT|QUEUETIMEOUT|AFTERHOURS|MAXCALLS/', $tr[$i])) 
					...
					if (($ls[$i]-$qs[$i]-15)>0) {  ## Patch by Joe J - can cause negative time values if removed.
						$totΑΠΑΝΤΗΣΗSsecdate[$j]+=($ls[$i]-$qs[$i]-15);
						$FtotΑΠΑΝΤΗΣΗSsec+=($ls[$i]-$qs[$i]-15);
					}
					$totΑΠΑΝΤΗΣΗSspeeddate[$j]+=$qs[$i];
					$FtotΑΠΑΝΤΗΣΗS++;
					print "<!-- $FtotΑΠΑΝΤΗΣΗSspeed+=$qs[$i] //-->\n";
					$FtotΑΠΑΝΤΗΣΗSspeed+=$qs[$i];
					}
	...
	*/
	...
	$MAIN2="| SHIFT                                     | CALLS   | CALLS    | AGENTS   | CALLS     | ABANDON | ABANDON | ΑΠΑΝΤΗΣΗ | TALK   | TALK       | WRAP       | CALL       |";
	$MAIN3="| DATE-TIME RANGE                           | OFFERED | ΑΠΑΝΤΗΣΗED | ΑΠΑΝΤΗΣΗED | ABANDONED | PERCENT | TIME    | SPEED  | TIME   | TIME       | TIME       | TIME       |";
	$CSV_text1="";
	$CSV_text2="";
	$CSV_text3="";
	...
	$CSV_text.="\"\",\"CALLS\",\"CALLS\",\"AGENTS\",\"CALLS\",\"ABANDON\",\"ABANDON\",\"ΑΠΑΝΤΗΣΗ\",\"TALK\",\"TALK\",\"WRAP\",\"CALL\"$CSV_text2\n";
	$CSV_text.="\"SHIFT DATE-TIME RANGE\",\"OFFERED\",\"ΑΠΑΝΤΗΣΗED\",\"ΑΠΑΝΤΗΣΗED\",\"ABANDONED\",\"PERCENT\",\"TIME\",\"SPEED\",\"TIME\",\"TIME\",\"TIME\",\"TIME\"$CSV_text3\n";
	...
	$GRAPH="<a name='multigroup_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800'><tr><th width='10%' class='grey_graph_cell' id='multigroup_graph1'><a href='#' onClick=\"DrawGraph('OFFERED', '1'); return false;\">ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣOFFERED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph2'><a href='#' onClick=\"DrawGraph('ΑΠΑΝΤΗΣΗED', '2'); return false;\">ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣΑΠΑΝΤΗΣΗED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph11'><a href='#' onClick=\"DrawGraph('AGENTS', '11'); return false;\">TOTAL AGENTS ΑΠΑΝΤΗΣΗED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph3'><a href='#' onClick=\"DrawGraph('ABANDONED', '3'); return false;\">ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣABANDONED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph4'><a href='#' onClick=\"DrawGraph('ABANDONPCT', '4'); return false;\">TOTAL ABANDON PERCENT</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph5'><a href='#' onClick=\"DrawGraph('AVGABANDONTIME', '5'); return false;\">AVG ABANDON TIME</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph6'><a href='#' onClick=\"DrawGraph('AVGΑΠΑΝΤΗΣΗSPEED', '6'); return false;\">AVG ΑΠΑΝΤΗΣΗ SPEED</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph7'><a href='#' onClick=\"DrawGraph('AVGTALKTIME', '7'); return false;\">AVG TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph8'><a href='#' onClick=\"DrawGraph('TOTALTALKTIME', '8'); return false;\">TOTAL TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph9'><a href='#' onClick=\"DrawGraph('TOTALWRAPTIME', '9'); return false;\">TOTAL WRAP TIME</a></th><th width='10%' class='grey_graph_cell' id='multigroup_graph10'><a href='#' onClick=\"DrawGraph('TOTALCALLTIME', '10'); return false;\">TOTAL CALL TIME</a></th></tr><tr><td colspan='11' class='graph_span_cell' align='center'><span id='stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
	$MTD_GRAPH="<BR><BR><a name='MTD_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800'><tr><th width='10%' class='grey_graph_cell' id='MTD_graph1'><a href='#' onClick=\"DrawMTDGraph('OFFERED', '1'); return false;\">ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣOFFERED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph2'><a href='#' onClick=\"DrawMTDGraph('ΑΠΑΝΤΗΣΗED', '2'); return false;\">ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣΑΠΑΝΤΗΣΗED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph11'><a href='#' onClick=\"DrawMTDGraph('AGENTS', '11'); return false;\">TOTAL AGENTS ΑΠΑΝΤΗΣΗED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph3'><a href='#' onClick=\"DrawMTDGraph('ABANDONED', '3'); return false;\">ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣABANDONED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph4'><a href='#' onClick=\"DrawMTDGraph('ABANDONPCT', '4'); return false;\">TOTAL ABANDON PERCENT</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph5'><a href='#' onClick=\"DrawMTDGraph('AVGABANDONTIME', '5'); return false;\">AVG ABANDON TIME</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph6'><a href='#' onClick=\"DrawMTDGraph('AVGΑΠΑΝΤΗΣΗSPEED', '6'); return false;\">AVG ΑΠΑΝΤΗΣΗ SPEED</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph7'><a href='#' onClick=\"DrawMTDGraph('AVGTALKTIME', '7'); return false;\">AVG TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph8'><a href='#' onClick=\"DrawMTDGraph('TOTALTALKTIME', '8'); return false;\">TOTAL TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph9'><a href='#' onClick=\"DrawMTDGraph('TOTALWRAPTIME', '9'); return false;\">TOTAL WRAP TIME</a></th><th width='10%' class='grey_graph_cell' id='MTD_graph10'><a href='#' onClick=\"DrawMTDGraph('TOTALCALLTIME', '10'); return false;\">TOTAL CALL TIME</a></th></tr><tr><td colspan='11' class='graph_span_cell' align='center'><span id='MTD_stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
	$WTD_GRAPH="<BR><BR><a name='WTD_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800'><tr><th width='10%' class='grey_graph_cell' id='WTD_graph1'><a href='#' onClick=\"DrawWTDGraph('OFFERED', '1'); return false;\">ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣOFFERED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph2'><a href='#' onClick=\"DrawWTDGraph('ΑΠΑΝΤΗΣΗED', '2'); return false;\">ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣΑΠΑΝΤΗΣΗED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph11'><a href='#' onClick=\"DrawWTDGraph('AGENTS', '11'); return false;\">TOTAL AGENTS ΑΠΑΝΤΗΣΗED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph3'><a href='#' onClick=\"DrawWTDGraph('ABANDONED', '3'); return false;\">ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣABANDONED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph4'><a href='#' onClick=\"DrawWTDGraph('ABANDONPCT', '4'); return false;\">TOTAL ABANDON PERCENT</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph5'><a href='#' onClick=\"DrawWTDGraph('AVGABANDONTIME', '5'); return false;\">AVG ABANDON TIME</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph6'><a href='#' onClick=\"DrawWTDGraph('AVGΑΠΑΝΤΗΣΗSPEED', '6'); return false;\">AVG ΑΠΑΝΤΗΣΗ SPEED</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph7'><a href='#' onClick=\"DrawWTDGraph('AVGTALKTIME', '7'); return false;\">AVG TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph8'><a href='#' onClick=\"DrawWTDGraph('TOTALTALKTIME', '8'); return false;\">TOTAL TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph9'><a href='#' onClick=\"DrawWTDGraph('TOTALWRAPTIME', '9'); return false;\">TOTAL WRAP TIME</a></th><th width='10%' class='grey_graph_cell' id='WTD_graph10'><a href='#' onClick=\"DrawWTDGraph('TOTALCALLTIME', '10'); return false;\">TOTAL CALL TIME</a></th></tr><tr><td colspan='11' class='graph_span_cell' align='center'><span id='WTD_stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
	$QTD_GRAPH="<BR><BR><a name='QTD_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800'><tr><th width='10%' class='grey_graph_cell' id='QTD_graph1'><a href='#' onClick=\"DrawQTDGraph('OFFERED', '1'); return false;\">ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣOFFERED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph2'><a href='#' onClick=\"DrawQTDGraph('ΑΠΑΝΤΗΣΗED', '2'); return false;\">ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣΑΠΑΝΤΗΣΗED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph11'><a href='#' onClick=\"DrawQTDGraph('AGENTS', '11'); return false;\">TOTAL AGENTS ΑΠΑΝΤΗΣΗED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph3'><a href='#' onClick=\"DrawQTDGraph('ABANDONED', '3'); return false;\">ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣABANDONED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph4'><a href='#' onClick=\"DrawQTDGraph('ABANDONPCT', '4'); return false;\">TOTAL ABANDON PERCENT</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph5'><a href='#' onClick=\"DrawQTDGraph('AVGABANDONTIME', '5'); return false;\">AVG ABANDON TIME</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph6'><a href='#' onClick=\"DrawQTDGraph('AVGΑΠΑΝΤΗΣΗSPEED', '6'); return false;\">AVG ΑΠΑΝΤΗΣΗ SPEED</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph7'><a href='#' onClick=\"DrawQTDGraph('AVGTALKTIME', '7'); return false;\">AVG TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph8'><a href='#' onClick=\"DrawQTDGraph('TOTALTALKTIME', '8'); return false;\">TOTAL TALK TIME</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph9'><a href='#' onClick=\"DrawQTDGraph('TOTALWRAPTIME', '9'); return false;\">TOTAL WRAP TIME</a></th><th width='10%' class='grey_graph_cell' id='QTD_graph10'><a href='#' onClick=\"DrawQTDGraph('TOTALCALLTIME', '10'); return false;\">TOTAL CALL TIME</a></th></tr><tr><td colspan='11' class='graph_span_cell' align='center'><span id='QTD_stats_graph'><BR>&nbsp;<BR></span></td></tr></table><BR><BR>";
	...
	$OFFERED_graph=$graph_header."<th class='thgraph' scope='col'>ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣOFFERED</th></tr>";
	$ΑΠΑΝΤΗΣΗED_graph=$graph_header."<th class='thgraph' scope='col'>ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣΑΠΑΝΤΗΣΗED </th></tr>";
	$AGENTS_graph=$graph_header."<th class='thgraph' scope='col'>TOTAL AGENTS ΑΠΑΝΤΗΣΗED </th></tr>";
	$ABANDONED_graph=$graph_header."<th class='thgraph' scope='col'>ΣΥΝΟΛΙΚΕΣ ΚΛΗΣΕΙΣABANDONED</th></tr>";
	...
	$AVGΑΠΑΝΤΗΣΗSPEED_graph=$graph_header."<th class='thgraph' scope='col'>AVG ΑΠΑΝΤΗΣΗ SPEED</th></tr>";
	...
	$totΑΠΑΝΤΗΣΗSsecwtd=0;
	$totΑΠΑΝΤΗΣΗSspeedwtd=0;
	$totABANDONSwtd=0;
	$totABANDONSsecwtd=0;
	...
	$totΑΠΑΝΤΗΣΗSsecmtd=0;
	$totΑΠΑΝΤΗΣΗSspeedmtd=0;
	$totABANDONSmtd=0;
	$totABANDONSsecmtd=0;
	...
	$totΑΠΑΝΤΗΣΗSsecqtd=0;
	$totΑΠΑΝΤΗΣΗSspeedqtd=0;
	$totABANDONSqtd=0;
	$totABANDONSsecqtd=0;
	...
	while ($d < $TOTintervals)
		...
		$totΑΠΑΝΤΗΣΗSavgspeedTIME[$d] =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($totΑΠΑΝΤΗΣΗSspeeddate[$d], $totΑΠΑΝΤΗΣΗSdate[$d])))));
		$totΑΠΑΝΤΗΣΗSavgTIME[$d] =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($totΑΠΑΝΤΗΣΗSsecdate[$d], $totΑΠΑΝΤΗΣΗSdate[$d])))));
		if (round(MathZDC($totΑΠΑΝΤΗΣΗSspeeddate[$d], $totΑΠΑΝΤΗΣΗSdate[$d]))>$max_avganswerspeed) {$max_avganswerspeed=round(MathZDC($totΑΠΑΝΤΗΣΗSspeeddate[$d], $totΑΠΑΝΤΗΣΗSdate[$d]));}
		$graph_stats[$d][12]=round(MathZDC($totΑΠΑΝΤΗΣΗSspeeddate[$d], $totΑΠΑΝΤΗΣΗSdate[$d]));
		$graph_stats[$d][16]=round(MathZDC($totΑΠΑΝΤΗΣΗSsecdate[$d], $totΑΠΑΝΤΗΣΗSdate[$d]));

		$totΑΠΑΝΤΗΣΗStalkTIME[$d] =	sprintf("%10s", floor(MathZDC($totΑΠΑΝΤΗΣΗSsecdate[$d], 3600)).date(":i:s", mktime(0, 0, $totΑΠΑΝΤΗΣΗSsecdate[$d])));
		$totΑΠΑΝΤΗΣΗSwrapTIME[$d] =	sprintf("%10s", floor(MathZDC(($totΑΠΑΝΤΗΣΗSdate[$d]*15), 3600)).date(":i:s", mktime(0, 0, ($totΑΠΑΝΤΗΣΗSdate[$d]*15))));
		if (($totΑΠΑΝΤΗΣΗSdate[$d]*15)>$max_totalwraptime) {$max_totalwraptime=($totΑΠΑΝΤΗΣΗSdate[$d]*15);}
		$graph_stats[$d][13]=($totΑΠΑΝΤΗΣΗSdate[$d]*15);
		$graph_stats[$d][14]=($totΑΠΑΝΤΗΣΗSsecdate[$d]+($totΑΠΑΝΤΗΣΗSdate[$d]*15));
		$graph_stats[$d][15]=$totΑΠΑΝΤΗΣΗSsecdate[$d];

		$totΑΠΑΝΤΗΣΗStotTIME[$d] =	sprintf("%10s", floor(MathZDC(($totΑΠΑΝΤΗΣΗSsecdate[$d]+($totΑΠΑΝΤΗΣΗSdate[$d]*15)), 3600)).date(":i:s", mktime(0, 0, ($totΑΠΑΝΤΗΣΗSsecdate[$d]+($totΑΠΑΝΤΗΣΗSdate[$d]*15)))));
		$totΑΠΑΝΤΗΣΗSdate[$d] =	sprintf("%8s", $totΑΠΑΝΤΗΣΗSdate[$d]);
		...
		if (date("w", strtotime($daySTART[$d]))==0 && date("w", strtotime($daySTART[$d-1]))!=0 && $d>0) 
			...
			$totΑΠΑΝΤΗΣΗSavgspeedTIMEwtd =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($totΑΠΑΝΤΗΣΗSspeedwtd, $totΑΠΑΝΤΗΣΗSwtd)))));
			$totΑΠΑΝΤΗΣΗSavgTIMEwtd =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($totΑΠΑΝΤΗΣΗSsecwtd, $totΑΠΑΝΤΗΣΗSwtd)))));
			if (round(MathZDC($totΑΠΑΝΤΗΣΗSspeedwtd, $totΑΠΑΝΤΗΣΗSwtd))>$max_wtd_avganswerspeed) {$max_wtd_avganswerspeed=round(MathZDC($totΑΠΑΝΤΗΣΗSspeedwtd, $totΑΠΑΝΤΗΣΗSwtd));}
			$wtd_graph_stats[$wa][12]=round(MathZDC($totΑΠΑΝΤΗΣΗSspeedwtd, $totΑΠΑΝΤΗΣΗSwtd));
			$wtd_graph_stats[$wa][16]=round(MathZDC($totΑΠΑΝΤΗΣΗSsecwtd, $totΑΠΑΝΤΗΣΗSwtd));
			$totΑΠΑΝΤΗΣΗStalkTIMEwtd =	sprintf("%10s", floor(MathZDC($totΑΠΑΝΤΗΣΗSsecwtd, 3600)).date(":i:s", mktime(0, 0, $totΑΠΑΝΤΗΣΗSsecwtd)));
			$totΑΠΑΝΤΗΣΗSwrapTIMEwtd =	sprintf("%10s", floor(MathZDC(($totΑΠΑΝΤΗΣΗSwtd*15), 3600)).date(":i:s", mktime(0, 0, ($totΑΠΑΝΤΗΣΗSwtd*15))));
			if (($totΑΠΑΝΤΗΣΗSwtd*15)>$max_wtd_totalwraptime) {$max_wtd_totalwraptime=($totΑΠΑΝΤΗΣΗSwtd*15);}
			$wtd_graph_stats[$wa][13]=($totΑΠΑΝΤΗΣΗSwtd*15);
			$wtd_graph_stats[$wa][14]=($totΑΠΑΝΤΗΣΗSsecwtd+($totΑΠΑΝΤΗΣΗSwtd*15));
			$wtd_graph_stats[$wa][15]=$totΑΠΑΝΤΗΣΗSsecwtd;
			$totΑΠΑΝΤΗΣΗStotTIMEwtd =	sprintf("%10s", floor(MathZDC(($totΑΠΑΝΤΗΣΗSsecwtd+($totΑΠΑΝΤΗΣΗSwtd*15)), 3600)).date(":i:s", mktime(0, 0, ($totΑΠΑΝΤΗΣΗSsecwtd+($totΑΠΑΝΤΗΣΗSwtd*15)))));
			# $totAGENTSwtd =	sprintf("%8s", $totAGENTSwtd);
			$totAGENTSwtd=count(array_count_values($AGENTS_wtd_array));
			$totAGENTSwtd =	sprintf("%8s", $totAGENTSwtd);
			$totΑΠΑΝΤΗΣΗSwtd =	sprintf("%8s", $totΑΠΑΝΤΗΣΗSwtd);
			...
			if (trim($totΑΠΑΝΤΗΣΗSwtd)>$max_wtd_answered) {$max_wtd_answered=trim($totΑΠΑΝΤΗΣΗSwtd);}
			...
			if (round(MathZDC($totΑΠΑΝΤΗΣΗSsecwtd, $totΑΠΑΝΤΗΣΗSwtd))>$max_wtd_avgtalktime) {$max_wtd_avgtalktime=round(MathZDC($totΑΠΑΝΤΗΣΗSsecwtd, $totΑΠΑΝΤΗΣΗSwtd));}
			if (trim($totΑΠΑΝΤΗΣΗSsecwtd)>$max_wtd_totaltalktime) {$max_wtd_totaltalktime=trim($totΑΠΑΝΤΗΣΗSsecwtd);}
			if (trim($totΑΠΑΝΤΗΣΗSsecwtd+($totΑΠΑΝΤΗΣΗSwtd*15))>$max_wtd_totalcalltime) {$max_wtd_totalcalltime=trim($totΑΠΑΝΤΗΣΗSsecwtd+($totΑΠΑΝΤΗΣΗSwtd*15));}
			...
			$wtd_graph_stats[$wa][2]=trim($totΑΠΑΝΤΗΣΗSwtd);
			...
			$wtd_graph_stats[$wa][6]=trim($totΑΠΑΝΤΗΣΗSavgspeedTIMEwtd);
			$wtd_graph_stats[$wa][7]=trim($totΑΠΑΝΤΗΣΗSavgTIMEwtd);
			$wtd_graph_stats[$wa][8]=trim($totΑΠΑΝΤΗΣΗStalkTIMEwtd);
			$wtd_graph_stats[$wa][9]=trim($totΑΠΑΝΤΗΣΗSwrapTIMEwtd);
			$wtd_graph_stats[$wa][10]=trim($totΑΠΑΝΤΗΣΗStotTIMEwtd);
			$wtd_graph_stats[$wa][17]=trim($totAGENTSwtd);
			$wa++;

			$ASCII_text.="$MAINH\n";
			$ASCII_text.="|                                       WTD | $totCALLSwtd | $totΑΠΑΝΤΗΣΗSwtd | $totAGENTSwtd | $totABANDONSwtd | $totABANDONSpctwtd%| $totABANDONSavgTIMEwtd | $totΑΠΑΝΤΗΣΗSavgspeedTIMEwtd | $totΑΠΑΝΤΗΣΗSavgTIMEwtd | $totΑΠΑΝΤΗΣΗStalkTIMEwtd | $totΑΠΑΝΤΗΣΗSwrapTIMEwtd | $totΑΠΑΝΤΗΣΗStotTIMEwtd |";
			$CSV_text.="\"WTD\",\"$totCALLSwtd\",\"$totΑΠΑΝΤΗΣΗSwtd\",\"$totAGENTSwtd\",\"$totABANDONSwtd\",\"$totABANDONSpctwtd%\",\"$totABANDONSavgTIMEwtd\",\"$totΑΠΑΝΤΗΣΗSavgspeedTIMEwtd\",\"$totΑΠΑΝΤΗΣΗSavgTIMEwtd\",\"$totΑΠΑΝΤΗΣΗStalkTIMEwtd\",\"$totΑΠΑΝΤΗΣΗSwrapTIMEwtd\",\"$totΑΠΑΝΤΗΣΗStotTIMEwtd\"";
			for ($s=0; $s<count($status_array); $s++) {
		...
		if (date("d", strtotime($daySTART[$d]))==1 && $d>0 && date("d", strtotime($daySTART[$d-1]))!=1) 
			...
			$totΑΠΑΝΤΗΣΗSavgspeedTIMEmtd =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($totΑΠΑΝΤΗΣΗSspeedmtd, $totΑΠΑΝΤΗΣΗSmtd)))));
			$totΑΠΑΝΤΗΣΗSavgTIMEmtd =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($totΑΠΑΝΤΗΣΗSsecmtd, $totΑΠΑΝΤΗΣΗSmtd)))));
			if (round(MathZDC($totΑΠΑΝΤΗΣΗSspeedmtd, $totΑΠΑΝΤΗΣΗSmtd))>$max_mtd_avganswerspeed) {$max_mtd_avganswerspeed=round(MathZDC($totΑΠΑΝΤΗΣΗSspeedmtd, $totΑΠΑΝΤΗΣΗSmtd));}
			$mtd_graph_stats[$ma][12]=round(MathZDC($totΑΠΑΝΤΗΣΗSspeedmtd, $totΑΠΑΝΤΗΣΗSmtd));
			$mtd_graph_stats[$ma][16]=round(MathZDC($totΑΠΑΝΤΗΣΗSsecmtd, $totΑΠΑΝΤΗΣΗSmtd));
			$totΑΠΑΝΤΗΣΗStalkTIMEmtd =	sprintf("%10s", floor(MathZDC($totΑΠΑΝΤΗΣΗSsecmtd, 3600)).date(":i:s", mktime(0, 0, $totΑΠΑΝΤΗΣΗSsecmtd)));
			$totΑΠΑΝΤΗΣΗSwrapTIMEmtd =	sprintf("%10s", floor(MathZDC(($totΑΠΑΝΤΗΣΗSmtd*15), 3600)).date(":i:s", mktime(0, 0, ($totΑΠΑΝΤΗΣΗSmtd*15))));
			if (($totΑΠΑΝΤΗΣΗSmtd*15)>$max_mtd_totalwraptime) {$max_mtd_totalwraptime=($totΑΠΑΝΤΗΣΗSmtd*15);}
			$mtd_graph_stats[$ma][13]=($totΑΠΑΝΤΗΣΗSmtd*15);
			$mtd_graph_stats[$ma][14]=($totΑΠΑΝΤΗΣΗSsecmtd+($totΑΠΑΝΤΗΣΗSmtd*15));
			$mtd_graph_stats[$ma][15]=$totΑΠΑΝΤΗΣΗSsecmtd;
			$totΑΠΑΝΤΗΣΗStotTIMEmtd =	sprintf("%10s", floor(MathZDC(($totΑΠΑΝΤΗΣΗSsecmtd+($totΑΠΑΝΤΗΣΗSmtd*15)), 3600)).date(":i:s", mktime(0, 0, ($totΑΠΑΝΤΗΣΗSsecmtd+($totΑΠΑΝΤΗΣΗSmtd*15)))));
			$totAGENTSmtd=count(array_count_values($AGENTS_mtd_array));
			$totAGENTSmtd =	sprintf("%8s", $totAGENTSmtd);
			$totΑΠΑΝΤΗΣΗSmtd =	sprintf("%8s", $totΑΠΑΝΤΗΣΗSmtd);
			...
			if (trim($totΑΠΑΝΤΗΣΗSmtd)>$max_mtd_answered) {$max_mtd_answered=trim($totΑΠΑΝΤΗΣΗSmtd);}
			...
			if (round(MathZDC($totΑΠΑΝΤΗΣΗSsecmtd, $totΑΠΑΝΤΗΣΗSmtd))>$max_mtd_avgtalktime) {$max_mtd_avgtalktime=round(MathZDC($totΑΠΑΝΤΗΣΗSsecmtd, $totΑΠΑΝΤΗΣΗSmtd));}
			if (trim($totΑΠΑΝΤΗΣΗSsecmtd)>$max_mtd_totaltalktime) {$max_mtd_totaltalktime=trim($totΑΠΑΝΤΗΣΗSsecmtd);}
			if (trim($totΑΠΑΝΤΗΣΗSsecmtd+($totΑΠΑΝΤΗΣΗSmtd*15))>$max_mtd_totalcalltime) {$max_mtd_totalcalltime=trim($totΑΠΑΝΤΗΣΗSsecmtd+($totΑΠΑΝΤΗΣΗSmtd*15));}
			$month=date("F", strtotime($dayEND[$d-1]));
			$year=substr($dayEND[$d-1], 0, 4);
			$mtd_graph_stats[$ma][0]="$month $year";
			$mtd_graph_stats[$ma][1]=trim($totCALLSmtd);
			$mtd_graph_stats[$ma][2]=trim($totΑΠΑΝΤΗΣΗSmtd);
			...
			$mtd_graph_stats[$ma][6]=trim($totΑΠΑΝΤΗΣΗSavgspeedTIMEmtd);
			$mtd_graph_stats[$ma][7]=trim($totΑΠΑΝΤΗΣΗSavgTIMEmtd);
			$mtd_graph_stats[$ma][8]=trim($totΑΠΑΝΤΗΣΗStalkTIMEmtd);
			$mtd_graph_stats[$ma][9]=trim($totΑΠΑΝΤΗΣΗSwrapTIMEmtd);
			$mtd_graph_stats[$ma][10]=trim($totΑΠΑΝΤΗΣΗStotTIMEmtd);
			$mtd_graph_stats[$ma][17]=trim($totAGENTSmtd);
			$ma++;

			$ASCII_text.="$MAINH\n";
			$ASCII_text.="|                                       MTD | $totCALLSmtd | $totΑΠΑΝΤΗΣΗSmtd | $totAGENTSmtd | $totABANDONSmtd | $totABANDONSpctmtd%| $totABANDONSavgTIMEmtd | $totΑΠΑΝΤΗΣΗSavgspeedTIMEmtd | $totΑΠΑΝΤΗΣΗSavgTIMEmtd | $totΑΠΑΝΤΗΣΗStalkTIMEmtd | $totΑΠΑΝΤΗΣΗSwrapTIMEmtd | $totΑΠΑΝΤΗΣΗStotTIMEmtd |";
			$CSV_text.="\"MTD\",\"$totCALLSmtd\",\"$totΑΠΑΝΤΗΣΗSmtd\",\"$totAGENTSmtd\",\"$totABANDONSmtd\",\"$totABANDONSpctmtd%\",\"$totABANDONSavgTIMEmtd\",\"$totΑΠΑΝΤΗΣΗSavgspeedTIMEmtd\",\"$totΑΠΑΝΤΗΣΗSavgTIMEmtd\",\"$totΑΠΑΝΤΗΣΗStalkTIMEmtd\",\"$totΑΠΑΝΤΗΣΗSwrapTIMEmtd\",\"$totΑΠΑΝΤΗΣΗStotTIMEmtd\"";
			for ($s=0; $s<count($status_array); $s++) {
			...
			if (date("m", strtotime($daySTART[$d]))==1 || date("m", strtotime($daySTART[$d]))==4 || date("m", strtotime($daySTART[$d]))==7 || date("m", strtotime($daySTART[$d]))==10) # Quarterly line
				...
				$totΑΠΑΝΤΗΣΗSavgspeedTIMEqtd =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($totΑΠΑΝΤΗΣΗSspeedqtd, $totΑΠΑΝΤΗΣΗSqtd)))));
				$totΑΠΑΝΤΗΣΗSavgTIMEqtd =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($totΑΠΑΝΤΗΣΗSsecqtd, $totΑΠΑΝΤΗΣΗSqtd)))));
				if (round(MathZDC($totΑΠΑΝΤΗΣΗSspeedqtd, $totΑΠΑΝΤΗΣΗSqtd))>$max_qtd_avganswerspeed) {$max_qtd_avganswerspeed=round(MathZDC($totΑΠΑΝΤΗΣΗSspeedqtd, $totΑΠΑΝΤΗΣΗSqtd));}
				$qtd_graph_stats[$qa][12]=round(MathZDC($totΑΠΑΝΤΗΣΗSspeedqtd, $totΑΠΑΝΤΗΣΗSqtd));
				$qtd_graph_stats[$qa][16]=round(MathZDC($totΑΠΑΝΤΗΣΗSsecqtd, $totΑΠΑΝΤΗΣΗSqtd));
				$totΑΠΑΝΤΗΣΗStalkTIMEqtd =	sprintf("%10s", floor(MathZDC($totΑΠΑΝΤΗΣΗSsecqtd, 3600)).date(":i:s", mktime(0, 0, $totΑΠΑΝΤΗΣΗSsecqtd)));
				$totΑΠΑΝΤΗΣΗSwrapTIMEqtd =	sprintf("%10s", floor(MathZDC(($totΑΠΑΝΤΗΣΗSqtd*15), 3600)).date(":i:s", mktime(0, 0, ($totΑΠΑΝΤΗΣΗSqtd*15))));
				if (($totΑΠΑΝΤΗΣΗSqtd*15)>$max_qtd_totalwraptime) {$max_qtd_totalwraptime=($totΑΠΑΝΤΗΣΗSqtd*15);}
				$qtd_graph_stats[$qa][13]=($totΑΠΑΝΤΗΣΗSqtd*15);
				$qtd_graph_stats[$qa][14]=($totΑΠΑΝΤΗΣΗSsecqtd+($totΑΠΑΝΤΗΣΗSqtd*15));
				$qtd_graph_stats[$qa][15]=$totΑΠΑΝΤΗΣΗSsecqtd;
				$totΑΠΑΝΤΗΣΗStotTIMEqtd =	sprintf("%10s", floor(MathZDC(($totΑΠΑΝΤΗΣΗSsecqtd+($totΑΠΑΝΤΗΣΗSqtd*15)), 3600)).date(":i:s", mktime(0, 0, ($totΑΠΑΝΤΗΣΗSsecqtd+($totΑΠΑΝΤΗΣΗSqtd*15)))));
				$totAGENTSqtd=count(array_count_values($AGENTS_qtd_array));
				$totAGENTSqtd =	sprintf("%8s", $totAGENTSqtd);
				$totΑΠΑΝΤΗΣΗSqtd =	sprintf("%8s", $totΑΠΑΝΤΗΣΗSqtd);
				...
				if (trim($totΑΠΑΝΤΗΣΗSqtd)>$max_qtd_answered) {$max_qtd_answered=trim($totΑΠΑΝΤΗΣΗSqtd);}
				...
				if (round(MathZDC($totΑΠΑΝΤΗΣΗSsecqtd, $totΑΠΑΝΤΗΣΗSqtd))>$max_qtd_avgtalktime) {$max_qtd_avgtalktime=round(MathZDC($totΑΠΑΝΤΗΣΗSsecqtd, $totΑΠΑΝΤΗΣΗSqtd));}
				if (trim($totΑΠΑΝΤΗΣΗSsecqtd)>$max_qtd_totaltalktime) {$max_qtd_totaltalktime=trim($totΑΠΑΝΤΗΣΗSsecqtd);}
				if (trim($totΑΠΑΝΤΗΣΗSsecqtd+($totΑΠΑΝΤΗΣΗSqtd*15))>$max_qtd_totalcalltime) {$max_qtd_totalcalltime=trim($totΑΠΑΝΤΗΣΗSsecqtd+($totΑΠΑΝΤΗΣΗSqtd*15));}
				...
				$qtd_graph_stats[$qa][2]=trim($totΑΠΑΝΤΗΣΗSqtd);
				...
				$qtd_graph_stats[$qa][6]=trim($totΑΠΑΝΤΗΣΗSavgspeedTIMEqtd);
				$qtd_graph_stats[$qa][7]=trim($totΑΠΑΝΤΗΣΗSavgTIMEqtd);
				$qtd_graph_stats[$qa][8]=trim($totΑΠΑΝΤΗΣΗStalkTIMEqtd);
				$qtd_graph_stats[$qa][9]=trim($totΑΠΑΝΤΗΣΗSwrapTIMEqtd);
				$qtd_graph_stats[$qa][10]=trim($totΑΠΑΝΤΗΣΗStotTIMEqtd);
				$qtd_graph_stats[$qa][17]=trim($totAGENTSqtd);
				$qa++;

				$ASCII_text.="|                                       QTD | $totCALLSqtd | $totΑΠΑΝΤΗΣΗSqtd | $totAGENTSqtd | $totABANDONSqtd | $totABANDONSpctqtd%| $totABANDONSavgTIMEqtd | $totΑΠΑΝΤΗΣΗSavgspeedTIMEqtd | $totΑΠΑΝΤΗΣΗSavgTIMEqtd | $totΑΠΑΝΤΗΣΗStalkTIMEqtd | $totΑΠΑΝΤΗΣΗSwrapTIMEqtd | $totΑΠΑΝΤΗΣΗStotTIMEqtd |";
				$CSV_text.="\"QTD\",\"$totCALLSqtd\",\"$totΑΠΑΝΤΗΣΗSqtd\",\"$totAGENTSqtd\",\"$totABANDONSqtd\",\"$totABANDONSpctqtd%\",\"$totABANDONSavgTIMEqtd\",\"$totΑΠΑΝΤΗΣΗSavgspeedTIMEqtd\",\"$totΑΠΑΝΤΗΣΗSavgTIMEqtd\",\"$totΑΠΑΝΤΗΣΗStalkTIMEqtd\",\"$totΑΠΑΝΤΗΣΗSwrapTIMEqtd\",\"$totΑΠΑΝΤΗΣΗStotTIMEqtd\"";
				for ($s=0; $s<count($status_array); $s++) {
		...
		$totΑΠΑΝΤΗΣΗSwtd+=$totΑΠΑΝΤΗΣΗSdate[$d];
		$totΑΠΑΝΤΗΣΗSsecwtd+=$totΑΠΑΝΤΗΣΗSsecdate[$d];
		$totΑΠΑΝΤΗΣΗSspeedwtd+=$totΑΠΑΝΤΗΣΗSspeeddate[$d];
		$totABANDONSwtd+=$totABANDONSdate[$d];
		$totABANDONSsecwtd+=$totABANDONSsecdate[$d];
		$totCALLSmtd+=$totCALLSdate[$d];
		$totΑΠΑΝΤΗΣΗSmtd+=$totΑΠΑΝΤΗΣΗSdate[$d];
		$totΑΠΑΝΤΗΣΗSsecmtd+=$totΑΠΑΝΤΗΣΗSsecdate[$d];
		$totΑΠΑΝΤΗΣΗSspeedmtd+=$totΑΠΑΝΤΗΣΗSspeeddate[$d];
		$totABANDONSmtd+=$totABANDONSdate[$d];
		$totABANDONSsecmtd+=$totABANDONSsecdate[$d];
		$totCALLSqtd+=$totCALLSdate[$d];
		$totΑΠΑΝΤΗΣΗSqtd+=$totΑΠΑΝΤΗΣΗSdate[$d];
		$totΑΠΑΝΤΗΣΗSsecqtd+=$totΑΠΑΝΤΗΣΗSsecdate[$d];
		$totΑΠΑΝΤΗΣΗSspeedqtd+=$totΑΠΑΝΤΗΣΗSspeeddate[$d];
		...
		if (trim($totΑΠΑΝΤΗΣΗSdate[$d])>$max_answered) {$max_answered=trim($totΑΠΑΝΤΗΣΗSdate[$d]);}
		...
		if (round(MathZDC($totΑΠΑΝΤΗΣΗSsecdate[$d], $totΑΠΑΝΤΗΣΗSdate[$d]))>$max_avgtalktime) 
			{$max_avgtalktime=round(MathZDC($totΑΠΑΝΤΗΣΗSsecdate[$d], $totΑΠΑΝΤΗΣΗSdate[$d]));}

		if (trim($totΑΠΑΝΤΗΣΗSsecdate[$d])>$max_totaltalktime) {$max_totaltalktime=trim($totΑΠΑΝΤΗΣΗSsecdate[$d]);}
		if (trim($totΑΠΑΝΤΗΣΗSsecdate[$d]+($totΑΠΑΝΤΗΣΗSdate[$d]*15))>$max_totalcalltime) {$max_totalcalltime=trim($totΑΠΑΝΤΗΣΗSsecdate[$d]+($totΑΠΑΝΤΗΣΗSdate[$d]*15));}
		$graph_stats[$d][0]="$daySTART[$d] - $dayEND[$d]";
		$graph_stats[$d][1]=trim($totCALLSdate[$d]);
		$graph_stats[$d][2]=trim($totΑΠΑΝΤΗΣΗSdate[$d]);
		$graph_stats[$d][3]=trim($totABANDONSdate[$d]);
		$graph_stats[$d][4]=trim($totABANDONSpctDATE[$d]);
		$graph_stats[$d][5]=trim($totABANDONSavgTIME[$d]);
		$graph_stats[$d][6]=trim($totΑΠΑΝΤΗΣΗSavgspeedTIME[$d]);
		$graph_stats[$d][7]=trim($totΑΠΑΝΤΗΣΗSavgTIME[$d]);
		$graph_stats[$d][8]=trim($totΑΠΑΝΤΗΣΗStalkTIME[$d]);
		$graph_stats[$d][9]=trim($totΑΠΑΝΤΗΣΗSwrapTIME[$d]);
		$graph_stats[$d][10]=trim($totΑΠΑΝΤΗΣΗStotTIME[$d]);
		$graph_stats[$d][17]=trim($totAGENTSday);

		$ASCII_text.="| $daySTART[$d] - $dayEND[$d] | $totCALLSdate[$d] | $totΑΠΑΝΤΗΣΗSdate[$d] | $totAGENTSday | $totABANDONSdate[$d] | $totABANDONSpctDATE[$d]%| $totABANDONSavgTIME[$d] | $totΑΠΑΝΤΗΣΗSavgspeedTIME[$d] | $totΑΠΑΝΤΗΣΗSavgTIME[$d] | $totΑΠΑΝΤΗΣΗStalkTIME[$d] | $totΑΠΑΝΤΗΣΗSwrapTIME[$d] | $totΑΠΑΝΤΗΣΗStotTIME[$d] |";
		$CSV_text.="\"$daySTART[$d] - $dayEND[$d]\",\"$totCALLSdate[$d]\",\"$totΑΠΑΝΤΗΣΗSdate[$d]\",\"$totAGENTSday\",\"$totABANDONSdate[$d]\",\"$totABANDONSpctDATE[$d]%\",\"$totABANDONSavgTIME[$d]\",\"$totΑΠΑΝΤΗΣΗSavgspeedTIME[$d]\",\"$totΑΠΑΝΤΗΣΗSavgTIME[$d]\",\"$totΑΠΑΝΤΗΣΗStalkTIME[$d]\",\"$totΑΠΑΝΤΗΣΗSwrapTIME[$d]\",\"$totΑΠΑΝΤΗΣΗStotTIME[$d]\"";
		for ($s=0; $s<count($status_array); $s++) {
	...
	$totTIME_MS =		sprintf("%9s", $totTIME_MS);
		...
		$FtotΑΠΑΝΤΗΣΗSavgspeedTIME =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($FtotΑΠΑΝΤΗΣΗSspeed, $FtotΑΠΑΝΤΗΣΗS)))));
		$FtotΑΠΑΝΤΗΣΗSavgTIME =	sprintf("%6s", date("i:s", mktime(0, 0, round(MathZDC($FtotΑΠΑΝΤΗΣΗSsec, $FtotΑΠΑΝΤΗΣΗS)))));
		$FtotΑΠΑΝΤΗΣΗStalkTIME =	sprintf("%10s", floor(MathZDC($FtotΑΠΑΝΤΗΣΗSsec, 3600)).date(":i:s", mktime(0, 0, $FtotΑΠΑΝΤΗΣΗSsec)));
		$FtotΑΠΑΝΤΗΣΗSwrapTIME =	sprintf("%10s", floor(MathZDC(($FtotΑΠΑΝΤΗΣΗS*15), 3600)).date(":i:s", mktime(0, 0, ($FtotΑΠΑΝΤΗΣΗS*15))));
		$FtotΑΠΑΝΤΗΣΗStotTIME =	sprintf("%10s", floor(MathZDC(($FtotΑΠΑΝΤΗΣΗSsec+($FtotΑΠΑΝΤΗΣΗS*15)), 3600)).date(":i:s", mktime(0, 0, ($FtotΑΠΑΝΤΗΣΗSsec+($FtotΑΠΑΝΤΗΣΗS*15)))));
		$FtotΑΠΑΝΤΗΣΗS =	sprintf("%8s", $FtotΑΠΑΝΤΗΣΗS);
		...
		if (date("w", strtotime($daySTART[$d]))>0) 
			...
			if (trim($totΑΠΑΝΤΗΣΗSavgTIMEwtd)>$max_wtd_avgtalktime) {$max_wtd_avgtalktime=trim($totΑΠΑΝΤΗΣΗSavgTIMEwtd);}
			if (trim($totΑΠΑΝΤΗΣΗSsecwtd)>$max_wtd_totaltalktime) {$max_wtd_totaltalktime=trim($totΑΠΑΝΤΗΣΗSsecwtd);}
			if (trim($totΑΠΑΝΤΗΣΗSsecwtd+($totΑΠΑΝΤΗΣΗSwtd*15))>$max_wtd_totalcalltime) {$max_wtd_totalcalltime=trim($totΑΠΑΝΤΗΣΗSsecwtd+($totΑΠΑΝΤΗΣΗSwtd*15));}
			...
			$wtd_ΑΠΑΝΤΗΣΗED_graph=preg_replace('/DAILY/', 'WEEK-TO-DATE',$ΑΠΑΝΤΗΣΗED_graph);
			...
			$wtd_AVGΑΠΑΝΤΗΣΗSPEED_graph=preg_replace('/DAILY/', 'WEEK-TO-DATE',$AVGΑΠΑΝΤΗΣΗSPEED_graph);
			...
			for ($q=0; $q<count($wtd_graph_stats); $q++) {
				...
				$wtd_ΑΠΑΝΤΗΣΗED_graph.="  <tr><td class='chart_td$class'>".$wtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$wtd_graph_stats[$q][2], $max_wtd_answered))."' height='16' />".$wtd_graph_stats[$q][2]."</td></tr>";
				...
				$wtd_AVGΑΠΑΝΤΗΣΗSPEED_graph.="  <tr><td class='chart_td$class'>".$wtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$wtd_graph_stats[$q][12], $max_wtd_avganswerspeed))."' height='16' />".$wtd_graph_stats[$q][6]."</td></tr>";
		...
		if (date("d", strtotime($daySTART[$d]))!=1) 
			...
			if (round(MathZDC($totΑΠΑΝΤΗΣΗSsecmtd, $totΑΠΑΝΤΗΣΗSmtd))>$max_mtd_avgtalktime)
				{$max_mtd_avgtalktime=round(MathZDC($totΑΠΑΝΤΗΣΗSsecmtd, $totΑΠΑΝΤΗΣΗSmtd));}
			...
			$mtd_ΑΠΑΝΤΗΣΗED_graph=preg_replace('/DAILY/', 'MONTH-TO-DATE',$ΑΠΑΝΤΗΣΗED_graph);
			...
			$mtd_AVGΑΠΑΝΤΗΣΗSPEED_graph=preg_replace('/DAILY/', 'MONTH-TO-DATE',$AVGΑΠΑΝΤΗΣΗSPEED_graph);
			...
			for ($q=0; $q<count($mtd_graph_stats); $q++) {
				...
				$mtd_ΑΠΑΝΤΗΣΗED_graph.="  <tr><td class='chart_td$class'>".$mtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$mtd_graph_stats[$q][2], $max_mtd_answered))."' height='16' />".$mtd_graph_stats[$q][2]."</td></tr>";
				...
				$mtd_AVGΑΠΑΝΤΗΣΗSPEED_graph.="  <tr><td class='chart_td$class'>".$mtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$mtd_graph_stats[$q][12], $max_mtd_avganswerspeed))."' height='16' />".$mtd_graph_stats[$q][6]."</td></tr>";
				...
				$graph_totΑΠΑΝΤΗΣΗSmtd+=$mtd_graph_stats[$q][2];
				...
				$graph_totΑΠΑΝΤΗΣΗSavgspeedTIMEmtd+=$mtd_graph_stats[$q][6];
				$graph_totΑΠΑΝΤΗΣΗSavgTIMEmtd+=$mtd_graph_stats[$q][7];
				$graph_totΑΠΑΝΤΗΣΗStalkTIMEmtd+=$mtd_graph_stats[$q][8];
				$graph_totΑΠΑΝΤΗΣΗSwrapTIMEmtd+=$mtd_graph_stats[$q][9];
				$graph_totΑΠΑΝΤΗΣΗStotTIMEmtd+=$mtd_graph_stats[$q][10];
			}			
	...
	#			{
			...
			if ( (round(MathZDC($totΑΠΑΝΤΗΣΗSsecqtd, $totΑΠΑΝΤΗΣΗSqtd))>$max_qtd_avgtalktime) )
				{$max_qtd_avgtalktime=round(MathZDC($totΑΠΑΝΤΗΣΗSsecqtd, $totΑΠΑΝΤΗΣΗSqtd));}
			...
			$qtd_ΑΠΑΝΤΗΣΗED_graph=preg_replace('/DAILY/', 'QUARTER-TO-DATE',$ΑΠΑΝΤΗΣΗED_graph);
			...
			$qtd_AVGΑΠΑΝΤΗΣΗSPEED_graph=preg_replace('/DAILY/', 'QUARTER-TO-DATE',$AVGΑΠΑΝΤΗΣΗSPEED_graph);
			...
			for ($q=0; $q<count($qtd_graph_stats); $q++) {
				...
				$qtd_ΑΠΑΝΤΗΣΗED_graph.="  <tr><td class='chart_td$class'>".$qtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$qtd_graph_stats[$q][2], $max_qtd_answered))."' height='16' />".$qtd_graph_stats[$q][2]."</td></tr>";
				...
				$qtd_AVGΑΠΑΝΤΗΣΗSPEED_graph.="  <tr><td class='chart_td$class'>".$qtd_graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$qtd_graph_stats[$q][12], $max_qtd_avganswerspeed))."' height='16' />".$qtd_graph_stats[$q][6]."</td></tr>";
				...
				$graph_totΑΠΑΝΤΗΣΗSqtd+=$qtd_graph_stats[$q][2];
				...
				$graph_totΑΠΑΝΤΗΣΗSavgspeedTIMEqtd+=$qtd_graph_stats[$q][6];
				$graph_totΑΠΑΝΤΗΣΗSavgTIMEqtd+=$qtd_graph_stats[$q][7];
				$graph_totΑΠΑΝΤΗΣΗStalkTIMEqtd+=$qtd_graph_stats[$q][8];
				$graph_totΑΠΑΝΤΗΣΗSwrapTIMEqtd+=$qtd_graph_stats[$q][9];
				$graph_totΑΠΑΝΤΗΣΗStotTIMEqtd+=$qtd_graph_stats[$q][10];
			}
	...
	#			}
			...
			for ($q=0; $q<count($graph_stats); $q++) {
				...
				$ΑΠΑΝΤΗΣΗED_graph.="  <tr><td class='chart_td$class'>".$graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$graph_stats[$q][2], $max_answered))."' height='16' />".$graph_stats[$q][2]."</td></tr>";
				...
				$AVGΑΠΑΝΤΗΣΗSPEED_graph.="  <tr><td class='chart_td$class'>".$graph_stats[$q][0]."</td><td nowrap class='chart_td value$class'><img src='../vicidial/images/bar.png' alt='' width='".round(MathZDC(400*$graph_stats[$q][12], $max_avganswerspeed))."' height='16' />".$graph_stats[$q][6]."</td></tr>";
			...
			$ΑΠΑΝΤΗΣΗED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗS)."</th></tr></table>";
			...
			$AVGΑΠΑΝΤΗΣΗSPEED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗSavgspeedTIME)."</th></tr></table>";
			$AVGTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗSavgTIME)."</th></tr></table>";
			$TOTALTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗStalkTIME)."</th></tr></table>";
			$TOTALWRAPTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗSwrapTIME)."</th></tr></table>";
			$TOTALCALLTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗStotTIME)."</th></tr></table>";
			$JS_onload.="\tDrawGraph('OFFERED', '1');\n"; 
			$JS_text.="function DrawGraph(graph, th_id) {\n";
			$JS_text.="	var OFFERED_graph=\"$OFFERED_graph\";\n";
			$JS_text.="	var ΑΠΑΝΤΗΣΗED_graph=\"$ΑΠΑΝΤΗΣΗED_graph\";\n";
			...
			$JS_text.="	var AVGΑΠΑΝΤΗΣΗSPEED_graph=\"$AVGΑΠΑΝΤΗΣΗSPEED_graph\";\n";
			...
			$wtd_ΑΠΑΝΤΗΣΗED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗS)."</th></tr></table>";
			...
			$wtd_AVGΑΠΑΝΤΗΣΗSPEED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗSavgspeedTIME)."</th></tr></table>";
			$wtd_AVGTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗSavgTIME)."</th></tr></table>";
			$wtd_TOTALTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗStalkTIME)."</th></tr></table>";
			$wtd_TOTALWRAPTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗSwrapTIME)."</th></tr></table>";
			$wtd_TOTALCALLTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗStotTIME)."</th></tr></table>";
			$JS_onload.="\tDrawWTDGraph('OFFERED', '1');\n"; 
			$JS_text.="function DrawWTDGraph(graph, th_id) {\n";
			$JS_text.="	var OFFERED_graph=\"$wtd_OFFERED_graph\";\n";
			$JS_text.="	var ΑΠΑΝΤΗΣΗED_graph=\"$wtd_ΑΠΑΝΤΗΣΗED_graph\";\n";
			...
			$JS_text.="	var AVGΑΠΑΝΤΗΣΗSPEED_graph=\"$wtd_AVGΑΠΑΝΤΗΣΗSPEED_graph\";\n";
			...
			$mtd_ΑΠΑΝΤΗΣΗED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗS)."</th></tr></table>";
			...
			$mtd_AVGΑΠΑΝΤΗΣΗSPEED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗSavgspeedTIME)."</th></tr></table>";
			$mtd_AVGTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗSavgTIME)."</th></tr></table>";
			$mtd_TOTALTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗStalkTIME)."</th></tr></table>";
			$mtd_TOTALWRAPTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗSwrapTIME)."</th></tr></table>";
			$mtd_TOTALCALLTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗStotTIME)."</th></tr></table>";
			$JS_onload.="\tDrawMTDGraph('OFFERED', '1');\n"; 
			$JS_text.="function DrawMTDGraph(graph, th_id) {\n";
			$JS_text.="	var OFFERED_graph=\"$mtd_OFFERED_graph\";\n";
			$JS_text.="	var ΑΠΑΝΤΗΣΗED_graph=\"$mtd_ΑΠΑΝΤΗΣΗED_graph\";\n";
			...
			$JS_text.="	var AVGΑΠΑΝΤΗΣΗSPEED_graph=\"$mtd_AVGΑΠΑΝΤΗΣΗSPEED_graph\";\n";
			...
			$qtd_ΑΠΑΝΤΗΣΗED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗS)."</th></tr></table>";
			...
			$qtd_AVGΑΠΑΝΤΗΣΗSPEED_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗSavgspeedTIME)."</th></tr></table>";
			$qtd_AVGTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗSavgTIME)."</th></tr></table>";
			$qtd_TOTALTALKTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗStalkTIME)."</th></tr></table>";
			$qtd_TOTALWRAPTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗSwrapTIME)."</th></tr></table>";
			$qtd_TOTALCALLTIME_graph.="<tr><th class='thgraph' scope='col'>TOTAL:</th><th class='thgraph' scope='col'>".trim($FtotΑΠΑΝΤΗΣΗStotTIME)."</th></tr></table>";
			$JS_onload.="\tDrawQTDGraph('OFFERED', '1');\n"; 
			$JS_text.="function DrawQTDGraph(graph, th_id) {\n";
			$JS_text.="	var OFFERED_graph=\"$qtd_OFFERED_graph\";\n";
			$JS_text.="	var ΑΠΑΝΤΗΣΗED_graph=\"$qtd_ΑΠΑΝΤΗΣΗED_graph\";\n";
			...
			$JS_text.="	var AVGΑΠΑΝΤΗΣΗSPEED_graph=\"$qtd_AVGΑΠΑΝΤΗΣΗSPEED_graph\";\n";
	...
	$ASCII_text.="$MAINH\n";
	$ASCII_text.="|                                    TOTALS | $FtotCALLS | $FtotΑΠΑΝΤΗΣΗS | $FtotAGENTS | $FtotABANDONS | $FtotABANDONSpct%| $FtotABANDONSavgTIME | $FtotΑΠΑΝΤΗΣΗSavgspeedTIME | $FtotΑΠΑΝΤΗΣΗSavgTIME | $FtotΑΠΑΝΤΗΣΗStalkTIME | $FtotΑΠΑΝΤΗΣΗSwrapTIME | $FtotΑΠΑΝΤΗΣΗStotTIME |";
	$CSV_text.="\"TOTALS\",\"$FtotCALLS\",\"$FtotΑΠΑΝΤΗΣΗS\",\"$FtotAGENTS\",\"$FtotABANDONS\",\"$FtotABANDONSpct%\",\"$FtotABANDONSavgTIME\",\"$FtotΑΠΑΝΤΗΣΗSavgspeedTIME\",\"$FtotΑΠΑΝΤΗΣΗSavgTIME\",\"$FtotΑΠΑΝΤΗΣΗStalkTIME\",\"$FtotΑΠΑΝΤΗΣΗSwrapTIME\",\"$FtotΑΠΑΝΤΗΣΗStotTIME\"";
	for ($s=0; $s<count($status_array); $s++) {
