...
if ( (!preg_match("/\|$ip\|/", $server_ips)) and ($formIPvalid < 1) )
	...
	if( (strlen($PHP_AUTH_USER)<2) or (strlen($PHP_AUTH_PW)<2) or (!$auth))
		...
		echo "Ακυρο Ονομα Χρήστη/Κωδικός Πρόσβασης: |$PHP_AUTH_USER|$PHP_AUTH_PW|$ip|\n";
		exit;
		}
	}
...
<table align=center width="700" border=0 cellpadding=5 cellspacing=0 bgcolor=#D9E6FE>
  <tr>
	<td align=right width="35%"><B><font face="arial, helvetica" size=2>Audio αρχείο για μεταφόρτωση:</font></B></td>
	<td align=left width="65%"><input type=file name="audiofile" value=""> <?php echo "$NWB#audio_store$NWE"; ?></td>
  </tr>
  <tr>
	<td align=center colspan=2><input type=submit name=submit value=submit></td>
  </tr>
  <tr><td align=left><font size=1> &nbsp; </font></td><td align=right><font size=1>Audio Store- &nbsp; &nbsp; ΕΚΔΟΣΗ: <?php echo $version ?> &nbsp; &nbsp; ΔΗΜΙΟΥΡΓΙΑ: <?php echo $build ?> &nbsp; &nbsp; </td></tr>
</table>
</form>
<BR><BR>
<CENTER><B>Σας συνιστούμε ανέβασμα μόνο 16bit Mono 8k PCM WAV αρχεία ήχου(.wav)</B>
<BR><BR><font size=1>Όλοι οι χώροι θα πρέπει να αφαιρεθεί από Ανέβηκαν ήχου ονόματα αρχείων</font><BR><BR>
...
if ($auth_delete > 0)
	{
	echo "<center><BR><BR>Αρχείων για να διαγράψετε:<BR>\n";
...
echo "</B></B><br><br><a href=\"admin.php?ADD=720000000000000&category=AUDIOSTORE&stage=manualupload\">Χτυπήστε εδώ για να δείτε ένα κούτσουρο φορτώνει στο ακουστικό κατάστημα</FONT>\n";
