...
if ($ΕΠΙΒΕΒΑΙΩΣΗ && $query_date && $end_date) {
		...
		$MAIN.="<a href=\"$PHP_SELF?ΕΠΙΒΕΒΑΙΩΣΗ=$ΕΠΙΒΕΒΑΙΩΣΗ&DB=$DB&type=$type&query_date=$query_date&query_date_D=$query_date_D&query_date_T=$query_date_T$server_ipQS$sip_hangup_causeQS&lower_limit=$lower_limit&upper_limit=$upper_limit&file_download=1\">[ΛΗΨΗ]</a>\n";
		...
		$MAIN.="\nVICIDIAL USER LOG\n";
		$MAIN.=$vulog_div;
		    $MAIN.="| WEB ΔΙΑΚΟΜΙΣΤΗΣ                                         | URL                                                                                                  | COUNT  |\n";
		$MAIN.=$vulog_div;
		$user_TOTAL=0;
