...
if ( (!$OK_to_process) or ( ($leadfile) and ($file_layout!="standard") ) )
	...
	if ($file_layout!="custom") 
		...
		<tr>
			<td align=center colspan=2><input type=submit value="VALIDER" name='submit_file'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button onClick="javascript:document.location='admin_listloader_third_gen.php'" value="RECHARGER" name='reload_page'></td>
		  </tr>
		  <tr><td align=left><font size=1> &nbsp; &nbsp; &nbsp; &nbsp; <a href="admin.php?ADD=100" target="_parent">RETOUR A L'ADMINISTRATION</a> &nbsp; &nbsp; &nbsp; &nbsp; <a href="./new_listloader_superL.php">Old Lead Loader</a> &nbsp; &nbsp; </font></td><td align=right><font size=1>LIST LOADER 3rd Gen- &nbsp; &nbsp; VERSION: <?php echo $version ?> &nbsp; &nbsp; CONSTRUCTION: <?php echo $build ?> &nbsp; &nbsp; </td></tr>
		</table>
		<?php 
	...
	<input type=hidden name='leadfile_name' value="<?php echo $leadfile_name ?>">
	<input type=hidden name='DB' value="<?php echo $DB ?>">
	<a href="admin_listloader_third_gen.php">Load Another Lead File</a> &nbsp; &nbsp; &nbsp; &nbsp;</font></B> <font size=1>VERSION: <?php echo $version ?> &nbsp; &nbsp; CONSTRUCTION: <?php echo $build ?>
	</font></td>
	</tr></table>
	<BR><BR><BR><BR>
	<?php
...
if (($leadfile) && ($LF_path))
	...
	##### BEGIN field chooser #####
		...
		print "    <th colspan=2><input type=submit name='OK_to_process' value='PRET A TRAITER'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button onClick=\"javascript:document.location='admin_listloader_third_gen.php'\" value=\"RECHARGER\" name='reload_page'></th>\r\n";
		print "  </tr>\r\n";
		print "</table>\r\n";
