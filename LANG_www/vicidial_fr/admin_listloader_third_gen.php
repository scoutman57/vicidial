...
if ( (!$OK_to_process) or ( ($leadfile) and ($file_layout!="standard") ) )
	...
	if ($file_layout!="custom") 
		...
		<tr>
		  ...
		  <tr><td align=left><font size=1> &nbsp; &nbsp; &nbsp; &nbsp; <a href="admin.php?ADD=100" target="_parent">RETOUR A L'ADMINISTRATION</a> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </font></td><td align=right><font size=1>LIST LOADER 3rd Gen- &nbsp; &nbsp; VERSION: <?php echo $version ?> &nbsp; &nbsp; CONSTRUCTION: <?php echo $build ?> &nbsp; &nbsp; </td></tr>
		</table>
		<?php 
