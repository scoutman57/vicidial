...
function realtime_refresh_display()
	...
	if (ar_seconds > 0)
		{
		document.getElementById("rafraîchir_countdown").innerHTML = "" + ar_seconds + "";
		ar_seconds = (ar_seconds - 1);
		setTimeout("realtime_rafraîchir_display()",1000);
		}
	else
		{
		document.getElementById("rafraîchir_countdown").innerHTML = "0";
		ar_seconds = ar_rafraîchir;
...
echo " &nbsp; &nbsp; &nbsp; rafraîchir: <span id=rafraîchir_countdown name=rafraîchir_countdown></span>\n\n";
