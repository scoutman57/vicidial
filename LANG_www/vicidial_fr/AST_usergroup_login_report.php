...
$report_name = 'Groupe utilisateur Login Report';
$db_source = 'M';
...
if ($VALIDER=="VALIDER") 
	{
	$ASCII_text="+--------------------------------+----------+----------------------+---------------------+---------------------+----------+-----------------+-----------------+----------------------+--------------+-----------------+-----------------+-----------------+\n";
	$ASCII_text.="| USER NAME                      | ID       | GROUPE D'UTILISATEURS           | FIRST LOGIN DATE    | LAST LOGIN DATE     | CAMPAIGN | SERVEUR IP       | COMPUTER IP     | EXTENSION            | BROWSER      | PHONE LOGIN     |  SERVEUR PHONE   | PHONE IP        |\n";
	$ASCII_text.="+--------------------------------+----------+----------------------+---------------------+---------------------+----------+-----------------+-----------------+----------------------+--------------+-----------------+-----------------+-----------------+\n";

	$CSV_text="\"Utilisateur group login report\",\"Utilisateur groups:\",\"$user_group_string\"\n\n";
	$CSV_text.="\"Utilisateur name\",\"Utilisateur ID\",\"Utilisateur group\",\"First login date\",\"Last login date\",\"ID de la campagne\",\"IP du serveur\",\"Computer IP\",\"Extension\",\"Browser\",\"Phone login\",\"Server phone\",\"Phone IP\"\n";
