...
if ($submit_template=="SOUMETTRE TEMPLATE" && $template_id && $template_name && $template_list_id && $standard_fields_layout) 
	{
...
else if ($delete_template=="Supprimer le modèle" && $template_id) 
	{
...
function checkForm(form_name) {
	...
	if (form_name.template_id.value=="") {error_msg+=" - ID modèle is missing\n";}
	else if (form_name.template_id.value.length<2) {error_msg+=" - ID modèle needs to be at least 2 characters long<\n";}
	if (form_name.template_name.value=="") {error_msg+=" - Template name is missing\n";}
	if (form_name.template_list_id.value=="") {error_msg+=" - ID de la liste is missing\n";}
...
<tr height="20"><th bgcolor="#000099"><font class="standard_bold" color="#FFFFFF">Maker Listloader modèle personnalisé<?php echo "$NWB#vicidial_template_maker$NWE"; ?></font></th></tr>
...
?>
	<tr>
		<th width="50%"><font class="standard_bold">Créer un nouveau modèle</font></th>
		<th width="50%"><font class="standard_bold">Supprimer un modèle existant</font></th>
	<tr valign="top">
		...
		<form id="listloader_file_primer" action="leadloader_template_display.php?form_action=prime_file" method="post" enctype="multipart/form-data" target="file_holder">
			<font class="standard">Modèle de fichier de l'échantillon de montage:<BR><font size="-2">()</font></font><?php echo "$NWB#template_maker-create_template$NWE"; ?><BR><BR><input type=file name="sample_template_file" value="<?php echo $sample_template_file; ?>" onChange="loadIFrame('prime_file', this.value); this.form.submit();">
		</form>
		</td>
		<td align="left" width='50%'><form action="<?php echo $PHP_SELF; ?>" method="post"><font class="standard">Sélectionnez le modèle à supprimer:</font><?php echo "$NWB#template_maker-delete_template$NWE"; ?><BR><select name="template_id" onChange="loadIFrame('hide_new_template_form', '')">
<?php
...
?>
		</select><BR/><BR/><input type="submit" value="Supprimer le modèle" class="red_btn" name="delete_template">
		</form></td>
	</tr>
	<tr>
		<td align=left colspan="2"><font size=1> &nbsp; &nbsp; &nbsp; &nbsp; <a href="admin.php?ADD=100" target="_parent">RETOUR A L'ADMINISTRATION</a> &nbsp; &nbsp; &nbsp; &nbsp; <a href="./admin_listloader_fourth_gen.php">Go to Lead Loader</a> &nbsp; &nbsp; </font></td>
	</tr>
	</tr>
</table>
</form>
...
<table border=0 cellpadding=3 cellspacing=0 width="100%" align="center">
	<tr>
		<th colspan="2" bgcolor="#330099"><font class="standard" color="white">Modèle de formulaire Nouveau</font></th>
	</tr>
	<tr bgcolor="#D9E6FE">
		<td align="right" width='25%'><font class="standard">ID modèle:</font></td>
	...
	<tr bgcolor="#D9E6FE">
		<td align="right" width='25%'><font class="standard">Nom du modèle:</font></td>
	...
	<tr bgcolor="#D9E6FE">
		<td align="right" width='25%'><font class="standard">description du modèle:</font></td>
	...
	<tr bgcolor="#D9E6FE">
		<td width='25%' align="right"><font class="standard">Modèle ID de liste sera charger dans:</font></td>
		<td width='75%'>
			<select id='template_list_id' name='template_list_id' onChange="AfficherTemplateFields(this.value)">
	...
	<tr bgcolor="#D9E6FE">
		<td width='25%' align="right"><font class="standard">Statuts to dedupe against (optional):</font></td>
		<td width='75%'>
	...
	<tr bgcolor="#D9E6FE">
		<th colspan='2'><input type='submit' name='submit_template' onClick="return checkForm(this.form)" value='SOUMETTRE TEMPLATE'></th>
	</tr>
<tr bgcolor="#D9E6FE"><td align="center" colspan=2>
<table border=0 cellpadding=3 cellspacing=1 width="100%" align="center">
	<tr>
		<th colspan="2" bgcolor="#330099"><font class="standard" color="white">Attribuer colonnes à des champs de fichiers<BR/><font size='-2'>(sélection d'une liste différente pour réinitialiser colonnes)</font></font><?php echo "$NWB#template_maker-assign_columns$NWE"; ?></th>
	</tr>
	<tr valign="top">
		<td border="1" align="center" bgcolor="#D9E6FE" width="50%"><font class="standard">champ standard</font></td>
		<td border="0" align="center" bgcolor="#FED9D9" width="50%"><font class="standard">champ personnalisé</font></td>
	</tr>
	<tr valign="top">
		<td colspan="2" align="center">
		<span id="field_display" name="field_display"><font class="standard_bold" color='red'>**Sélectionnez un ID de liste à partir du menu déroulant ci-dessus pour afficher les colonnes**</font></span>
		</td>
	</tr>
</table>
</tr></td>
