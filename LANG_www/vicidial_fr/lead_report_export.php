...
$report_name = "Pistes d'exportation Rapport";
$db_source = 'M';
...
##### END RUN THE EXPORT AND OUTPUT FLAT DATA FILE #####
	...
	echo "<CENTER><BR>\n";
	echo "<FONT SIZE=3 FACE=\"Arial,Helvetica\"><B>Pistes d'exportation Rapport</B></FONT><BR>\n";
	echo "<FONT SIZE=2 FACE=\"Arial,Helvetica\">Ce rapport rassemble les informations de plomb pour les appels émis dans la plage de dates sélectionnée. Un plomb est seulement exporté une fois, peu importe combien d'appels ont été traités. Le statut de plomb actuelle est utilisée.</FONT><BR><BR>\n";
