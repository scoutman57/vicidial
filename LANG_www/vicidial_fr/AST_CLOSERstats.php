...
$ASCII_text="\n";
$ASCII_text.="---------- CALL TIME HOLD RÉPARTITION EN SECONDES       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&VALIDER=$VALIDER&file_download=2\">TÉLÉCHARGER</a>\n";
$ASCII_text.="+-------------------------------------------------------------------------------------------+------------+\n";
$ASCII_text.="|     0     5    10    15    20    25    30    35    40    45    50    55    60    90   +90 | TOTAL      |\n";
$ASCII_text.="+-------------------------------------------------------------------------------------------+------------+\n";

$CSV_text2.="\n\"CALL TIME HOLD RÉPARTITION EN SECONDES\"\n";
...
$ASCII_text="\n";
$ASCII_text.="           CALL REPONSEED TIME AND PERCENT BREAKDOWN IN SECONDS\n";
$ASCII_text.="          +-------------------------------------------------------------------------------------------+------------+\n";
$ASCII_text.="          |     0     5    10    15    20    25    30    35    40    45    50    55    60    90   +90 | TOTAL      |\n";
$ASCII_text.="----------+-------------------------------------------------------------------------------------------+------------+\n";

$CSV_text2.="\n\"CALL REPONSEED TIME AND PERCENT BREAKDOWN IN SECONDS\"\n";
$CSV_text2.="\"\",\"0\",\"5\",\"10\",\"15\",\"20\",\"25\",\"30\",\"35\",\"40\",\"45\",\"50\",\"55\",\"60\",\"90\",\"+90\",\"TOTAL\"\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- FAIT APPEL Hangup STATS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&VALIDER=$VALIDER&file_download=3\">TÉLÉCHARGER</a>\n";
$ASCII_text.="+----------------------+------------+\n";
...
if ($report_display_type=="HTML") 
	...
	$GRAPH_text="</PRE>\n";
	$GRAPH_text.="<table cellspacing=\"0\" cellpadding=\"0\" summary=\"FAIT APPEL Hangup STATS\" class=\"horizontalgraph\">\n";
	$GRAPH_text.="  <caption align=\"top\">FAIT APPEL Hangup STATS</caption>\n";
	$GRAPH_text.="  <tr>\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- CALL STATUS STATS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&VALIDER=$VALIDER&file_download=4\">TÉLÉCHARGER</a>\n";
$ASCII_text.="+--------+----------------------+----------------------+------------+------------+----------+----------+\n";
$ASCII_text.="| STATUS | DESCRIPTION          | CATÉGORIE             | CALLS      | TOTAL TIME | AVG TIME |CALLS/HOUR|\n";
$ASCII_text.="+--------+----------------------+----------------------+------------+------------+----------+----------+\n";
...
$CSV_text4.="\n\"CALL STATUS STATS\"\n";
$CSV_text4.="\"STATUS\",\"DESCRIPTION\",\"CATÉGORIE\",\"CALLS\",\"TOTAL TIME\",\"AVG TIME\",\"CALLS/HOUR\"\n";
...
$CSV_text5.="\"CATÉGORIE\",\"CALLS\",\"DESCRIPTION\"\n";
...
$ASCII_text="\n";
$ASCII_text.="---------- CALL INITIAL QUEUE POSITION BREAKDOWN       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&VALIDER=$VALIDER&file_download=6\">TÉLÉCHARGER</a>\n";
$ASCII_text.="+-------------------------------------------------------------------------------------+------------+\n";
...
$ASCII_text.="GRAPHIQUE INCREMENTE PAR TRANCHE DE 15 MINUTES DU TOTAL DES APPELS TAKEN INTO THIS IN-GROUP\n";
...
$MAIN.="\n";
$MAIN.="---------- CALL REPONSEED TIME BREAKDOWN IN SECONDS       <a href=\"$PHP_SELF?DB=$DB&DID=$DID&query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&VALIDER=$VALIDER&file_download=8\">TÉLÉCHARGER</a>\n";
$MAIN.="+------+-------------------------------------------------------------------------------------------+------------+\n";
$MAIN.="| HOUR |     0     5    10    15    20    25    30    35    40    45    50    55    60    90   +90 | TOTAL      |\n";
$MAIN.="+------+-------------------------------------------------------------------------------------------+------------+\n";

$CSV_text8.="\n\"CALL REPONSEED TIME BREAKDOWN IN SECONDS\"\n";
