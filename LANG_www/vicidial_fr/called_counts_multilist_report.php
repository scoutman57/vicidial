...
$report_name = 'Called Counts ID de la listes Report';
$db_source = 'M';
...
$HEADER.="function LoadListes(FromBox) {\n";
$HEADER.="	if (!FromBox) {alert(\"NO\"); return false;}\n";
$HEADER.="	var selectedCampagnes=\"|\";\n";
...
$HEADER.="			selectedCampagnes += document.getElementById('group').options[i].value+\"|\";\n";
$HEADER.="		} \n";
$HEADER.="	}\n";
$HEADER.="\n";
$HEADER.="	// Supprimer la liste menu\n";
...
$HEADER.="		var campaign_matches = selectedCampagnes.match(campaignID);\n";
...
$MAIN.="Listes: <font size=1>(en option, peut-être lente)</font><BR>\n";
$MAIN.=$list_options;
...
if (strlen($QUERY_STRING) > 5)
	...
	$CSV_text="";
	$MAIN.="<center>\n";
	$MAIN.="<br><b>CALLED COUNTS WITHIN LIST(S) $list_id_title_str$date_range_title:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"$PHP_SELF?DB=$DB$groupQS$list_idQS&query_date=$query_date&end_date=$end_date&override_date=$override_date&VALIDER=$VALIDER&file_download=1\">[TÉLÉCHARGER]</a></b><br>\n";
	$CSV_text.="CALLED COUNTS WITHIN LIST(S) $list_id_title_str$date_range_title:\n";
	$MAIN.="<TABLE width=700 cellspacing=1>\n";
	$MAIN.="<tr><td align=left><font size=1>ETAT</td><td align=center><font size=1>NOM DU STATUT</td>";
	$CSV_text.="\"STATUS\",\"NOM DU STATUT\",";
	...
	$MAIN.="<td align=center><font size=1>SOUS TOTAL</td></tr>\n";
	$CSV_text.="\"SUBTOTAL\"\n";
