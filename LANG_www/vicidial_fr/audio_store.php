...
if ( (!preg_match("/\|$ip\|/", $server_ips)) and ($formIPvalid < 1) )
	...
	if( (strlen($PHP_AUTH_USER)<2) or (strlen($PHP_AUTH_PW)<2) or (!$auth))
		...
		echo "Login ou mot de passe invalide: |$PHP_AUTH_USER|$PHP_AUTH_PW|$ip|\n";
		exit;
		}
	}
...
<table align=center width="700" border=0 cellpadding=5 cellspacing=0 bgcolor=#D9E6FE>
  <tr>
	<td align=right width="35%"><B><font face="arial, helvetica" size=2>Audio Fichier à télécharger:</font></B></td>
	<td align=left width="65%"><input type=file name="audiofile" value=""> <?php echo "$NWB#audio_store$NWE"; ?></td>
  </tr>
  <tr>
	<td align=center colspan=2><input type=submit name=submit value=submit></td>
  </tr>
  <tr><td align=left><font size=1> &nbsp; </font></td><td align=right><font size=1>Audio Store- &nbsp; &nbsp; VERSION: <?php echo $version ?> &nbsp; &nbsp; CONSTRUCTION: <?php echo $build ?> &nbsp; &nbsp; </td></tr>
</table>
</form>
<BR><BR>
<CENTER><B>Nous vous recommandons vivement le téléchargement ne 16bit mono PCM 8k fichiers audio WAV(.wav)</B>
<BR><BR><font size=1>Tous les espaces seront supprimés à partir des noms de fichiers audio téléchargés </font><BR><BR>
...
if ($auth_delete > 0)
	{
	echo "<center><BR><BR>Fichier à supprimer:<BR>\n";
...
echo "</B></B><br><br><a href=\"admin.php?ADD=720000000000000&category=AUDIOSTORE&stage=manualupload\">Cliquez ici pour voir un journal des ajouts à la boutique audio</FONT>\n";
