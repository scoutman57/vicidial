			...
			if (xmlhttp) 
				...
				xmlhttp.onreadystatechange = function() 
					...
					//	alert(xmlhttp.responseText);
						...
						var loop_ct=0;
						var conv_start=0;
						var CB_HTML = "<table width=610><tr bgcolor=<?php echo $SCRIPT_COLOR ?>><td><font class=\"log_title\">#</td><td><font class=\"log_title\"> CHAMADABACK DATE/TIME</td><td><font class=\"log_title\">NÚMERO</td><td><font class=\"log_title\">NAME</td><td><font class=\"log_title\">  STATUS</td><td align=right><font class=\"log_title\">CAMPAIGN</td><td><font class=\"log_title\">LAST DATA/HORA DA CHAMADA</td><td align=left><font class=\"log_title\"> COMMENTS</td></tr>"
...
// Fast version of manual dial
		...
		if ( (MDDiaLCodEform.length < 1) || (MDPhonENumbeRform.length < 5) )
			{
			alert("VOCÊ DEVE ENTRAR UM NÚMERO E O CÓDIGO DE ÁREA PARA USAR A DISCAGEM RÁPIDA");
			}
		else
			{
			var MDLookuPLeaD = 'new';
...
// Send the Manual Discar proximo número request
	function ManualDialNext(mdnCBid,mdnBDleadid,mdnDiaLCodE,mdnPhonENumbeR,mdnStagE,mdVendorid,mdgroupalias)
		...
		if (document.vicidial_form.LeadPreview.checked==true)
			...
			var man_preview = 'YES';
			var man_status = "Mostrar o contato, então <a href=\"#\" onclick=\"ManualDialOnly()\"><font class=\"preview_text\"> DISCAR REGISTRO</font></a> or <a href=\"#\" onclick=\"ManualDialSkip()\"><font class=\"preview_text\">PULAR REGISTRO</font></a>"; 
			}
		else
			{
			...
			//		alert(xmlhttp.responseText);
					...
					if ( (MDnextCID.match(regMNCvar)) || (MDnextCID.match(regMDFvarDNC)) || (MDnextCID.match(regMDFvarCAMP)) )
						...
						if (MDnextCID.match(regMDFvarCAMP))
							{alert("Esse número de telefone não está na lista da campanha:\n" + mdnPhonENumbeR);   alert_displayed=1;}
				...
				xmlhttp.onreadystatechange = function() 
					...
					//	alert(xmlhttp.responseText);
						...
						if (MDSnextCID == "LEAD NOT REVERTED")
							{
							alert("O contato não pode ser lido. Houve um erro.:\n" + MDSnextResponse);
							}
						else
							{
...
// Generate the Pausa Code Chooser panel
	function PauseCodeSelectContent_create()
		...
		if ( (AutoDialWaiting == 1) || (VD_live_customer_call==1) || (alt_dial_active==1) || (MD_channel_look==1) )
			{
			alert("VOCÊ DEVE ESTAR EM PAUSA PARA ENTRAR UM CÓDIGO DE PAUSA NO MODO AUTOMÁTICO");
			}
		else
			{
			HidEGenDerPulldown();
...
// Mostrar the groups selection span
	function OpeNGrouPSelectioN()
		...
		if ( (AutoDialWaiting == 1) || (VD_live_customer_call==1) || (alt_dial_active==1) || (MD_channel_look==1) )
			{
			alert("VOCÊ DEVE ESTAR EM PAUSA PARA ALTERAR OS GRUPOS");
			}
		else
			{
...
<?php	echo "Logado como usuário: $VD_loginligadoTelefone: $SIP_userpara a campanha: $VD_campaign&nbsp; \n"; ?>
...
<span style="position:absolute;left:0px;top:0px;z-index:52;" id="NeWManuaLDiaLBox">
	...
	<td align=right><font class="body_text"> Pesquisar Registros Existentes: </td>
	<td align=left><font class="body_text"><input type=checkbox name=LeadLookuP size=1 value="0">&nbsp; (Esta opção caso esteja marcada irá tentar encontrar o número do fone no sistema antes de inserir um novo registro)</td>
	</tr><tr>
...
<span style="position:absolute;left:0px;top:12px;z-index:39;" id="NoneInSessionBox">
    <table border=1 bgcolor="#CCFFFF" width=<?php echo $CAwidth ?> height=<?php echo $WRheight ?>><TR><TD align=center> Não existe ninguém na sua sessão: <span id="NoneInSessionID"></span><BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:41;" id="WrapupBox">
    <table border=1 bgcolor="#CCFFCC" width=<?php echo $CAwidth ?> height=<?php echo $WRheight ?>><TR><TD align=center> Chamada pós-atd: <span id="WrapupTimer"></span> segundos restantes de pós-atendimento<BR><BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:43;" id="AgenTDisablEBoX">
    <table border=1 bgcolor="#FFFFFF" width=<?php echo $CAwidth ?> height=<?php echo $WRheight ?>><TR><TD align=center>Sua sessão foi finalizada<BR><a href="#" onclick="LogouT('DISABLED');return false;">SAIR</a><BR><BR><a href="#" onclick="hideDiv('AgenTDisablEBoX');return false;">Voltar</a>
</TD></TR></TABLE>
</span>

<span style="position:absolute;left:0px;top:0px;z-index:44;" id="SysteMDisablEBoX">
    <table border=1 bgcolor="#FFFFFF" width=<?php echo $CAwidth ?> height=<?php echo $WRheight ?>><TR><TD align=center>Há um problema de sincronização no seu sistema, por favor informe o seu administrador de sistemas<BR><BR><BR><a href="#" onclick="hideDiv('SysteMDisablEBoX');return false;">Voltar</a>
</TD></TR></TABLE>
</span>
...
<span style="position:absolute;left:0px;top:0px;z-index:64;" id="PauseCodeSelectBox">
    <table border=1 bgcolor="#CCFFCC" width=<?php echo $CAwidth ?> height=<?php echo $WRheight ?>><TR><TD align=center VALIGN=top> SELECIONE UM CÓDIGO DE PAUSA :<BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:65;" id="GroupAliasSelectBox">
    <table border=1 bgcolor="#CCFFCC" width=<?php echo $CAwidth ?> height=<?php echo $WRheight ?>><TR><TD align=center VALIGN=top> SELEC. UM APELIDO DE GRUPO :<BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:53;" id="CloserSelectBox">
	...
	if ( ($outbound_autodial_active > 0) and ($disable_blended_checkbox < 1) and ($dial_method != 'INBOUND_MAN') )
		{
		?>
		<input type=checkbox name=CloserSelectBlended size=1 value="0"> LIGAÇÃO MESCLADA(ligações saintes ativadas) <BR>
		<?php
		}
	?>
...
<span style="position:absolute;left:0px;top:0px;z-index:55;" id="NothingBox">
	...
	<?php
	if (!$agentonly_callbacks)
		{echo "<input type=checkbox name=CallBackOnlyMe size=1 value=\"0\"> SOMENTE MEUS AGENDAMENTOS <BR>";}
	if ( ($outbound_autodial_active < 1) or ($disable_blended_checkbox > 0) or ($dial_method == 'INBOUND_MAN') )
		{echo "<input type=checkbox name=CloserSelectBlended size=1 value=\"0\"> LIGAÇÃO MESCLADA<BR>";}
	?>
</span>
