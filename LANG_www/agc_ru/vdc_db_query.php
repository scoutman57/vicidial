...
28 => "Недопустимо number format (address incomplete).",
29 => "Facilities rejected.",
30 => "Response to СТАТУС INQUIRY.",
...
81 => "Недопустимо call reference value.",
88 => "Incompatible destination.",
95 => "Недопустимо message, unspecified.",
...
100 => "Недопустимо information element contents.",
