...
// default settins
var A_TCALDEF = {
	'months' : ['Janvier', 'February', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Août', 'Septembre', 'Octobre', 'Novembre', 'Décembre'],
...
function f_tcalParseDate (s_date) {
	...
	if (!re_date.exec(s_date))
		return alert ("Invalide date: '" + s_date + "'.\nAccepted format is yyyy-mm-dd.")
	...
	if (n_month < 1 || n_month > 12)
		return alert ("Invalide month value: '" + n_month + "'.\nAllowed range is 01-12.");
	var d_numdays = new Date(n_year, n_month, 0);
	if (n_day > d_numdays.getDate())
		return alert("Invalide day of month value: '" + n_day + "'.\nAllowed range for selected month is 01 - " + d_numdays.getDate() + ".");
