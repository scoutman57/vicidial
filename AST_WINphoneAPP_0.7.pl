#!/usr/bin/perl -w
# 
# AST_WINphoneAPP_0.7.pl version 0.7      for Perl/Tk
...
# - Allows calls to be placed from GUI
...
# perl -d:ptkdb C:\AST_VICI\AST_WINphoneAPP_0.7.pl  
#  
#
# Distributed with no waranty under the GNU Public License
#

# some script specific default values
$DASH='-';
$USUS='__';
...
### Frame for current live phones and live Zap Channels
	...
	### list box for current live lines that are active and what phones are on them
		my $live_ext = $ext_frame->Listbox(-relief => 'sunken', 
		...
		my $scrollB = $ext_frame->Scrollbar(-command => ['yview', $live_ext]);
