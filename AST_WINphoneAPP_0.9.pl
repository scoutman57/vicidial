...
# 
# AST_WINphoneAPP_0.9.pl version 0.9.4      for Perl/Tk
...
# perl -d:ptkdb C:\AST_VICI\AST_WINphoneAPP_0.9.pl  
#  
#
...
### Frame for middle buttons and entries
	...
	### button for a popup HELP screen with user directions
		my $Open_Help = $middle_bottons_frame->Button(-text => 'HELP', -width => -1,
					-command => sub 
					{
					 Open_Help;
					});
