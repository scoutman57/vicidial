+------------------------------------------------------------------------------+
|      Asterisk GUI client - astguiclient - twelfth public release 1.0.6       |
...
- astGUIclient_1.0.6.pl - the GUI application itself
 ...
 - astVICIDIAL_0.9.pl - the VICIDIAL GUI client auto-dialing application
