+------------------------------------------------------------------------------+
|      Asterisk GUI client - astguiclient - eighth public release 1.0.2        |
...
- AST_WINphoneAPP_1.0.2.pl - the GUI application itself
 ...
 - AST_VICIDIAL_0.5.pl - the VICIDIAL GUI client auto-dialing application
