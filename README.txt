+------------------------------------------------------------------------------+
|    Asterisk GUI client - astguiclient - thirteenth public release 1.1.0      |
...
- astGUIclient_1.1.0.pl - the GUI application itself
 ...
 - astVICIDIAL_1.0.pl - the VICIDIAL GUI client auto-dialing application
...
Zaptel trunks or IAX VOIP trunks and SIP/IAX VOIP hard or softphones or Zap 
devices as extensions, it could be adapted to other functions, but It was 
designed for Zap/IAX/SIP users. The client programs will run on X and Win32.
