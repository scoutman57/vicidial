+------------------------------------------------------------------------------+
|      Asterisk GUI client - astguiclient - seventh public release 1.0.1       |
...
- AST_WINphoneAPP_1.0.1.pl - the GUI application itself
 ...
 - AST_VICIDIAL_0.4.pl - the VICIDIAL GUI client auto-dialing application
