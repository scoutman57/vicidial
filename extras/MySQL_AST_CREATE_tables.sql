...
INSERT INTO system_settings (version,install_date,first_login_trigger) values('2.9rc1', CURDATE(), 'Y');
...
UPDATE system_settings SET db_schema_version='1379',db_schema_update_date=NOW(),reload_timestamp=NOW();
