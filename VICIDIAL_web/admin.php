...
if ($ADD==8)		{echo "CallBacks Within Agent";}
if ($ADD==81)		{echo "CallBacks Within Campaign";}
if ($ADD==811)		{echo "CallBacks Within List";}
...
if ($ADD==8)
{
	...
	$stmt="SELECT * from vicidial_callbacks where status='ACTIVE' and user='$user' order by callback_time desc";
	$rslt=mysql_query($stmt, $link);
...
if ($ADD==81)
{
	...
	$stmt="SELECT * from vicidial_callbacks where status='ACTIVE' and campaign_id='$campaign_id' order by callback_time desc";
	$rslt=mysql_query($stmt, $link);
	$cb_to_print = mysql_num_rows($rslt);
...
if ($ADD==811)
{
	...
	$stmt="SELECT * from vicidial_callbacks where status='ACTIVE' and list_id='$list_id' order by callback_time desc";
	$rslt=mysql_query($stmt, $link);
	$cb_to_print = mysql_num_rows($rslt);
...
{
echo "<center><TABLE width=600 cellspacing=0 cellpadding=1>\n";
echo "<tr bgcolor=black><td><font size=1 color=white>LEAD</td><td><font size=1 color=white>LIST</td><td><font size=1 color=white>CAMPAIGN</td><td><font size=1 color=white>ENTRY DATE</td><td><font size=1 color=white>CALLBACK DATE</td><td><font size=1 color=white>USER</td><td><font size=1 color=white>RECIPIENT</td></tr>\n";
