...
if ($ADD==2111111)	{echo "New Script Addition";}
if ($ADD==3)		{echo "Modify User";}
if ($ADD==31)		{echo "Modify Campaign";}
if ($ADD==34)		{echo "Modify Campaign - Basic View";}
...
if ($ADD==3111111)	{echo "Modify Script";}
if ($ADD=="4A")		{echo "Modify User - Admin";}
if ($ADD==4)		{echo "Modify User";}
if ($ADD==41)		{echo "Modify Campaign";}
if ($ADD==42)		{echo "Modify Campaign Status";}
if ($ADD==43)		{echo "Modify Campaign HotKey";}
if ($ADD==44)		{echo "Modify Campaign - Basic View";}
if ($ADD==411)		{echo "Modify List";}
if ($ADD==4111)		{echo "Modify In-Group";}
if ($ADD==41111)	{echo "Modify Remote Agents";}
if ($ADD==411111)	{echo "Modify Users Groups";}
if ($ADD==4111111)	{echo "Modify Script";}
if ($ADD==5)		{echo "Delete User";}
if ($ADD==51)		{echo "Delete Campaign";}
if ($ADD==52)		{echo "Logout Agents";}
if ($ADD==511)		{echo "Delete List";}
if ($ADD==5111)		{echo "Delete In-Group";}
if ($ADD==51111)	{echo "Delete Remote Agents";}
if ($ADD==511111)	{echo "Delete Users Group";}
if ($ADD==5111111)	{echo "Delete Script";}
if ($ADD==6)		{echo "Delete User";}
if ($ADD==61)		{echo "Delete Campaign";}
if ($ADD==62)		{echo "Logout Agents";}
if ($ADD==611)		{echo "Delete List";}
if ($ADD==6111)		{echo "Delete In-Group";}
if ($ADD==61111)	{echo "Delete Remote Agents";}
if ($ADD==611111)	{echo "Delete Users Group";}
if ($ADD==6111111)	{echo "Delete Script";}
if ($ADD==7111111)	{echo "Preview Script";}
...
if ($ADD==1000000)	{echo "Scripts";}
if ($ADD==55)		{echo "Search Form";}
if ($ADD==66)		{echo "Search Results";}
...
<B>Script Name -</B> This is the title of a Vicidial Script. This is a short summary of the script. max 50 characters, minimum of 2 characters.
...
<TR BGCOLOR=#F0F5FE><TD ALIGN=LEFT COLSPAN=2><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=1><B> &nbsp; <a href="server_stats.php"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=1>STATS AND REPORTS</a>   &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; | <a href="<? echo $PHP_SELF ?>?ADD=1111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=1>ADD SCRIPT</a> | <a href="<? echo $PHP_SELF ?>?ADD=1000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=1>VIEW SCRIPTS</a> |&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;| <a href="admin_search_lead.php"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=1>SEARCH FOR A LEAD</a> | <a href="group_hourly_stats.php"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=1>GROUP HOURLY</a></TD></TR>
	...
	if ($row[0] > 0)
	...
	else
		{
		 if ( (strlen($group_id) < 2) or (strlen($group_name) < 2)  or (strlen($group_color) < 2) or (strlen($group_id) > 20) or (eregi(' ',$group_id)) or (eregi('-',$group_id)) or (eregi('+',$group_id)) )
			...
			{
			$stmt="INSERT INTO vicidial_inbound_groups values('$group_id','$group_name','$group_color','$active','$web_form_address','$voicemail_ext','$next_agent_call','$fronter_display','$script_id','$get_call_launch');";
			$rslt=mysql_query($stmt, $link);
...
if ($ADD=="4A")
{
	echo "<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2>";
	 ...
	 if ( (strlen($pass) < 2) or (strlen($full_name) < 2) or (strlen($user_level) < 1) )
		...
		$stmt="UPDATE vicidial_users set pass='$pass',full_name='$full_name',user_level='$user_level',user_group='$user_group',phone_login='$phone_login',phone_pass='$phone_pass',delete_users='$delete_users',delete_user_groups='$delete_user_groups',delete_lists='$delete_lists',delete_campaigns='$delete_campaigns',delete_ingroups='$delete_ingroups',delete_remote_agents='$delete_remote_agents',load_leads='$load_leads',campaign_detail='$campaign_detail',ast_admin_access='$ast_admin_access',ast_delete_phones='$ast_delete_phones',delete_scripts='$delete_scripts' where user='$user';";
		$rslt=mysql_query($stmt, $link);
...
if ($ADD==44)
{
	echo "<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2>";
	 ...
	 if ( (strlen($campaign_name) < 6) or (strlen($active) < 1) )
		...
		$stmt="UPDATE vicidial_campaigns set campaign_name='$campaign_name',active='$active',dial_status_a='$dial_status_a',dial_status_b='$dial_status_b',dial_status_c='$dial_status_c',dial_status_d='$dial_status_d',dial_status_e='$dial_status_e',lead_order='$lead_order',hopper_level='$hopper_level', auto_dial_level='$auto_dial_level' where campaign_id='$campaign_id';";
		$rslt=mysql_query($stmt, $link);
		...
		if ($WeBRooTWritablE > 0)
			{
			$fp = fopen ("./admin_changes_log.txt", "a");
			fwrite ($fp, "$date|MODIFY CAMPAIGN INFO|$PHP_AUTH_USER|$ip|campaign_name='$campaign_name',active='$active',dial_status_a='$dial_status_a',dial_status_b='$dial_status_b',dial_status_c='$dial_status_c',dial_status_d='$dial_status_d',dial_status_e='$dial_status_e',lead_order='$lead_order',hopper_level='$hopper_level', auto_dial_level='$auto_dial_level' where campaign_id='$campaign_id'|$reset_hopper|\n");
			fclose($fp);
			}
		}
...
echo "<tr bgcolor=#B6D3FC><td align=right>Script: </td><td align=left><select size=1 name=script_id>\n";
echo "$scripts_list";
echo "<option selected>$script_id</option>\n";
echo "</select>$NWB#vicidial_campaigns-campaign_script$NWE</td></tr>\n";
...
echo "<tr bgcolor=#B6D3FC><td align=right>Script: </td><td align=left>$script_id</td></tr>\n";
